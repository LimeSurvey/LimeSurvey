...
This is a command line LimeSurvey Survey importer. Usage: php
    <?php echo $argv[0]; ?>
<File to import>
[
<user>
...
<File to import>
has to be a LimeSurvey survey dump.
<user>
and
<password>
are only required if the control access is active With the --help,
-help, -h, or -? options, you can get this help.
