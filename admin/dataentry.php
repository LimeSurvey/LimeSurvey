...
if($actsurrows['browse_response'])
{
	...
	if ($subaction == "insert")
	{
		...
		else
		{
			...
			{
				$today = date_shift(date("Y-m-d H:i"), "Y-m-d", $timeadjust);      
			...
			if (isset($_POST['save']) && $_POST['save'] == "on")
			{
				...
				'saved_thisstep' => 0,
				"status"=>"S",
				"saved_date"=>date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust));
				...
				if ($connect->AutoExecute("{$dbprefix}saved_control", $scdata,'INSERT'))
				{
                    ...
                    "sent"=>date_shift(date("Y-m-d H:i"), "Y-m-d H:i", $timeadjust), 	
                    "completed"=>"N");
	...
	elseif ($subaction == "edit" || $subaction == "editsaved")
	{
		...
		elseif ($subaction == "editsaved")
		{
			...
			$results1['id']="";
			$results1['datestamp']=date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust);      
		...
		elseif ($subaction == "editsaved")
		{
			...
			$dataentryoutput .="<input type='hidden' name='closedate' value='".date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust)."' />\n";
	...
	else
	{
		...
		{
            $localtimedate=date_shift(date("Y-m-d H:i"), "Y-m-d H:i", $timeadjust);        
			$dataentryoutput .= "\t<tr>\n"
			."\t\t<td valign='top' width='1%'></td>\n"
