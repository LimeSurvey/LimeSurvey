...
if ($action == "newsurvey")
{
	if($_SESSION['USER_RIGHT_CREATE_SURVEY'])
	{
		...
		. "\t\t<td align='left'><input type='text' size='82' id='surveyls_title' name='surveyls_title' /><font size='1'> ".$clang->gT("(This field is mandatory.)")."</font></td></tr>\n"
		. "\t<tr><td align='right'>".$clang->gT("Description:")."</td>\n"
		. "\t\t<td align='left'><textarea cols='80' rows='10' name='description'></textarea></td></tr>\n"
		. "\t<tr><td align='right'>".$clang->gT("Welcome:")."</td>\n"
		. "\t\t<td align='left'><textarea cols='80' rows='10' name='welcome'></textarea></td></tr>\n"
		. "\t<tr><td align='right'>".$clang->gT("Administrator:")."</td>\n"
		...
		. "\t</tr>\n";
		// ANONYMOUS
		$newsurvey .= "\t<tr><td align='right'>".$clang->gT("Anonymous answers?")."\n";
		  // warning message if anonymous + datestamped anwsers
		$newsurvey .= "\n"
		. "\t<script type=\"text/javascript\"><!-- \n"
		. "\tfunction alertPrivacy()\n"
		...
		. "\t\t<td align='left'><input type='text' size='82' name='email_invite_subj' value='".$clang->gT("Invitation to participate in survey")."' />\n"
		. "\t</td></tr>\n";
		$newsurvey .= "\t<tr><td align='right'>".$clang->gT("Invitation Email:")."</td>\n"
		. "\t\t<td align='left'><textarea cols='80' rows='10' name='email_invite'>".$clang->gT("Dear {FIRSTNAME},\n\nYou have been invited to participate in a survey.\n\nThe survey is titled:\n\"{SURVEYNAME}\"\n\n\"{SURVEYDESCRIPTION}\"\n\nTo participate, please click on the link below.\n\nSincerely,\n\n{ADMINNAME} ({ADMINEMAIL})\n\n----------------------------------------------\nClick here to do the survey:\n{SURVEYURL}")."</textarea>\n"
		. "\t</td></tr>\n";
