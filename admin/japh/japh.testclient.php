...
// errors are ok, but warnings just destroy our layout while they have nothing to say
...
{
	try
	{	$mods = $client->aAvailableModules("admin", "password", "mod");}
...
{
	try
	{	$cores = $client->aAvailableModules("admin", "password", "core");}
	catch (SoapFault $fault)
...
while(list($key, $value) = each($_REQUEST))
{
	...
	if(substr($key,0,6)=="change")
	{
		...
		try
		{
			$sReturn = $client->sChangeSurvey("admin", "password", $table, $key, $value, $where );
		}
		catch (SoapFault $fault)
		{
			$sOutput .= " <br/><br/><b>SOAP Error: ".$fault->faultcode." : ".$fault->faultstring."</b>";
	...
	{
		//$functionToCall = "sInsertParticipants";
		try
		{
...
<b><font color='red'>* </font>LimeSurvey User: (default: 'admin')</b><br />
<input type='text' name='user' size='30' maxlength='150' value='admin' />
<br />
<b><font color='red'>* </font>LimeSurvey Passwort: (default: 'password')</b>
<br />
<input type='password' name='password' size='30' maxlength='150'
	value='password' /> <br />
...
echo "<br />";
echo "<b><font color='red'>* </font>LimeSurvey User: (default: 'admin')</b><br />";
echo "<input type='text' name='user' size='30' maxlength='150' value='admin'/>";
echo "<br />";
echo "<b><font color='red'>* </font>LimeSurvey Passwort: (default: 'password')</b> <br />";
echo "<input type='password' name='password' size='30' maxlength='150' value='password'/>";
echo "<br />";
...
echo "<b><font color='red'>* </font>LimeSurvey User: (default: 'admin')</b><br />";
echo "<input type='text' name='user' size='30' maxlength='150' value='admin'/><br />";
echo "<b><font color='red'>* </font>LimeSurvey Passwort: (default: 'password')</b> <br />";
echo "<input type='password' name='password' size='30' maxlength='150' value='password'/><br />";
