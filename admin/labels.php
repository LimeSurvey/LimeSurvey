...
//        		."\t<td width='25%' align='center' class='settingcaption'><strong>\n"
	...
	$labelsoutput.= "<div class='tab-page'> <h2 class='tab'>".$clang->gT("Uploaded Resources Management")."</h2>\n"
		...
		. "\t\t<tr><td></td><td><input type='button' onclick='window.open(\"$scriptname?action=exportlabelresources&amp;lid={$lid}\", \"_blank\")'/ value=\"".$clang->gT("Export Zip archive of uploaded ressources")."\" $disabledIfNoResources></td><td><td></tr>\n"
