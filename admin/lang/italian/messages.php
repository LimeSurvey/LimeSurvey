<?php
// TRANSLATION BY Gabriele "Pentothal" Carioli //
...
define("_CREATESURVEY", "Cre Indagine"); //New for 0.98rc4
...
define("_TOKENCONTROL", "Controlla token");
define("_TOKENDBADMIN", "Amministrazione Database Token");
define("_DROPTOKENS", "Elimina tavole token");
define("_EMAILINVITE", "Invia invito");
define("_EMAILREMIND", "Invia sollecita");
define("_TOKENIFY", "Genera token");
define("_UPLOADCSV", "Upload File CSV");
...
define("_S_TOKENS_BT", "Genera token");
...
define("_Q_ANSWERS_BT", "Modifica/Aggiungi risposte di questa domanda");
define("_Q_LABELS_BT", "Modifica/Aggiungi etichette di questa domanda");
define("_Q_MINIMISE_BT", "Nascondi dettagli di questa domanda");
define("_Q_MAXIMISE_BT", "Mostra dettagli di questa domanda");
...
define("_B_STATISTICS_BT", "Statistiche di queste risposte");
define("_B_EXPORT_BT", "Esporta risultati");
define("_B_BACKUP_BT", "Backup dei risultati in file SQL");
//Tokens Button Bar
define("_T_ALL_BT", "Mostra token");
define("_T_ADD_BT", "Aggiungi token");
...
define("_T_TOKENIFY_BT", "Genera token");
define("_T_KILL_BT", "Elimina tavole token");
//Labels Button Bar
...
define("_SL_EMAIL", "Email Amministratore:");
...
define("_NONE", "Nessuno"); //as in "Vuoto", "Nessuna scelta";
...
define("_SS_SURVEYTABLE", "Il nome della tavola per l&#039;indagine &egrave;:"); //NEW for release 0.98rc3
...
define("_QS_NOANSWERS", "&Egrave; necessario inserire delle risposte per questa domanda"); //New for release 0.98rc4
define("_QS_NOLID", "&Egrave; necessario inserire un gruppo di etichette per questa domanda"); //New for release 0.98rc4
...
define("_UC_NOCREATE", "Impossibile creare file htaccess. Verifica il config.php per la configurazione di \$homedir, e assicurarsi che i token siano stati inseriti nella directory giusta.");
...
define("_UC_ADD_MISSING", "Impossibile aggiungere utente. Username e/o password non sono stati inseriti");
define("_UC_DEL_USER", "Elimina utente");
define("_UC_DEL_MISSING", "Impossibile eliminare utente. Username non &egrave; stato inserito.");
define("_UC_MOD_USER", "Modifica utente");
define("_UC_MOD_MISSING", "Impossibile modificare utente. Username e/o password non sono stati inseriti");
...
define("_UC_NOUSERS", "Non esistono utenti nella tabella. Si consiglia di &#039;disattivare&#039; la sicurezza. Si pu&ograve; &#039;ri-attivare&#039; in un secondo momento.");
...
define("_AC_ACTIVATE_MESSAGE1", "Attivare un &#039;indagine solo dopo aver inserito tutti i dati e non sono necessarie ulteriori modifiche.");
...
define("_AC_DEACTIVATE_MESSAGE3", "Le informazioni di un&#039;indagine disattivata possono essere visualizzate solo dall&#039;amministratore attraverso uno strumento MySQL come phpmyadmin. Se l&#039;indagine utilizza i token, la tavola delle risposte verr&agrave; rinominata e sar&agrave; accessibile solo dall&#039;amministratore.");
define("_AC_DEACTIVATE_MESSAGE4", "La tavola delle risposte verr&agrave; rinominata:");
...
define("_AC_DEACTIVATED_MESSAGE3", "Non dimenticare il nome di questo database per accedere alle informazioni pi&ugrave; tardi.");
define("_AC_DEACTIVATED_MESSAGE4", "Le tavole dei token associate a questa indagine sono state rinominate: ");

//CHECKFIELDS
define("_CF_CHECKTABLES", "Verifica delle seguenti tavole");
define("_CF_CHECKFIELDS", "Verifica dei seguenti campi");
define("_CF_CHECKING", "Verifica");
define("_CF_TABLECREATED", "La tavola &egrave; stata creata");
define("_CF_FIELDCREATED", "I campi sono stati creati");
define("_CF_OK", "OK");
define("_CFT_PROBLEM", "Alcune tavole o campi non sono presenti nel database.");

//CREATE DATABASE (createdb.php)
define("_CD_DBCREATED", "Il database &egrave; stato creato.");
define("_CD_POPULATE_MESSAGE", "Clicca sul seguente link per l&#039;inserimento dei dati nel database");
...
define("_DB_FAIL_NEWANSWERMISSING", "Impossibile aggiungere domanda. Inserire Codice e Risposta");
define("_DB_FAIL_NEWANSWERDUPLICATE", "Impossibile aggiungere domanda. Domanda con lo stesso codice gi&agrave; esistente");
define("_DB_FAIL_ANSWERUPDATEMISSING", "Impossibile aggiornare domanda. Inserire Codice e Risposta");
define("_DB_FAIL_ANSWERUPDATEDUPLICATE", "Impossibile aggiornare domanda. Domanda con lo stesso codice gi&agrave; esistente");
define("_DB_FAIL_ANSWERUPDATECONDITIONS", "Impossibile aggiornare domanda. Il codice della domande &egrave; stato modificato. Alcune domande dipendono dalle condizioni associate alla domanda con il vecchio codice. Elimina le condizioni prima di modifcare il codice di questa domanda.");
...
define("_DB_FAIL_NEWSURVEY_TITLE", "Impossibile creare indagine. Inserire un titolo");
define("_DB_FAIL_NEWSURVEY", "Impossibile creare indagine");
define("_DB_FAIL_SURVEYUPDATE", "Impossibile aggiornare indagine");
define("_DB_FAIL_SURVEYDELETE", "Impossibile eliminare indagine");

//DELETE SURVEY MESSAGES
define("_DS_NOSID", "Non &egrave; stato selezionato nessuna indagine da eliminare");
define("_DS_DELMESSAGE1", "Eliminare questa indagine?");
define("_DS_DELMESSAGE2", "Questa operazione eliminer&agrave; l&#039;indagine e tutti i relativi gruppi, domande, risposte e condizoni.");
define("_DS_DELMESSAGE3", "Si consiglia di esportare l&#039;indagine dalla pagina di amministrazione generale prima di eliminarla.");
define("_DS_SURVEYACTIVE", "Questa indagine &egrave; attiva e esiste un database delle risposte. Eliminanado l&#039;indagine si eliminano anche le risposte. Si consiglia di esportare le risposte prima di eliminare l&#039;indagine.");
...
define("_IQ_WRONGFILE", "Il file non &egrave; un file per le domande PHPSurveyor. Importazione non &egrave; riuscita.");
...
define("_TC_NOTOKENCOUNT", "Totale senza token unico:"); //New in 0.98rc4
...
define("_TC_DELTOKENS", "Elimina token per questa indagine.");
define("_TC_DELTOKENSINFO", "L&#039;eliminanazione della tavola dei Token, render&agrave; l&#039;indagine aperta a tutti. Verr&agrave; eseguito un backup dei dati a cui solo l&#039;amministratore di sistema avr&agrave; accesso.");
define("_TC_DELETETOKENS", "Elimina tavola dei token");
define("_TC_TOKENSGONE", "La tavola dei token &egrave; stata eliminta e non &egrave; pi&ugrave; obbligatorio avere un token di ingresso per accedere all&#039;indagine. Se si procede verr&agrave; eseguito un backup dei dati a cui solo l&#039;amministratore di sistema avr&agrave; accesso.");
define("_TC_NOTINITIALISED", "I token non sono stati attivati.");
define("_TC_INITINFO", "Attivando i token per questa indagine, l&#039;accesso all&#039;indagine sar&agrave; riservata solo agli utenti con un token.");
define("_TC_INITQ", "Creare una tavola dei Token per questa indagine?");
define("_TC_INITTOKENS", "Genera token");
define("_TC_CREATED", "E&#039; stata creata una tavola dei token per questa indagine.");
define("_TC_DELETEALL", "Azzera i token");
define("_TC_DELETEALL_RUSURE", "Procedere nell&#039;eliminazione delle voci di TUTTI i Token?");
define("_TC_ALLDELETED", "Tutti i Token sono stati azzeratii");
define("_TC_CLEARINVITES", "Non spedire gli inviti");
define("_TC_CLEARINV_RUSURE", "Annullare la spedizione di tutti gli inviti?");
define("_TC_CLEARTOKENS", "Elimina codici associati ai token");
define("_TC_CLEARTOKENS_RUSURE", "Elimina tutti i codici associati ai token?");
define("_TC_TOKENSCLEARED", "I codici associati ai token sono stati eliminati");
define("_TC_INVITESCLEARED", "Gli inviti non verranno spediti");
define("_TC_EDIT", "Genera token");
define("_TC_DEL", "Elimina token");
...
define("_TC_INVITESUBJECT", "Invito a partecipare a {SURVEYNAME}"); //Leave {SURVEYNAME} for replacement in scripts
define("_TC_REMINDSUBJECT", "Sollecito a partecipare a {SURVEYNAME}"); //Leave {SURVEYNAME} for replacement in scripts
define("_TC_REMINDSTARTAT", "Incomincia dal ID del Token n.:");
define("_TC_REMINDTID", "Invia a ID del Token n.:");
define("_TC_CREATETOKENSINFO", "Cliccando su SI verranno generati automaticamente i codici e i Token per tutti gli utenti che ne sono ancora sprovvisti. Procedere?");
define("_TC_TOKENSCREATED", "{TOKENCOUNT} Token sono stati creati"); //Leave {TOKENCOUNT} for replacement in script with the number of tokens created
define("_TC_TOKENDELETED", "Token eliminato.");
define("_TC_SORTBY", "Ordina: ");
define("_TC_ADDEDIT", "Aggiungi o genera Token");
...
define("_TC_NONETOSEND", "Nessun messaggio e-mail da inviare. I messaggi non soddisfano i seguenti criteri - indirizzo e-mail valido, non &egrave; stato ancora inviato un invito, l&#039;indagine &egrave; gi&agrave; stata completata l&#039;utente ha gi&agrave; un token.");
...
define("_TC_NOREMINDTEMPLATE", "Promenmoria Impossibile trovare Template degli inviti. Il file dovrebbe essere nella cartella template di default.");
...
define("_TC_EMAILSTOGO", "Troppe e-mail in attesa di essere spedite. Impossibile inviarli tutti insieme. Clicca sul seguente link per continuare a inviare i messaggi.");
define("_TC_EMAILSREMAINING", "Ci sono ancora {EMAILCOUNT} email in attesa di invio."); //Leave {EMAILCOUNT} for replacement in script by number of emails remaining
...
define("_LB_FAIL_DELSET", "Impossibile cancellare il gruppo di etichette - Ci sono delle domande che dipendono da esso. &Egrave; necessario eliminare prima queste domande.");
