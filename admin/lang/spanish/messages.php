...
define("_EMAILINVITE", "Enviar Invitación (email)");
...
//Browse Button Bar
define("_B_ADMIN_BT", "Regresar a la Administració de Encuestas");
...
define("_T_INVITE_BT", "Enviar Invitación (email)");
...
define("_SL_ALLOWREGISTER", "Permitir registración pública?"); //New with 0.98rc9
...
define("_HTEXT", "Texto libre enomre"); //New with 0.99dev01
define("_YESNO", "Si/No");
...
define("_LISTFL_DROPDOWN", "Lista (Etiquetas Flexibles) (Dropdown)"); //New in 0.99dev01
...
define("_SS_IPADDRESS", "La Dirección IP será guardada en un log"); //New with 0.991
...
define("_SS_SBYS", "Es presentado en una sola páguna."); //NEW for release 0.98rc3
...
define("_SS_ALLOWREGISTER", "Si se utilizan tokens, el público puede registrarse para esta encuesta"); //NEW for release 0.98rc9
define("_SS_ALLOWSAVE", "Los participantes pueden salvar encuestas parcialmente terminadas"); //NEW for release 0.99dev01
...
define("_QS_COPYINFO", "Nota: Debes introducir un código de pregunta nuevo"); //New for release 0.98rc4
...
define("_ST_NODB3", "PHPSurveyor puede intentar crear la base de datos por tí.");
...
define("_UC_HTPASSWD_EXPLAIN", "Si estás utilizando un servidor Windows es recomendado que copies el archivo htpasswd.exe de apache al directorio admin para que esta función funcione correctamente.");
define("_UC_SEC_REMOVE", "Removiendo opciones de seguridad");
define("_UC_ALL_REMOVED", "Archivo de acceso, de contraseñas y base de datos de usuarios borrados");
define("_UC_ADD_USER", "Agregando Usuario");
define("_UC_ADD_MISSING", "No se pudo agregar el usuario. Faltaron Nombre de Usuario y/o Contraseña");
...
define("_UC_TURNON_MESSAGE1", "Aún no has inicializado las opciones de seguridad para el sistema de encuestas y subsecuentemente no hay restricciones de acceso .</p>\nSi das clic en el botón de 'Inicializar Seguridad' de abajo, opciones estándar de seguridad de APACHE serán agregadas al directorio de administración del sistema. Y entonces necesitarás utilizar los valores default de nombre de usuario y contraseña para accesar la pantalla de administración.");
define("_UC_TURNON_MESSAGE2", "Es recomendado que una vez que hayas inicializado el sistema de seguridad cambies la contraseña default.");
...
define("_AC_MULTI_NOANSWER", "Esta pregunta  es de mútiples respuestas pero aún no tiene respuestas asignadas a él");
...
define("_AC_CON_OUTOFORDER", "Esta pregunta tiene asignada una condifión, pero esta condición está basada en una pregunta que aparece después de ella..");
...
define("_AC_ACTIVATE_MESSAGE1", "Debes activar una encuesta solo cuando estés absolutamente seguro(a) que la configuración de la encuesta es la correcta y que no habrá más cambios.");
define("_AC_ACTIVATE_MESSAGE2", "Una vez que la encuesta es activada no podrás:<ul><li>Agregar o borrar Grupos</li><li>Agregar o borrar respuestas a preguntas de Opción Múltiple</li><li>Agregar o borrar preguntas</li></ul>");
define("_AC_ACTIVATE_MESSAGE3", "Aunque aún podrás:<ul><li>Modificar los códigos de las preguntas, texto o tipo</li><li>Modificar los nombres de los grupos</li><li>Agregar, borrar o modificar respuestas de respuestas predefinidas (exceptuando preguntas de múltiples respuestas)</li><li>Change survey name or description</li></ul>");
define("_AC_ACTIVATE_MESSAGE4", "Si deseas agregar o borra grupos o preguntas una vez que la encuesta ya haya sido contestada por lo menos una vez, deberás desactivar la encuesta, lo cual moverá toda la información ya existente a otra tabla para ser archivada.");
...
define("_AC_REGISTRATION", "Esta encuesta admite registración pública. Es necesario crear la tabal de token.");
...
define("_AC_DEACTIVATE_MESSAGE2", "Cuando desactivas una encuesta TODOS los datos que fueron introducidos en la tabla original serán movidos a otra tabla, y cuando se vuelva a activar nuevamente la encuesta, la tabla estará vacía. Ya no tendrá acceso a estos datos por medio de PHPSurveyor.");
define("_AC_DEACTIVATE_MESSAGE3", "Los datos de una encuesta que ha sido desactivada solo pueden ser accesados por un usuario con acceso a la base de datos. Si tu encuesta utiliza tokens, esta tabla también será renombrada y sólo será accesible a los administradores del sistema.");
define("_AC_DEACTIVATE_MESSAGE4", "La tabla de contestaciones será renombrada a:");
define("_AC_DEACTIVATE_MESSAGE5", "Se sugiere que exportes las contestaciones antes de desactivar la encuesta. Da clic en \"Cancelar\" para regresar a la pantalla de administración sin desactivar la encuesta.");
define("_AC_DEACTIVATE", "Desactivar");
define("_AC_DEACTIVATED_MESSAGE1", "La tabla de respuestas ha sido renombrada a: ");
define("_AC_DEACTIVATED_MESSAGE2", "Las respuestas a esta encuesta ya no están disponibles a PHPSurveyor.");
...
define("_CD_NODBNAME", "La información para accesar a la base de datos no se ha dado. Este script debe ser ejecutado desde el admin.php solamente.");
...
define("_DB_FAIL_QUESTIONDELCONDITIONS", "No se pudo borrar la pregunta. Hay condiciones en otras preguntas que dependen de esta pregunta. No podrás borrar esta pregunta hasta que se quiten estas condiciones.");
define("_DB_FAIL_QUESTIONDELETE", "No se pudo borrar la pregunta.");
define("_DB_FAIL_NEWANSWERMISSING", "No se pudo agregar la respuesta. Debes incluir el Código y una Respuesta.");
define("_DB_FAIL_NEWANSWERDUPLICATE", "No se pudo agregar la respuesta. Ya existe una respuesta con este código.");
define("_DB_FAIL_ANSWERUPDATEMISSING", "No se pudo actualizar la respuesta. Debes incluir el Código y una Respuesta.");
define("_DB_FAIL_ANSWERUPDATEDUPLICATE", "No se pudo actualizar la respuesta. Ya existe una respuesta con este código.");
define("_DB_FAIL_ANSWERUPDATECONDITIONS", "No se pudo agregar la respuesta. Has cambiado su código, pero hay condiciones en otras preguntas que dependen del código anterior. Debes borrar las condiciones antes de poder cambiar el código a esta respuesta.");
...
define("_DS_DELMESSAGE1", "Estás a punto de borrar esta encuesta.");
...
define("_DS_DELMESSAGE3", "Se recomienda que antes de borrar esta encuesta exportes la encuesta entera desde la página de administración.");
define("_DS_SURVEYACTIVE", "Esta encuesta está activa y existe una tabla de contestaciones. Si la borras, estas contestaciones serán borradas. Recomendamos que las exportes antes de borrar la encuesta.");
...
//EXPORT RESULTS
define("_EX_FROMSTATS", "Filtrado del Script de Estadísticas");
...
define("_EX_COLSELECT", "Elejir columnas"); //New for 0.98rc7
define("_EX_COLOK", "Elija las columnos que desea exportar. Deje todo sin seleccionar para exportar todas las columnas."); //New for 0.98rc7
...
define("_IG_IMPORTSUMMARY", "Resumen de la Importación de la Grupo");
define("_IG_SUCCESS", "Se completó con éxito la importación de la grupo.");
define("_IG_IMPFAILED", "La importación de la grupo falló.");
...
define("_IQ_WRONGFILE", "Este archivo no es un archivo de pregunta PHPSurveypr válido. Falló la importación.");
...
define("_DR_RUSURE", "¿Esta seguro que quiere borrar esta entrada?"); //New for 0.98rc6
...
define("_ST_CALCULATION", "Calculo"); //New with 0.98rc8
...
define("_ST_MAX", "Maximo"); //New with 0.98rc8 - Mathematical
define("_ST_Q1", "Primer Cuarto (Q1)"); //New with 0.98rc8 - Mathematical
define("_ST_Q2", "Segundo Cuarto (Medio)"); //New with 0.98rc8 - Mathematical
define("_ST_Q3", "Tercer Cuarto (Q3)"); //New with 0.98rc8 - Mathematical
...
define("_DE_NOTACTIVE", "Esta encuesta no ha sido activada. Tus respuestas no serán almacenadas.");
...
define("_DE_CONDITIONHELP2", "a la pregunta {QUESTION}, contestaste {ANSWER}"); //This will be a tricky one depending on your languages syntax. {ANSWER} is replaced with ALL ANSWERS, separated by _DE_OR (OR).
define("_DE_AND", "Y");
define("_DE_OR", "O");
define("_DE_SAVEENTRY", "Salvar como encuesta parcialmente completada"); //New in 0.99dev01
...
define("_TC_DELTOKENSINFO", "Si borras esta tabla de tokens, ya no será requerido el uso de tokens para accesar esta encuesta. Se hará un respaldo de esta tabla si procede. Solo el administrador del sistema tendrá acceso a esta tabla.");
define("_TC_DELETETOKENS", "Borrar Tokens");
define("_TC_TOKENSGONE", "La tabla de tokens ha sido borrada y los tokens ya no son requeridos para accesar esta encuesta. Una copia de esta tabla ha sido creada y solo el administrador del sistema podrá accesarla.");
define("_TC_NOTINITIALISED", "No se han inicializado tokens para esta encuesta.");
define("_TC_INITINFO", "Si inicializas tokens para esta encuesta, esta solo será accesible a usuarios que tengan asignados un token.");
...
define("_TC_CREATETOKENSINFO", "Dando clic a 'Si' generará tokens para todos aquellos que esten en la lista y que no se le haya generado un token. ¿Es esto correcto?");
...
define("_TC_NOREMINDERSTOSEND", "No hubo correos electrónicos elegibles para enviar. Esto fue causado porque los criterios no se satisficieron - teniendo la dirección de correo eletrónico, haber enviado una invitación, pero no haber completado la encuesta aún.");
...
define("_TC_EMAILINVITE", "Estimado {FIRSTNAME},\n\nUsted ha sido invitado a participar en una encuesta.\n\n"
						 ...
						 ."Para participar, por favor haga click en el link de abajo.\n\nSinceramente,\n\n"
...
define("_TC_EMAILREGISTER", "Estimado {FIRSTNAME},\n\n"
						  ...
						  ."está errado, por favor, contacte a {ADMINNAME} en {ADMINEMAIL}.");//NEW for 0.98rc9
define("_TC_EMAILCONFIRM_SUBJ", "Confirmación de encuesta completada"); //New for 0.99dev01
define("_TC_EMAILCONFIRM", "Estimado {FIRSTNAME},\n\nEste correo es para confirmar que ha completadd la encuesta titulada {SURVEYNAME} "
						  ."y sus respuestas fueron salvadas. Gracias por su participación.\n\n"
						  ."Si tiene alguna otra duda con respecto a este correo, por favor contacte a {ADMINNAME} en {ADMINEMAIL}.\n\n"
						  ."Sinceramente,\n\n"
...
define("_LB_ACTIVEUSE", "No puedes cambiar los códigos, agregar o borrar entradas a este conjunto de etiquetas porque está siendo utilizado por una encuesta activa.");
define("_LB_TOTALUSE", "Algunas encuestas están utilizando este conjunto de etiquetas. El modificar los códigos, agregar o borrar entradas a este conjunto puede producir resultados indeseados.");
//Export Labels
...
define("_PS_TITLE", "Resúmen de PHPSurveyor");
...
define("_CD_COPYRUSURE", "¿Está seguro que desea copiar estas condiciones a las preguntas que ha seleccionado?"); //New with 098rc9
define("_CD_NODIRECT", "No puede correr este script directamente."); //New with 098rc9
...
define("_CD_DIDNOTCOPYQ", "No se copió las preguntas"); //New with 098rc9
...
define("_TP_STANDARDFILES", "Archivo Estandar:");  //New with 098rc9
...
define("_TP_SAVEPAGE", "Página de Salvar Encuesta"); //New with 0.99dev01

//Saved Surveys
define("_SV_RESPONSES", "Respuestas Salvadas:");
define("_SV_IDENTIFIER", "Identificador");
define("_SV_RESPONSECOUNT", "Contestado");
define("_SV_IP", "Dirección IP");
define("_SV_DATE", "Fecha Salvada");
...
define("_VV_ENTRYFAILED", "Importción Faillida en el Elemento");
...
define("_VV_RUSURE", "Si ha elejido exportar y desactivar, ésto va a renombrar su tabla actual de respuestas y no será facil restaurarla. ¿Está seguro?");

//ASSESSMENTS
define("_AS_TITLE", "Evaluaciones");
define("_AS_DESCRIPTION", "Si crea alguna evaluación en esta página, para la encuesta actualmente seleccionada, la evaluación será realizada al final, despues de ser enviada la encuesta");
define("_AS_NOSID", "No SID Provisto");
define("_AS_SCOPE", "Alcance");
define("_AS_MINIMUM", "Minimo");
define("_AS_MAXIMUM", "Maximo");
...
define ("_DC_TITLE", "Verificación de Concistencia de Datos<br /><font size='1'>Si aparecen errores, puede que usted deba ejecutar este script repetidas veces. </font>"); // New with 0.99stable
define ("_DC_QUESTIONSOK", "Todas las preguntas son concistentes"); // New with 0.99stable
define ("_DC_ANSWERSOK", "Todas las respuestas son concistentes"); // New with 0.99stable
define ("_DC_CONDITIONSSOK", "Todas las condiciones son concistentes"); // New with 0.99stable
define ("_DC_GROUPSOK", "Todos los grupos son concistentes"); // New with 0.99stable
...
define ("_DC_QAOK", "Todos los atributos de preguntas son concistentes"); // New with 0.99stable
define ("_DC_ASSESSOK", "Todas las evaluaciones son concistentes"); // New with 0.99stable
