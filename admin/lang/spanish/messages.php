...
define("_SL_EXPIRYDATE", "Expiraci&oacute;n:");
...
define("_AC_DEACTIVATE_MESSAGE2", "Cuando desactivas una encuesta TODOS los datos que fueron introducidos en la tabla original ser&aacute;n movidos a otra tabla, y cuando se vuelva a activar nuevamente la encuesta, la tabla estar&aacute; vac&iacute;a. Ya no tendrá acceso a estos datos por medio de PHPSurveyor.");
