...
function questionjavascript($type)
{
    ...
    . "document.getElementById('Validation').style.display = 'none';\n"
    . "document.getElementById('MandatorySelection').style.display='';\n"
    . "document.getElementById('MaxFileSize').style.display='';\n"
    . "document.getElementById('MaxNumOfFilea').style.display='';\n"
    . "document.getElementById('MinNumOfFilea').style.display='';\n"
