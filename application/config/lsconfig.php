...
$config['adminscripts']            = $config['rootdir'].DIRECTORY_SEPARATOR."application".DIRECTORY_SEPARATOR."scripts".DIRECTORY_SEPARATOR;
$config['generalscripts']          = $config['rootdir'].DIRECTORY_SEPARATOR."scripts".DIRECTORY_SEPARATOR;
