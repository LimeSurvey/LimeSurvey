        ...
        */
        function actionView($surveyid,$printableexport=FALSE)
        {
            ...
            if($sExportType == 'pdf')
            {
                ...
                $oPDF = new pdf();
                $sHeaderString = $sSurveyName." (".$clang->gT("ID",'unescaped').":".$iSurveyID.")";
                $oPDF->initAnswerPDF($aPdfLanguageSettings, Yii::app()->getConfig('sitename'), $sLanguage, $sSurveyName, $sHeaderString);
