...
class SurveymenuController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Surveymenu');
	...
	{
		$model=new Surveymenu('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Surveymenu']))
			$model->attributes=$_GET['Surveymenu'];
