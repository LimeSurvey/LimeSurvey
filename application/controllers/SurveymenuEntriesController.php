...
class SurveymenuEntriesController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('SurveymenuEntries');
	...
	{
		$model=new SurveymenuEntries('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['SurveymenuEntries']))
			$model->attributes=$_GET['SurveymenuEntries'];
