...
class UserManagementController extends LSBaseController
{
    ...
    /**
     * Render the import-users modal partial for a given import format.
     *
    ...
    /**
         * Imports users from an uploaded CSV or JSON file, creating new users or updating existing ones, then redirects to the user index.
         *
         * @param string $importFormat Format of the uploaded file; must be "csv" or "json".
         * @return string The rendered error partial when the current user lacks create permission; otherwise the action performs a redirect to the user index (no meaningful return).
