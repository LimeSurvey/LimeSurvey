...
class Statistics extends SurveyCommonAction
{
    ...
    public function simpleStatistics($surveyid)
    {
        ...
        $colonArrayNumberQuestions = Question::model()->findAll("sid = :sid and `type` = :type", [
            ":sid" => $surveyid,
        ...
        foreach ($colonArrayNumberQuestions as $colonArrayNumberQuestion) {
            $questions[$colonArrayNumberQuestion->qid] = $colonArrayNumberQuestion;
        }
