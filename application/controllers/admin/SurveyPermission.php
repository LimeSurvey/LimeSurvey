...
class SurveyPermission extends SurveyCommonAction
{
    ...
    public function index($iSurveyID)
    {
        ...
        if (Permission::model()->hasSurveyPermission($iSurveyID, 'surveysecurity', 'create')) {
            ...
            . "<li><label class='col-sm-1 col-md-offset-2 text-right form-label' for='uidselect'>" . gT("User") . ": </label>
                 <div class='col-sm-4'>
            ...
            . "<label  class='col-sm-1 col-md-offset-2  text-right form-label'  for='ugidselect'>" . gT("User group") . ": </label>
                <div class='col-sm-4'>
