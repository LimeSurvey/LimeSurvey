...
class printablesurvey extends Survey_Common_Action
{
     ...
     */
    public function index($surveyid, $lang = null)
    {
            ...
            while ($rounds < 1) {
                ...
                if ($server_is_newer) {
                    ...
                    array(
                                             ...
                                             '[[EMPTY-TABLE-CELL]]', '[[EMPTY-TABLE-CELL-HEADER]]', '',
                                             ), $survey_output['GROUPS'], -1, $replace_count
                                             );
                } else {
