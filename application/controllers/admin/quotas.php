...
class quotas extends Survey_Common_Action
{
    ...
    public function _redirectToIndex($iSurveyId)
    {
    ...
    public function insertquota($iSurveyId)
    {
        $iSurveyId = sanitize_int($iSurveyId);
    ...
    public function modifyquota($iSurveyId)
    {
        $iSurveyId = sanitize_int($iSurveyId);
    ...
    public function editquota($iSurveyId)
    {
        $iSurveyId = sanitize_int($iSurveyId);
        $this->_checkPermissions($iSurveyId, 'update');
        $aData = $this->_getData($iSurveyId);
