        ...
        if (!Yii::app()->request->getQuery('ok')) {
            ...
            $this->_renderWrappedTemplate('token', array('message' => array(
                ...
                'message' => $alert
                    ...
                    . gT("Anonmymize survey")."' onclick=\"window.open('".$this->getController()->createUrl("admin/survey/sa/anonymize/surveyid/{$iSurveyId}/ok/Y")."', '_top')\" />\n"
                    . "<input class='btn btn-default' type='submit' value='"
                    . gT("Cancel")."' onclick=\"window.open('".$this->getController()->createUrl("admin/survey/sa/view/surveyid/{$iSurveyId}")."', '_top')\" /></div>\n"
            )), $aData);
        }
