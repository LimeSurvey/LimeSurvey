...
class tokens extends Survey_Common_Action
{
    ...
    */
    function bounceprocessing($iSurveyId)
    {
        ...
        if ($thissurvey['bounceprocessing'] != 'N' ||  ($thissurvey['bounceprocessing'] == 'G' && \SettingGlobal::get('bounceaccounttype') != 'off'))
        {
            ...
            {
                $accounttype=strtoupper(\SettingGlobal::get('bounceaccounttype'));
                $hostname = \SettingGlobal::get('bounceaccounthost');
                $username = \SettingGlobal::get('bounceaccountuser');
                $pass = \SettingGlobal::get('bounceaccountpass');
                $hostencryption=strtoupper(\SettingGlobal::get('bounceencryption'));
            }
            else
            {
