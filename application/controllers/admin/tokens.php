    ...
    */
    function getTokens_json($iSurveyId, $search = null)
    {
        ...
        foreach ($tokens as $token)
        {
            ...
            if (strtolower($token['emailstatus']) == 'ok' && Permission::model()->hasSurveyPermission($iSurveyId, 'tokens', 'update')) {
    ...
    */
    function email($iSurveyId, $tokenids = null)     
    {
        ...
        if (!Yii::app()->request->getPost('ok'))
        {
            ...
            {
                $aData['tokenids'] = TokenDynamic::model($iSurveyId)->findUninvitedIDs($aTokenIds, 0, $bEmail, $SQLemailstatuscondition);
            }
