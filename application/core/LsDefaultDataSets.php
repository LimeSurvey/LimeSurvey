...
class LsDefaultDataSets
{
    ...
    public static function getTemplateConfigurationData()
    {
        ...
        $returnArray[] = [
            ...
            'files_print_css'   => '{"add":["css/print_theme.css"]}',
            'options'           => '{"hideprivacyinfo":"off","showpopups":"1","showclearall":"off","questionhelptextposition":"top","fixnumauto":"enable","deselectsinglechoice":"off","cornerradius":"2","backgroundimage":"off","backgroundimagefile":".\/files\/pattern.png","brandlogo":"off","brandlogofile":"image::theme::files\/logo.png","font":"ibm-sans", "bodybackgroundcolor":"#ffffff","fontcolor":"#444444", "questionbackgroundcolor":"#ffffff", "checkicon":"EB7A","cssframework":"apple", "notables":"1"}',
            'cssframework_name' => '',
            'cssframework_css'  => '',
            'cssframework_js'   => '',
