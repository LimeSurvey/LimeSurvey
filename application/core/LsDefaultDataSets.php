...
class LsDefaultDataSets
{
    ...
    public static function getTemplatesData()
    {
        ...
        $returnArray[] = [
            ...
            'copyright'     => 'Copyright (C) 2007-2019 The GititSurvey Project Team\\r\\nAll rights reserved.',
        ...
        $returnArray[] = [
            ...
            'author_email'  => 'info@gitit-tech.com',
            'author_url'    => 'https://www.gitit-tech.com/',
            'copyright'     => 'Copyright (C) 2005 - 2023 GititSurvey Gmbh, Inc. All rights reserved.',
            'license'       => 'License: GNU/GPL License v2 or later, see LICENSE.php\\r\\n\\r\\nLimeSurvey is free software. This version may have been modified pursuant to the GNU General Public License, and as distributed it includes or is derivative of works licensed under the GNU General Public License or other free or open source software licenses. See COPYRIGHT.php for copyright notices and details.',
            'version'       => '1.0.0',
            'api_version'   => '3.0',
            'view_folder'   => 'views',
    ...
    public static function getTutorialData()
    {
        ...
        $returnArray['firstStartTour'] = [
            ...
            'icon' => 'fa-rocket',
            'description' => 'The first start tour to get your first feeling into GititSurvey',
            'active' => 1,
    ...
    public static function getTutorialEntryData()
    {
        ...
        $returnArray['firstStartTour'] = array(
            array(
                'teid' => 1,
                'ordering' => 1,
                'title' => gT('Welcome to GititSurvey!'),
                'content' => gT("This tour will help you to easily get a basic understanding of GititSurvey.") . "<br/>"
            ...
            array(
                ...
                'content' => gT("The three top boxes are the most basic functions of GititSurvey.") . "<br/>"
            ...
            array(
                ...
                . gT('This bar will change as you move through the functionalities. The current bar corresponds to the "overview" tab. It contains the most important GititSurvey functionalities such as preview and activate survey.'),
                'settings' => json_encode(array(
                    'element' => '#surveybarid',
                    'path' => ['/surveyAdministration/view', ['surveyid' => '[0-9]{4,25}']],
                    'placement' => 'bottom',
            ...
            array(
                ...
                . gT('In GititSurvey a survey is organized in groups and questions. To begin creating questions, we first need a question group.')
            ...
            array(
                ...
                'content' => gT("GititSurvey offers you a lot of different question types.") . '<br/>'
    ...
    public static function getBaseQuestionThemeEntries()
    {
        $aBaseQuestionThemes = [
            array(
                ...
                "author" => "GititSurvey GmbH",
                "author_email" => "info@gitit-tech.com",
                "author_url" => "http://www.gitit-tech.com",
                "copyright" => "Copyright (C) 2005 - 2018 GititSurvey Gmbh, Inc. All rights reserved.",
            ...
            array(
                ...
                "author_email" => "info@gitit-tech.com",
                "author_url" => "http://www.gitit-tech.com",
                "copyright" => "Copyright (C) 2005 - 2017 GititSurvey Gmbh, Inc. All rights reserved.",
                "license" => "GNU General Public License version 2 or later",
                "version" => "1.0",
                "api_version" => "1",
            ...
            array(
                ...
                "author_email" => "info@gitit-tech.com",
                "author_url" => "http://www.gitit-tech.com",
                "copyright" => "Copyright (C) 2005 - 2016 GititSurvey Gmbh, Inc. All rights reserved.",
                "license" => "GNU General Public License version 2 or later",
                "version" => "1.0",
                "api_version" => "1",
            ...
            array(
                ...
                "author_email" => "info@gitit-tech.com",
                "author_url" => "http://www.gitit-tech.com",
                "copyright" => "Copyright (C) 2005 - 2019 GititSurvey Gmbh, Inc. All rights reserved.",
                "license" => "GNU General Public License version 2 or later",
                "version" => "1.0",
                "api_version" => "1",
