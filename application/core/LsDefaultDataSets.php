...
class LsDefaultDataSets {
    ...
    public static function getSurveyMenuEntryData(){
        ...
        $basicMenues = [
            ...
            [1,NULL,7,'publication', gT('Publication and access control settings'),gT('Publication & access'),gT('Edit settings for publication and access control'),'key','fontawesome','','','updatesurveylocalesettings','editLocalSettings_main_view','/admin/survey/subview/accordion/_publication_panel','','surveylocale','read',NULL,'_tabPublicationAccess','en-GB',1, date('Y-m-d H:i:s'),0,date('Y-m-d H:i:s'),0],
