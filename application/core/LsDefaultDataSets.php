...
class LsDefaultDataSets
{
    ...
    public static function getBoxesData()
    {
        ...
        $returnArray[] = ['position' => 5, 'url' => 'https://www.limesurvey.org/limestore', 'title' => gT('LimeStore'), 'ico' => 'fa fa-shopping-basket', 'desc' => gT('LimeSurvey extension marketplace'), 'page' => 'welcome', 'usergroup' => '-2'];
