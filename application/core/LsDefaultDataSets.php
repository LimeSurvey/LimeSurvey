                    ...
                    . "<div class='popover-navigation lstutorial__template--navigation'>"
                        . "<div class='row'>"
                            . "<div class='btn-group col-xs-12' role='group' aria-label='...'>"
                                . "<button role='button' type='button' class='btn btn-outline-secondary col-md-6' data-role='prev'>" . gT('Previous', 'js') . "</button>"
                                . "<button role='button' type='button' class='btn btn-primary col-md-6' data-role='next'>" . gT('Next', 'js') . "</button>"
                            . "</div>"
                        . "</div>"
                    . "</div>"
                . "</div>",
