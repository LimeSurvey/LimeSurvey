<div class='footer'>
    ...
    <div style='float:right;'>
        <a class='ls-link' href='https://donate.limesurvey.org' target="_blank"><img alt='<?php printf(gT("Support this project - Donate to %s!"), "LimeSurvey"); ?>' title='<?php printf(gT("Support this project - Donate to %s!"), "LimeSurvey"); ?>' src='<?php echo Yii::app()->getConfig('adminimageurl'); ?>donate.png'/></a>
    </div>
