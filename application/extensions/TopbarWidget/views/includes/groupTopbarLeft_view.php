...
<?php if (!empty(trim($toolsDropdownItems))): ?>
    ...
    <div class="btn-group hidden-xs">
        ...
        <button role="button" id="ls-question-group-tools-button" type="button" class="btn btn-outline-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
