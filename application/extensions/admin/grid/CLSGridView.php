...
class CLSGridView extends TbGridView
{
    ...
    protected function appendAdditionalColumns(): void
    {
        ...
        $columns_filter_button = '<button role="button" type="button" aria-label="select columns " class="btn b-0" data-bs-toggle="modal" data-bs-target="#survey-column-filter-modal">
