...
class SurveyListMassiveActions
{
        ...
        return [
            ...
            [
                ...
                'htmlModalBody' => Yii::app()->getController()->renderFile(
                    dirname(__FILE__) . '/../../../survey/ListSurveysWidget/views/massive_actions/_select_survey_theme.php',
                    [],
                    true
                ),
            ],
            ...
            [
                ...
                'iconClasses' => 'ri-add-circle-line',
                ...
                'htmlModalBody' => Yii::app()->getController()->renderFile(
                    dirname(__FILE__) . '/../../../survey/ListSurveysWidget/views/massive_actions/_change_survey_group.php',
                    [],
                    true
                ),
            ],
