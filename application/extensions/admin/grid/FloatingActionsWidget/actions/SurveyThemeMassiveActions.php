...
/**
 * Massive (floating bar) actions for the "Installed survey themes" grid.
 *
 * Returns the action definitions consumed by FloatingActionsWidget for the
 * survey themes grid. Only the actions the current user is permitted to run are
 * included.
 */
class SurveyThemeMassiveActions
{
    /**
     * @return array
     */
