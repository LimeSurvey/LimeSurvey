...
class TbButton extends CWidget
{
    ...
    public $block = false;
    /**
     * @var bool indicates whether the button is active.
     */
    public $active = false;
    /**
     * @var bool indicates whether the button is disabled.
     */
    public $disabled = false;
    /**
     * @var bool indicates whether to encode the label.
     */
    public $encodeLabel = true;
    /**
     * @var bool indicates whether to enable toggle.
     */
    public $toggle;
    /**
