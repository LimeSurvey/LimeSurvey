...
{
    /**
     * @var bool if set to true will keep the header fixed  position
     */
    public $fixedHeader = false;

    /**
     * @var int, when is set to true, headerOffset will position table header top position
    ...
    /**
     * @var array displays an extended summary version. There are different types of summary types,
    ...
    /**
     * @var string is the class name of the layer containing the extended summary
     */
    public $extendedSummaryCssClass = 'extended-summary';

    /**
     * @var array the HTML attributes of the layer containing the extended summary
     */
    public $extendedSummaryOptions = array();

    /**
     * @var array has scripts that will be executed after components have updated.
    ...
    /**
     * @var array hold scripts that will be executed on document ready.
     *            It is used internally to render scripts required for components to work correctly. You may use it for your own
     *            scripts, just make sure it is of type array.
     */
    ...
    /**
     * @var array if configured, the extended view will display a highcharts chart.
     */
    public $chartOptions = array();

    /**
     * @var bool. If true the rows at the table will be sortable.
     */
    ...
    /**
     * @var bool Save sort order by ajax defaults to false
     *
    ...
    /**
     * @var bool a helper property that is set to true if we have to render the
     *           extended summary
     */
    protected $displayExtendedSummary;
    /**
     * @var bool a helper property that is set to true if we have to render a chart.
     */
    protected $displayChart;

    /**
     * @var array hold the current configured TbOperation that will process column values.
     */
    protected $extendedSummaryTypes = array();

    /**
     * @var array hold the supported operation types
     */
...
{
    /**
     * @var string the template to display label and value of the operation at the summary
     */
    public $template = '{label}: {value}';

    /**
     * @var int the resulted value of operation
     */
    public $value = 0;

    /**
     * @var string the label of the calculated value
     */
    public $label;
...
{
    /**
     * @var float the total sum
     */
    protected $total;

    /**
     * @var array the supported type of values
     */
...
class TbCountOfTypeOperation extends TbOperation
{
    ...
    /**
     * @var string holds the template of each calculated type
     */
    public $typeTemplate = '{label}({value})';

    /**
     * @var array hold the configuration of types to calculate. The configuration is set by an array which keys
...
class TbPercentOfTypeOperation extends TbCountOfTypeOperation
{
    ...
    /**
     * @var holds the total sum of the values. Required to get the percentage.
     */
    protected $_total;
...
{
    /**
     * @var string the class name of the layer holding the chart
     */
    ...
    /**
     * @var array the configuration data of the chart
     */
...
{
    /**
     * @var string the class of the layer containing the class
     */
