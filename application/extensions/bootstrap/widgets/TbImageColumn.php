...
class TbImageColumn extends CGridColumn
{
    ...
    /**
     * @var string is evaluated in every data cell and
    ...
    /**
     * @var string renders if  is null
     */
    public $emptyText = '';

    /**
     * @var bool whether to use a bogus image from placehold.it or not. If true, will render an image
    ...
    /**
     * @var bool whether to use bogus image from placekitten.com or not. If true, will render an image
    ...
    /**
     * @var string the size of the image to render if is null and $userPlaceHoldIt
     *             is set to true
     */
    public $placeHoldItSize = '48x48';

    /**
     * @var string the size of the image to render if is null and $usePlaceKitten
     *             is set to true
     */
