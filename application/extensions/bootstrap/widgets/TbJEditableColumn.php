...
{
    /**
     * @var string the route to make AJAX calls to
     */
    public $saveURL;

    /**
     * @var array the jEditable jquery plugin options
     */
    public $jEditableOptions = array();

    /**
     * @var string the class that
     */
    public $cssClass = 'tbjeditable-column';

    /**
     * @var the event jEditable plugin should be displayed (ie dbclick, click...)
     */
    protected $event;
