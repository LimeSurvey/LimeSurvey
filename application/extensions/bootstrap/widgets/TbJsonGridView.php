...
{
    /**
     * @var bool true when there is an AJAX request. TbJsonGridView expect a JSON response.
     */
    public $json;

    /**
     * @var string display pager on top by default, override to place two pagers as we expect lots of records
     */
    public $template = "{pager}\n{items}\n{summary}\n{pager}";

    /**
     * @var int how long we keep the responses on cache? It will depend on cacheTTLType (seconds, minutes, hours)
     */
    public $cacheTTL = 1;
    ...
    /**
     * @var bool whether we use client ajax cache or not. True by default.
     */
