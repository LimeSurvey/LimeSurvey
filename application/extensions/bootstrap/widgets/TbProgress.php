...
class TbProgress extends CWidget
{
    ...
    public $type;
    /**
     * @var bool indicates whether the bar is striped.
     */
    public $striped = false;
    /**
     * @var bool indicates whether the bar is animated.
     */
    public $animated = false;
    /**
     * @var int the amount of progress in percent.
     */
    public $percent = 0;
    /**
    ...
    public $content;
    /**
     * @var array set to an array of progress bar values to display stacked progress bars
     *            <pre>
     *            'stacked'=>array(
