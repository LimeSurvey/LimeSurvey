...
class TbRelationalColumn extends TbDataColumn
{
    ...
    /**
     * @var string the class name that will wrap up the cell content.
    ...
    /**
     * @var string the message that is displayed on the newly created row in case there is an AJAX
     *             error.
     */
