...
function browsemenubar($title='',$surveyid=null,$load=false)
{
    ...
    . "<a href='".site_url('admin/survey/view/'.$surveyid)."' title=\"".$clang->gTview("Return to survey administration")."\" >"
    ...
    if (bHasSurveyPermission($surveyid,'responses','read'))
    {
        ...
        {
            $browsemenubar .="<a href='".site_url('admin/browse/'.$surveyid.'/all')."' title=\"".$clang->gTview("Display Responses")."\" >" .
        ...
        else
        {
            ...
            {
                $browsemenubar .= "<li><a href=\"".site_url('admin/browse/'.$surveyid.'/all/'.$tmp_lang)."\" accesskey='b'>".getLanguageNameFromCode($tmp_lang,false)."</a></li>";
            }
    ...
    {
        $browsemenubar .= "<a href='".site_url('admin/dataentry/view/'.$surveyid)."'".
    ...
    {
        $browsemenubar .= "<a href='".site_url('admin/statistics/'.$surveyid)."' "
