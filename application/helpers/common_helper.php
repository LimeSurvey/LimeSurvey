 ...
 */
function checkUploadedFileSize($sFileName, $customMaxSize = null)
{
 ...
 * @param mixed $customMaxSize maximum file upload size
 */
function checkUploadedFileSizeAndRedirect($sFileName, $redirectUrl, $customMaxSize = null)
{
    try {
        checkUploadedFileSize($sFileName, $customMaxSize);
    } catch (Exception $ex) {
 ...
 * @param mixed $customMaxSize maximum file upload size
 */
function checkUploadedFileSizeAndRenderJson($sFileName, $debugInfo = [], $customMaxSize = null)
{
    try {
        checkUploadedFileSize($sFileName, $customMaxSize);
    } catch (Exception $ex) {
