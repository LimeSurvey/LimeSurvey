...
'max' => array('max', 'LEMmax', gT('Find highest value'), 'number max(arg1, arg2, ... argN)', 'http://php.net/max', -2),
'min' => array('min', 'LEMmin', gT('Find lowest value'), 'number min(arg1, arg2, ... argN)', 'http://php.net/min', -2),
