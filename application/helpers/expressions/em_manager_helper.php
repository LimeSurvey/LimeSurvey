        ...
        foreach ($LEM->currentQset as $q) {
            ...
            if ($gseq != $_gseq) {
                ...
                if ($bGroupHaveError) {
                    $haveErrors = true;
                    $errClass = 'danger';
                    $errText = "<br><em class='badge label-danger'>" . $LEM->gT("This group has at least 1 error.") . "</em>";
                }
            ...
            $errText = ($errorCount > 0) ? "<br><em class='badge label-danger'>" . $LEM->ngT("This question has at least {n} error.|This question has at least {n} errors.", $errorCount) . "</em>" : "";
