...
class questionHelper
{
    ...
    public static function getQuestionThemeAttributeValues($type, $sQuestionThemeName = null)
    {
        ...
        // Add the questions attributes by plugins for questionedit->getAdvancedOptions
        $pluginsAttribute = QuestionAttribute::getQuestionAttributesPlugins($type);

        return array_merge($aQuestionAttributes, $additionalAttributes,$pluginsAttribute);
    }
