...
class questionHelper
{
    ...
    public static function getAttributesDefinitions()
    {
        ...
        "types"=>Question::QT_EXCLAMATION_LIST_DROPDOWN . Question::QT_L_LIST_DROPDOWN . Question::QT_O_LIST_WITH_COMMENT . Question::QT_W . Question::QT_Z_LIST_RADIO_FLEXIBLE,
        'category'=>gT('Display'),
        'sortorder'=>100,
        'inputtype'=>'switch',
        ...
        "types"=>Question::QT_W . Question::QT_Z_LIST_RADIO_FLEXIBLE,
        'category'=>gT('Logic'),
        'sortorder'=>100,
        'inputtype'=>'text',
        ...
        "types"=>Question::QT_A_ARRAY_5_CHOICE_QUESTIONS . Question::QT_B_ARRAY_10_CHOICE_QUESTIONS . Question::QT_C_ARRAY_YES_UNCERTAIN_NO . Question::QT_E_ARRAY_OF_INC_SAME_DEC_QUESTIONS . Question::QT_F_ARRAY_FLEXIBLE_ROW . Question::QT_M_MULTIPLE_CHOICE . Question::QT_P_MULTIPLE_CHOICE_WITH_COMMENTS . Question::QT_K_MULTIPLE_NUMERICAL_QUESTION . Question::QT_Q_MULTIPLE_SHORT_TEXT,
        'category'=>gT('Logic'),
        'sortorder'=>130,
        'inputtype'=>'text',
        ...
        "types"=>Question::QT_P_MULTIPLE_CHOICE_WITH_COMMENTS . Question::QT_L_LIST_DROPDOWN . Question::QT_W . Question::QT_EXCLAMATION_LIST_DROPDOWN . Question::QT_Z_LIST_RADIO_FLEXIBLE,
        'category'=>gT('Logic'),
        'sortorder'=>100,
        'inputtype'=>'switch',
        'options'=>array(0=>gT('No'),
        ...
        "types"=>Question::QT_L_LIST_DROPDOWN . Question::QT_M_MULTIPLE_CHOICE . Question::QT_P_MULTIPLE_CHOICE_WITH_COMMENTS . Question::QT_W . Question::QT_Z_LIST_RADIO_FLEXIBLE . Question::QT_EXCLAMATION_LIST_DROPDOWN,
        'category'=>gT('Display'),
        'sortorder'=>100,
        'inputtype'=>'text',
        'i18n'=>true,
