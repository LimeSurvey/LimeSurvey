...
EOD;
        ...
        $coreReplacements['SAVE'] = $survey->bool_allowsave ? doHtmlSaveAll(isset($move) ? $move : null, $survey) : '';
...
* @return string
**/
function doHtmlSaveAll($move = "", Survey $survey)
{
