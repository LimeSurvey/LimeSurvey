    ...
    */
    ...
    if (isset($thissurvey['allowsave']) and $thissurvey['allowsave'] == "Y")
    {
        ...
        if ($thissurvey['format'] == 'A')
        {
            ...
            {
                $_saveall = "\t\t\t<input type='submit' name='loadall' value='" . $clang->gT("Load unfinished survey") . "' class='saveall' onclick=\"javascript:addHiddenField(document.getElementById('limesurvey'),'loadall',this.value);document.getElementById('limesurvey').submit();\" " . (($thissurvey['active'] != "Y") ? "disabled='disabled'" : "") . "/>"
