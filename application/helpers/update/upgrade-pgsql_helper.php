...
function db_upgrade($oldversion) {
    ...
    if ($oldversion < 127) {
        ...
        modifyDatabase("","create index assessments_idx on prefix_assessments (gid)"); echo $modifyoutput;  flush();@ob_flush();
    ...
    if ($oldversion < 129) {
        //129
        modifyDatabase("","ALTER TABLE prefix_surveys ADD startdate date"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 130)
    {
        modifyDatabase("","ALTER TABLE prefix_conditions ADD scenario integer NOT NULL default '1'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","UPDATE prefix_conditions SET scenario=1 where (scenario is null) or scenario=0"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 133)
    {
        modifyDatabase("","ALTER TABLE prefix_users ADD one_time_pw bytea"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("","ALTER TABLE prefix_answers ADD assessment_value integer NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_labels ADD assessment_value integer NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        // copy any valid codes from code field to assessment field
        modifyDatabase("","update [prefix_answers set assessment_value=CAST(code as integer)");// no output here is intended
        modifyDatabase("","update prefix_labels set assessment_value=CAST(code as integer)");// no output here is intended
        ...
        modifyDatabase("","ALTER TABLE prefix_assessments ADD language character varying(20) NOT NULL default 'en'"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("","update prefix_assessments set message=cast(message as character) ||'<br /><a href=\"'||link||'\">'||link||'</a>'"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("","ALTER TABLE prefix_assessments DROP CONSTRAINT prefix_assessments_pkey"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_assessments ADD CONSTRAINT prefix_assessments_pkey PRIMARY KEY (id,language)"); echo $modifyoutput; flush();@ob_flush();

        // Add new fields to survey language settings
        modifyDatabase("","ALTER TABLE prefix_surveys_languagesettings ADD surveyls_url character varying(255)"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 135)
    {
        modifyDatabase("","ALTER TABLE prefix_question_attributes ALTER COLUMN value TYPE text"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","update prefix_settings_global set stg_value='135' where stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 136)
    {
        modifyDatabase("","ALTER TABLE prefix_quota ADD autoload_url integer NOT NULL DEFAULT 0"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("","ALTER TABLE ONLY prefix_quota_languagesettings
        ADD CONSTRAINT prefix_quota_languagesettings_pkey PRIMARY KEY (quotals_id);"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE ONLY prefix_users ADD CONSTRAINT prefix_users_pkey PRIMARY KEY (uid)"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE ONLY prefix_users ADD CONSTRAINT prefix_user_name_key UNIQUE (users_name)"); echo $modifyoutput; flush();@ob_flush();
    ...
    {
        modifyDatabase("", "ALTER TABLE prefix_surveys_languagesettings ADD surveyls_dateformat integer NOT NULL default 1"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_users ADD \"dateformat\" integer NOT NULL default 1"); echo $modifyoutput; flush();@ob_flush();
    ...
    {
        modifyDatabase("", "ALTER TABLE prefix_quota_members ALTER COLUMN code TYPE character varying(11)"); echo $modifyoutput; flush();@ob_flush();
    ...
    {
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD \"tokenlength\" smallint NOT NULL DEFAULT '15'"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 142) //Modify surveys table
    {
        ...
        modifyDatabase("", "ALTER TABLE prefix_surveys ALTER COLUMN \"startdate\" TYPE timestamp"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ALTER COLUMN \"expires\" TYPE timestamp"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 143) //Modify surveys table
    {
        ...
        modifyDatabase("", "ALTER TABLE prefix_answers ADD scale_id smallint NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_questions ADD scale_id smallint NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_questions ADD same_default smallint NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_answers DROP CONSTRAINT prefix_answers_pkey"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_answers ADD CONSTRAINT prefix_answers_pkey PRIMARY KEY (qid,code,language,scale_id)"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("","ALTER TABLE prefix_defaultvalues ADD CONSTRAINT prefix_defaultvalues_pkey PRIMARY KEY (qid , scale_id, language, specialtype, sqid)"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("", "create INDEX sess2_expiry on prefix_sessions( expiry );"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "create INDEX sess2_expireref on prefix_sessions ( expireref );"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 145)
    {
        ...
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceprocessing character varying(1) NULL default 'N'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceaccounttype character varying(4) NULL"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceaccounthost character varying(200) NULL"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceaccountpass character varying(100) NULL"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceaccountencryption character varying(3) NULL"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD bounceaccountuser character varying(200) NULL"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("", "ALTER TABLE prefix_surveys ADD navigationdelay smallint NOT NULL default '0'"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("", "ALTER TABLE ONLY prefix_survey_permissions ADD CONSTRAINT prefix_survey_permissions_pkey PRIMARY KEY (sid,uid,permission);"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("", "ALTER TABLE prefix_surveys_languagesettings ADD email_admin_notification_subj character varying(255)");
        modifyDatabase("", "ALTER TABLE prefix_surveys_languagesettings ADD email_admin_responses_subj character varying(255)");
        modifyDatabase("", "ALTER TABLE prefix_surveys_languagesettings ADD email_admin_notification text");
        modifyDatabase("", "ALTER TABLE prefix_surveys_languagesettings ADD email_admin_responses text");
        ...
        modifyDatabase("","ALTER TABLE prefix_conditions ALTER COLUMN method TYPE CHAR(5)"); echo $modifyoutput; flush();@ob_flush();

        modifyDatabase("","UPDATE prefix_surveys set private='N' where private is NULL;"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_surveys RENAME COLUMN private TO anonymized;"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_surveys ALTER COLUMN anonymized TYPE char(1);"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_surveys ALTER COLUMN anonymized SET DEFAULT 'N';"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_surveys ALTER COLUMN anonymized SET NOT NULL ;"); echo $modifyoutput; flush();@ob_flush();
        ...
        modifyDatabase("", "ALTER TABLE  prefix_surveys_languagesettings ADD surveyls_numberformat integer default 0 NOT NULL"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 146) //Modify surveys table
    {
        ...
        modifyDatabase("", "INSERT into prefix_survey_permissions (sid,uid,permission,read_p,update_p) SELECT sid,owner_id,'translations','1','1' from prefix_surveys"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='146' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }

    if ($oldversion < 147)
    {
        modifyDatabase("", "ALTER TABLE prefix_users ADD templateeditormode character varying(7) NOT NULL DEFAULT 'default'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "ALTER TABLE prefix_users ADD questionselectormode character varying(7) NOT NULL DEFAULT 'default'"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='147' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 148)
    {
        modifyDatabase("","ALTER TABLE prefix_users ADD participant_panel integer NOT NULL default '0'"); echo $modifyoutput; flush(); @ob_flush();
        ...
        participant_id("","CREATE TABLE prefix_survey_links (
        participant_id character varying( 50 ) NOT NULL,
    ...
    if ($oldversion < 149)
    {
        ...
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='149' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();

    }
    if ($oldversion < 150)
    {
        modifyDatabase("","ALTER TABLE prefix_questions ADD relevance TEXT;"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='150' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 151)
    {
        modifyDatabase("","ALTER TABLE prefix_groups ADD randomization_group character varying(20) NOT NULL DEFAULT '';"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='151' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 152)
    {
        modifyDatabase("","CREATE INDEX question_attributes_idx3 ON prefix_question_attributes (attribute);"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='152' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 153)
    {
        modifyDatabase("",'CREATE TABLE prefix_expression_errors (
        "id" serial PRIMARY KEY NOT NULL,
        ...
        modifyDatabase("", "UPDATE prefix_settings_global SET stg_value='153' WHERE stg_name='DBVersion'"); echo $modifyoutput; flush();@ob_flush();
    }
    if ($oldversion < 154)
    {
    ...
    if ($oldversion < 155)
    {
        ...
        modifyDatabase("","ALTER TABLE prefix_surveys ADD googleanalyticsapikey character varying(25) DEFAULT NULL;"); echo $modifyoutput; flush();@ob_flush();
        modifyDatabase("","ALTER TABLE prefix_surveys RENAME COLUMN showXquestions TO showxquestions;"); echo $modifyoutput; flush();@ob_flush();
    ...
    if ($oldversion < 156)
    {
        ...
        modifyDatabase("","ALTER TABLE prefix_surveys_languagesettings ADD surveyls_attributecaptions TEXT NULL;"); echo $modifyoutput; flush();@ob_flush();
...
function upgrade_token_tables128()
{
    ...
    else
    {
        ...
        {
            modifyDatabase("","ALTER TABLE ".$sv['0']." ADD remindersent character varying(17) DEFAULT 'N'"); echo $modifyoutput; flush();@ob_flush();
            modifyDatabase("","ALTER TABLE ".$sv['0']." ADD remindercount INTEGER DEFAULT 0"); echo $modifyoutput; flush();@ob_flush();
        }
    }
}
...
function upgrade_token_tables134()
{
    ...
    else
    {
        foreach ( $surveyidresult as $sv )
        {
            modifyDatabase("","ALTER TABLE ".$sv[0]." ADD validfrom timestamp"); echo $modifyoutput; flush();@ob_flush();
            modifyDatabase("","ALTER TABLE ".$sv[0]." ADD validuntil timestamp"); echo $modifyoutput; flush();@ob_flush();
        }
    }
}
...
function upgrade_token_tables145()
{
    ...
    else
    {
        foreach ( $surveyidresult as $sv )
        {
            modifyDatabase("","ALTER TABLE ".$sv[0]." ADD usesleft integer DEFAULT 1 NOT NULL"); echo $modifyoutput; flush();@ob_flush();
...
function upgrade_question_attributes142()
{
    ...
    $questionids = Yii::app()->createCommand($attributequery)->queryRow();
    foreach ($questionids as $questionid)
    {
        //Select all affected question attributes
        $attributevalues=Yii::app()->createCommand("SELECT value from {{question_attributes}} where attribute='exclude_all_other' and qid=".$questionid)->queryRow();
...
function upgrade_tables143()
{
    ...
    $answerresult = Yii::app()->createCommand($answerquery)->queryAll();
    ...
    modifyDatabase("","delete from {{answers}} using {{questions}} where {{answers}}.qid={{questions}}.qid and {{questions}}.type in ('1','A','B','C','E','F','H',';',':')"); echo $modifyoutput; flush();@ob_flush();
