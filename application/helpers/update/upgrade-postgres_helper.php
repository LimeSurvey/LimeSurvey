...
function upgrade_tables143()
{
    ...
    modify_database("","delete from {{answers}} using {{questions}} where {{answers}}.qid={{questions}}.qid and {{questions}}.type in ('1','A','B','C','E','F','H',';',':')"); echo $modifyoutput; flush();ob_flush();
