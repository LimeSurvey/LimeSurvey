...
class TransformerOutputSurvey extends TransformerOutputActiveRecord
{
    ...
    public function __construct(
        ...
        $this->setDataMap([
            ...
            'language'  => true,
            'expires' => ['key' => 'expires', 'formatter' => ['dateTimeToJson' => true]],
            'startdate' => ['key' => 'startDate', 'formatter' => ['dateTimeToJson' => true]],
            'anonymized' => ['formatter' => ['ynToBool' => true]],
            'savetimings' => ['key' => 'saveTimings', 'formatter' => ['ynToBool' => true]],
            'additional_languages' => 'additionalLanguages',
            'datestamp' => ['formatter' => ['ynToBool' => true]],
            "usecookie" => ['key' => 'useCookie', 'formatter' => ['ynToBool' => true]],
            "allowregister" => ['key' => 'allowRegister', 'formatter' => ['ynToBool' => true]],
            "allowsave" => ['key' => 'allowSave', 'formatter' => ['ynToBool' => true]],
            "autonumber_start" => ['key' => 'autoNumberStart', 'type' => 'int'],
            "autoredirect" => ['key' => 'autoRedirect', 'formatter' => ['ynToBool' => true]],
            "allowprev" => ['key' => 'allowPrev', 'formatter' => ['ynToBool' => true]],
            "printanswers" => ['key' => 'printAnswers', 'formatter' => ['ynToBool' => true]],
            "ipaddr" => ['key' => 'ipAddr', 'formatter' => ['ynToBool' => true]],
            "ipanonymize" => ['key' => 'ipAnonymize', 'formatter' => ['ynToBool' => true]],
            "refurl" => ['key' => 'refUrl', 'formatter' => ['ynToBool' => true]],
            "datecreated" => ['key' => 'dateCreated', 'formatter' => ['dateTimeToJson' => true]],
            "publicstatistics" => ['key' => 'publicStatistics', 'formatter' => ['ynToBool' => true]],
            "publicgraphs" => ['key' => 'publicGraphs', 'formatter' => ['ynToBool' => true]],
            "listpublic" => ['key' => 'listPublic', 'formatter' => ['ynToBool' => true]],
            "sendconfirmation" => ['key' => 'sendConfirmation', 'formatter' => ['ynToBool' => true]],
            "tokenanswerspersistence" => ['key' => 'tokenAnswersPersistence', 'formatter' => ['ynToBool' => true]],
            "assessments" => ['formatter' => ['ynToBool' => true]],
            "usecaptcha" => ['key' => 'useCaptcha', 'formatter' => ['ynToBool' => true]],
            "usetokens" => ['key' => 'useTokens', 'formatter' => ['ynToBool' => true]],
            ...
            "showxquestions" => ['key' =>  'showXQuestions', 'formatter' => ['ynToBool' => true]],
            "showgroupinfo" => 'showGroupInfo',
            "shownoanswer" => ['key' =>  'showNoAnswer', 'formatter' => ['ynToBool' => true]],
            "showqnumcode" => 'showQNumCode',
            "bouncetime" => ['key' =>  'bounceTime', 'type' => 'int'],
            "bounceprocessing" => ['key' =>  'bounceProcessing', 'formatter' => ['ynToBool' => true]],
            ...
            "showwelcome" => ['key' =>  'showWelcome', 'formatter' => ['ynToBool' => true]],
            "showprogress" => ['key' =>  'showProgress', 'formatter' => ['ynToBool' => true]],
            "questionindex" => ['key' =>  'questionIndex', 'type' => 'int'],
            "navigationdelay" => ['key' =>  'navigationDelay', 'type' => 'int'],
            "nokeyboard" => ['key' =>  'noKeyboard', 'formatter' => ['ynToBool' => true]],
            "alloweditaftercompletion" => ['key' =>  'allowedItAfterCompletion', 'formatter' => ['ynToBool' => true]],
