...
class KeteranganYaTidak extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'mainPotensiR3s' => array(self::HAS_MANY, 'MainPotensiR3', 'R305D'),
			'mainPotensiR5s' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B2K2'),
			'mainPotensiR5s1' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B1K3'),
			'mainPotensiR5s2' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B2K3'),
			'mainPotensiR5s3' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B1K4'),
			'mainPotensiR5s4' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B2K4'),
			'mainPotensiR5s5' => array(self::HAS_MANY, 'MainPotensiR5', 'R506B1K2'),
		);
	}
