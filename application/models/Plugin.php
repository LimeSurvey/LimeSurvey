...
class Plugin extends LSActiveRecord
{
    ...
    public function getActionButtons()
    {
        ...
        if (Permission::model()->hasGlobalPermission('settings', 'update')) {
            ...
            if ($this->load_error == 1) {
                ...
                $output .= "<a href='" . $reloadUrl . "' data-toggle='tooltip' title='" . gT('Attempt plugin reload') . "' class='btn btn-outline-secondary btn-sm btntooltip'><span class='fa fa-refresh'></span></a>";
    ...
    public function getActivateButton()
    {
        ...
        $output .= "
                ...
                <button data-toggle='tooltip' title='" . gT('Activate plugin') . "' class='btntooltip btn btn-outline-secondary btn-sm'>
    ...
    public function getDeactivateButton()
    {
        ...
        $output .= "
                <input type='hidden' name='pluginId' value='" . $this->id . "' />
                <button type='button' data-toggle='tooltip' onclick='return confirm(\"" . gT('Are you sure you want to deactivate this plugin?') . "\");' title='" . gT('Deactivate plugin') . "' class='btntooltip btn btn-warning btn-sm'>
                    <i class='fa fa-power-off'></i>
                </button>
            </form>
        ";
