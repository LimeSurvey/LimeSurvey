 ...
 */
    ...
    public function getOrderedSubQuestions($scale_id = null)
    {
        ...
        if ($this->getQuestionAttribute('random_order') == 1) {
            ...
            usort(
                $aOrderedSubquestions, function ($oQuestionA, $oQuestionB) {
        ...
        foreach ($aOrderedSubquestions as $i => $oSubquestion) {
            ...
            if (($this->getQuestionAttribute('exclude_all_others') != '' && $this->getQuestionAttribute('random_order') == 1)
