...
class QuestionAttribute extends LSActiveRecord
{
     ...
     */
    public static $attributesDefinitions;
    /**
     * The attribute/settings by question type
     */
    public static $questionAttributesSettings;
    ...
    */
    ...
    {
        if(self::$attributesDefinitions)
        {
            return self::$attributesDefinitions;
        }
     ...
     * @param $sType: alwayus used excpet for TSV import : @todo must fix here
     * @return array()
     */
    public static function getQuestionAttributesSettings($sType=null)
    {
        ...
        {
            return self::$questionAttributesSettings;
        }
    }
}
?>
