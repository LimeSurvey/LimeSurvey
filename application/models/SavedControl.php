...
class SavedControl extends LSActiveRecord
{
    ...
    public function getGridButtons()
    {
        ...
        $gridButtons['editresponse'] = array(
            'label' => '<span class="visually-hidden">' . gT("Edit") . '</span><span class="ri-pencil-fill" aria-hidden="true"></span>',
            'imageUrl' => false,
        ...
        $gridButtons['resend_accesscode'] = array(
            'label' => '<span class="visually-hidden">' . gT("Edit") . '</span><span class="ri-refresh-line" aria-hidden="true"></span>',
            'imageUrl' => false,
        ...
        $gridButtons['delete'] = array(
            'label' => '<span class="visually-hidden">' . gT("Delete") . '</span><span class="ri-delete-bin-fill text-danger" aria-hidden="true"></span>',
            'imageUrl' => false,
            'icon' => false,
