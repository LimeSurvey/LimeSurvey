...
class Survey extends LSActiveRecord implements PermissionInterface
{
    ...
    /**
     * This function returns any valid mappings from the survey participants lists to the CPDB
    ...
    /**
     * Returns true in a survey participants list exists for survey
     * @return boolean
     */
    ...
    public static function getPermissionData()
    {
        $aPermission = array(
            ...
            'surveysettings' => array(
                ...
                'description' => gT("Permission to view, update the survey settings including survey participants list creation"),
