...
class Survey extends LSActiveRecord implements PermissionInterface
{
    ...
    public function getRunning()
    {
        ...
        if ($this->active == 'N') {
            ...
            $sIconRunNoEx = '<a href="' . App()->createUrl('/surveyAdministration/view/surveyid/' . $this->sid) . '" class="survey-state" data-toggle="tooltip" title="' . gT('End: Never') . '"><span class="fa  fa-play text-success"></span><span class="sr-only">SS' . sprintf(gT('End: Never')) . '</span></a>';
