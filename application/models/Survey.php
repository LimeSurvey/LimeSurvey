...
class Survey extends LSActiveRecord implements PermissionInterface
{
    ...
    public function getRunning()
    {
        ...
        if ($this->active == 'N') {
            ...
            $sIconRunNoEx = '<a href="' . App()->createUrl('/surveyAdministration/view/surveyid/' . $this->sid) . '" class="survey-state" data-toggle="tooltip" title="' . sprintf(gT('End: Never')) . '"><span class="fa  fa-play text-success"></span><span class="sr-only">SS' . sprintf(gT('End: Never')) . '</span></a>';
        ...
        if (isset($this->active)) {
            if ($this->active == 'N' || $this->active == "Y") {
                ...
                if ($this->active == "R") {
                    ...
                    $subCriteria2->addCondition('t.startdate IS NOT NULL', "OR");
