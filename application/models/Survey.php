    ...
    */
    ...
    public function getRunning()
    {
        ...
        elseif ($this->expires != '' || $this->startdate != '')
        {
            ...
            $sIconRunning = '<a href="'.App()->createUrl('/admin/survey/sa/view/surveyid/'.$this->sid).'" class="survey-state" data-toggle="tooltip" title="'.gT('Expires').': '.$sStop.'"><span class="fa  fa-clock-o text-success"></span></a>';
