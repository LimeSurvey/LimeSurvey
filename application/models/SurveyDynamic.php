...
class SurveyDynamic extends LSActiveRecord
{
    ...
    public function addTimingCriteria($condition)
    {
        ...
        $newCriteria->select = 'survey_timings.*'; // Otherwise we don't get records from the survey participants list
    ...
    /**
     * Return criteria updated with the ones needed for including results from the survey participants list
     *
    ...
    public function addTokenCriteria($condition)
    {
        ...
        $newCriteria->select = $aTokenFields; // Otherwise we don't get records from the survey participants list
        $newCriteria->mergeWith($criteria);
    ...
    public function search()
    {
        ...
        // Join the survey participants list and filter tokens if needed
