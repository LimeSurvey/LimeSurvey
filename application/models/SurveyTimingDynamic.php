...
class SurveyTimingDynamic extends LSActiveRecord
{
    ...
    */
    ...
    public function getButtons()
    {
        ...
        $buttons = '<a class="btn btn-default" href="' . $viewUrl . '" role="button" data-toggle="tooltip" title="'.gT('View response details').'"><span class="glyphicon glyphicon-list-alt" ></span></a>';
        ...
        if (Permission::model()->hasSurveyPermission(self::$sid, 'responses', 'update'))
        {
            ...
            $buttons .= '&nbsp;<a class="btn btn-default" href="' . $editUrl . '" role="button" data-toggle="tooltip" title="'.gT('Edit this response').'"><span class="glyphicon glyphicon-pencil" ></span></a>';
        }
        ...
        if (Permission::model()->hasSurveyPermission(self::$sid, 'responses', 'delete'))
        {
            ...
            $buttons .= '&nbsp;<a class="btn btn-default" data-target="#confirmation-modal" data-href="' . $deleteUrl . '" role="button" data-toggle="modal" data-tooltip="true" title="'.gT('Delete this response').'"><span class="text-danger glyphicon glyphicon-trash" ></span></a>';
        }
