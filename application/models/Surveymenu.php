...
class Surveymenu extends LSActiveRecord
{
    ...
    public function restoreDefaults(){
        ...
        try {
            ...
            $oDB->createCommand()->insert("{{surveymenu}}", array_combine($headerArray, [null,null,null,0,0,'quickmenu','collapsed','quickmenu',1, date('Y-m-d H:i:s'),0,date('Y-m-d H:i:s'),0]));
