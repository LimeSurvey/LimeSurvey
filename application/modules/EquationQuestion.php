...
class EquationQuestion extends QuestionModule
{
    ...
    {
        $clang=Yii::app()->lang;
        $props=array('description' => $clang->gT("Equation"),'group' => $clang->gT("Mask questions"),'subquestions' => 0,'class' => 'equation','hasdefaultvalues' => 0,'assessable' => 0,'answerscales' => 0,'enum' => 0);
