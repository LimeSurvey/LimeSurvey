...
class LongTextQuestion extends TextQuestion
{
    ...
    {
        return printablesurvey::input_type_image('textarea', $this->getTypeHelp($language), '100%', 8);
    }
    ...
    public function QueXMLAppendAnswers(&$question)
    {
        ...
        $response->appendChild(QueXMLCreateFree("longtext",quexml_get_lengthth($this->id,"display_rows","40"),""));
