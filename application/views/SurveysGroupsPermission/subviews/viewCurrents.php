<div class="well">
    ...
    <p><?= gT("This survey group is shown for users with any permission to the survey group, user with any permission to one survey inside this group, or if this group was configured to be available.") ?></p>
</div>
<?php if (!empty($oExistingUsers)) {
    $this->renderPartial(
        '/SurveysGroupsPermission/subviews/currentUsersList',
        array(
            'model' => $model,
