    ...
    <?php foreach ($anslangs as $anslang)
        { ?>
            ...
            <?php for ($scale_id = 0; $scale_id < $scalecount; $scale_id++)
            {
                ...
                <?php } ?>
                <button id='btnlsbrowser_<?php echo $scale_id; ?>' class='btnlsbrowser' type='button'><?php echo $clang->gT('Predefined label sets...'); ?></button>
                <button id='btnquickadd_<?php echo $scale_id; ?>' class='btnquickadd' type='button'><?php echo $clang->gT('Quick add...'); ?></button>
