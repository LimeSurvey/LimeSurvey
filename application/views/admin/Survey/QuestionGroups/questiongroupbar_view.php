            ...
            if (bHasSurveyPermission($surveyid,'surveycontent','delete'))
            {
                if ((($sumcount4 == 0 && $activated != "Y") || $activated != "Y"))
                {
                    ...
                    { ?>
                        ...
                        <a href='#' onclick="if (confirm('<?php echo $clang->gT("Deleting this group will also delete any questions and answers it contains. Are you sure you want to continue?","js"); ?>')) {<?php echo get2post("database.php?action=delgroup&amp;sid=$surveyid&amp;gid=$gid"); ?>}"
