<div id='resources'>
            ...
            <li><label>&nbsp;</label>
            <input type='button' onclick='window.open("<?php echo site_url("admin/export/resources/exportsurvresources/$surveyid/"); ?>", "_blank")' value="<?php echo $clang->gT("Export Resources As ZIP Archive"); ?>" <?php echo $disabledIfNoResources; ?> /></li>
