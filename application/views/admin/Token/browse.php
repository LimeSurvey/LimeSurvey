...
<form id='tokensearch' method='post' action='<?php echo site_url("admin/tokens/browse/$surveyid");?>'>
	...
	if ($bresult->num_rows() > 0) { ?>
        ...
        { ?>
            ...
            echo get2post("scriptname?action=tokens&amp;sid={$surveyid}&amp;subaction=delete&amp;tids=document.getElementById('tokenboxeschecked').value&amp;limit={$limit}&amp;start={$start}&amp;order={$order}");?>}}else{alert('<?php echo $clang->gT("No tokens selected");?>');}"  />
