    ...
    <form action="<?php echo site_url("admin/tokens/managetokenattributes/$surveyid");?>" method="post">'
...
<?php
    ...
    <form id="addattribute" action="<?php echo site_url("admin/tokens/managetokenattributes/$surveyid");?>" method="post">
    <p>
