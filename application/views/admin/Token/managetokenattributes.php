    ...
    <form action="<?php echo site_url("admin/tokens/updatetokenattributedescriptions/$surveyid");?>" method="post">'
...
<?php
    ...
    <form id="addattribute" action="<?php echo site_url("admin/tokens/updatetokenattributes/$surveyid");?>" method="post">
    <p>
