...
<a href='<?php echo site_url("admin/browse/$surveyid/id/$last/");?>' title='<?php echo $clang->gTview("Show previous...");?>' >
...
<a href='<?php echo site_url("admin/browse/$surveyid/id/$next/");?>' title='<?php echo $clang->gTview("Show next...");?>'>
