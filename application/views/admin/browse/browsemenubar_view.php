...
<?php if (bHasSurveyPermission($surveyid,'responses','read')) { ?>
    <a href='<?php echo $this->createUrl("admin/browse/$surveyid");?>' title="<?php echo $clang->gTview("Show summary information");?>">
    ...
    <?php } else { ?>
        ...
        <?php foreach ($tmp_survlangs as $tmp_lang) { ?>
            <li><a href="<?php echo $this->createUrl("admin/browse/$surveyid/all/0/50/asc/$tmp_lang");?>" accesskey='b'><?php echo getLanguageNameFromCode($tmp_lang,false);?></a></li>
        <?php } ?>
        </ul></div>
    <?php } ?>
    <a href='<?php echo $this->createUrl("admin/browse/$surveyid/all/0/50/desc");?>' title="<?php echo $clang->gTview("Display Last 50 Responses");?>" >
...
if (bHasSurveyPermission($surveyid,'responses','create')) { ?>
    <a href='<?php echo $this->createUrl("admin/dataentry/view/$surveyid/");?>' "<?php echo $clang->gTview("Dataentry Screen for Survey");?>" >
...
if (bHasSurveyPermission($surveyid,'statistics','read')) { ?>
    <a href='<?php echo $this->createUrl("admin/statistics/$surveyid/");?>' title="<?php echo $clang->gTview("Get statistics from these responses");?>">
    ...
    <?php if ($thissurvey['savetimings']=="Y") { ?>
        <a href='<?php echo $this->createUrl("admin/browse/$surveyid/time/");?>' title="<?php echo $clang->gTview("Get time statistics from these responses");?>" >
...
<?php if (bHasSurveyPermission($surveyid,'responses','export')) { ?>
    <a href='<?php echo $this->createUrl("admin/export/exportresults/$surveyid/");?>' title="<?php echo $clang->gTview("Export results to application");?>">
    <img name='Export' src='<?php echo $imageurl;?>/export.png' alt='<?php echo $clang->gT("Export results to application");?>' /></a>

    <a href='<?php echo $this->createUrl("admin/export/exportspss/$surveyid/");?>' title="<?php echo $clang->gTview("Export results to a SPSS/PASW command file");?>">
    <img src='<?php echo $imageurl;?>/exportspss.png' alt="<?php echo $clang->gT("Export results to a SPSS/PASW command file");?>" /></a>

    <a href='<?php echo $this->createUrl("admin/export/exportr/$surveyid/");?>' title="<?php echo $clang->gTview("Export results to a R data file");?>" >
    <img src='<?php echo $imageurl;?>/exportr.png' alt='<?php echo $clang->gT("Export results to a R data file");?>' /></a>
<?php }
if (bHasSurveyPermission($surveyid,'responses','create'))
{ ?>
    <a href='<?php echo $this->createUrl("admin/importoldresponses/$surveyid/");?>' title="<?php echo $clang->gTview("Import responses from a deactivated survey table");?>">
...
<?php if (bHasSurveyPermission($surveyid,'responses','read')) { ?>
    <a href='<?php echo $this->createUrl("admin/saved/view/$surveyid/");?>' title="<?php echo $clang->gTview("View Saved but not submitted Responses");?>" >
...
if (bHasSurveyPermission($surveyid,'responses','import'))  { ?>
    <a href='<?php echo $this->createUrl("admin/vvimport/$surveyid/");?>' title="<?php echo $clang->gTview("Import a VV survey file");?>" >
...
if (bHasSurveyPermission($surveyid,'responses','export'))  { ?>
    <a href='<?php echo $this->createUrl("admin/export/vvexport/$surveyid/");?>' title="<?php echo $clang->gTview("Export a VV survey file");?>" >
...
if (bHasSurveyPermission($surveyid,'responses','delete') && $thissurvey['anonymized'] == 'N' && $thissurvey['tokenanswerspersistence'] == 'Y') { ?>
    <a href='<?php echo $this->createUrl("admin/iteratesurvey/$surveyid/");?>' title="<?php echo $clang->gTview("Iterate survey");?>" >
