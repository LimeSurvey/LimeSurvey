<tr class='<?php echo $bgcc; ?>' valign='top'>
    ...
    <td align='center'>
        <a href='<?php echo $this->createUrl("/admin/browse/sa/view/surveyid/{$iSurveyId}/id/{$dtrow['id']}"); ?>'><img src='<?php echo $imageurl; ?>/token_viewanswer.png' alt='<?php $clang->eT('View response details'); ?>'/></a>
