<tr class='<?php echo $bgcc; ?>' valign='top'>
    ...
    <td align='center'>
        ...
        <a href='<?php echo $this->createUrl("/admin/dataentry/surveyid/{$iSurveyId}/edit/id/{$dtrow['id']}"); ?>'><img src='<?php echo $imageurl; ?>/token_edit.png' alt='<?php $clang->eT('Edit this response'); ?>'/></a>
