...
<div class='messagebox ui-corner-all'>
    ...
    {?>
      <form action='<?php echo site_url('admin/checkintegrity/fixredundancy'); ?>' method='post'>
          ...
          <input type='submit' value='<?php $clang->eT("Delete checked items!"); ?>' /><p>
          <span style='color: red; font-size:0.8em;'><?php $clang->eT("Note that you cannot undo a delete if you proceed. The data will be gone."); ?></span>
      </form><?php
    } ?>
