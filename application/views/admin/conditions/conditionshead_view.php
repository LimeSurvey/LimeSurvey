        ...
        <div class='menubar'>
            ...
            <div class='menubar-main'>
                <div class='menubar-left'>
                    ...
                    <a href="#" onclick="window.open('<?php echo $this->createUrl("/admin/conditions/sa/action/subaction/conditions/surveyid/$surveyid/gid/$gid/qid/$qid");?>', '_top')" title='<?php $clang->eTview("Show conditions for this question");?>' >
                        <img name='SummaryButton' src='<?php echo $imageurl;?>/summary.png' alt='<?php $clang->eT("Show conditions for this question");?>' /></a>
                    <img src='<?php echo $imageurl;?>/seperator.gif' alt='' />
                    <a href="#" onclick="window.open('<?php echo $this->createUrl("admin/conditions/sa/action/subaction/editconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid");?>', '_top')" title='<?php $clang->eTview("Add and edit conditions");?>' >
                        <img name='ConditionAddButton' src='<?php echo $imageurl;?>/conditions_add.png' alt='"<?php $clang->eT("Add and edit conditions");?>' /></a>
                    <a href="#" onclick="window.open('<?php echo $this->createUrl("admin/conditions/sa/action/subaction/copyconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid");?>', '_top')" title='<?php $clang->eTview("Copy conditions");?>' >
