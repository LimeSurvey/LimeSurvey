...
$subaction == "renumberscenarios")  { ?>
    ...
    { // show the Delete all conditions for this question button ?>
        <a href='#' onclick="if ( confirm('<?php $clang->eT("Are you sure you want to delete all conditions set to the questions you have selected?","js");?>')) { document.getElementById('deleteallconditions').submit();}" title='<?php $clang->eTview("Delete all conditions");?>' >
    ...
    { // show the renumber scenario button for this question ?>
        <a href='#' onclick="if ( confirm('<?php $clang->eT("Are you sure you want to renumber the scenarios with incremented numbers beginning from 1?","js");?>')) { document.getElementById('toplevelsubaction').value='renumberscenarios'; document.getElementById('deleteallconditions').submit();}" title='<?php $clang->eTview("Renumber scenario automatically");?>' >
