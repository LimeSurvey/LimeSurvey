	...
	<a href='#' onclick="if ( confirm('<?php $clang->eT("Are you sure you want to delete this condition?","js"); ?>')) { $('#editModeTargetVal<?php echo $rows['cid']; ?>').remove(); $('#cquestions<?php echo $rows['cid']; ?>').remove(); document.getElementById('conditionaction<?php echo $rows['cid']; ?>').submit();}"
		title='<?php $clang->eTview("Delete this condition"); ?>'>
		<img src='$imageurl/conditions_delete_16.png'  alt='<?php $clang->eT("Delete this condition"); ?>' name='DeleteThisCondition'
			title='' />
	</a>
	<a href='#' onclick='document.getElementById("subaction<?php echo $rows['cid']; ?>").value="editthiscondition"; document.getElementById(
		...
		<img src='$imageurl/conditions_edit_16.png'  alt='<?php $clang->eT("Edit this condition"); ?>' name='EditThisCondition' /></a>
