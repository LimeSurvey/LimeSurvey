<tr>
    ...
    <td><?php echo $scenariotext; ?>&nbsp;
        <form action='<?php echo $this->createUrl("/admin/conditions/sa/index/subaction/updatescenario/surveyid/$surveyid/gid/$gid/qid/$qid/"); ?>' method='post' id='editscenario<?php echo $scenarionr['scenario']; ?>' style='display: none'>
