<div class='header ui-widget-header'><?php $clang->eT("Data entry"); ?></div>
	<div class='messagebox ui-corner-all'>
		...
		<input type='submit' value='<?php $clang->eT("Add Another Record"); ?>' onclick="window.open('<?php echo Yii::app()->homeUrl.('/admin/dataentry/sa/view/surveyid/'.$surveyid.'/lang/'.$lang); ?>', '_top')" />
		<br /><br />
        ...
        <?php if(isset($thisid)): ?>
			<input type='submit' value='<?php $clang->eT("View This Record"); ?>' onclick="window.open('<?php echo Yii::app()->homeUrl.('/admin/browse/sa/action/surveyid/'.$surveyid.'/id/'.$thisid); ?>', '_top')" />
			<br /><br />
        <?php endif; ?>

        <?php if(isset($save)): ?>
        	<input type='submit' value='<?php $clang->eT("Browse Saved Responses"); ?>' onclick="window.open('<?php echo Yii::app()->homeUrl.('/admin/saved/sa/view/surveyid/'.$surveyid.'/all'); ?>', '_top')" />
        	<br /><br />
		<?php endif; ?>
	</div>
