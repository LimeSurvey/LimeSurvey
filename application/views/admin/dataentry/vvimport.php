...
<?php
    ...
    <div class="panel panel-primary" id="panel-1">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                <label for="dontdeletefirstline" class=" control-label" title='<?php eT("With real vv file : questions code are in second line"); ?>' data-bs-toggle="tooltip" data-bs-placement="right">
            ...
            <div class="form-group">
                <label for="forceimport" class=" control-label" title='<?php eT("Try to import even if question codes don't match"); ?>' data-bs-toggle="tooltip" data-bs-placement="right">
                    <?php eT("Force import:"); ?>
                </label>
                <div class="">
                    <?php  $this->widget('yiiwheels.widgets.switch.WhSwitch', array(
