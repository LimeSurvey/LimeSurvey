        ...
        <div class="col-lg-12 content-right">
            ...
            <div class='wrap2columns'>
                ...
                <div class='left'>
                    ...
                    <fieldset <?php  if ($SingleResponse) { echo 'style="display:none"';} ?> >
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <label for='completionstate'><?php eT("Completion state");?></label>
                                <select id='completionstate' name='completionstate' class="form-control">
                            ...
                            <?php
                                echo CHTML::label(gT("Export language"),"exportlang");
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <?php
                                            echo CHTML::label(gT("Number of characters"),'abbreviatedtextto');
                            ...
                            <li>
                                <div class="checkbox">
                                    <?php
                                        echo CHTML::checkBox('emcode',false,array('value'=>'emcode','id'=>'emcode'));
                            ...
                            <li>
                                <?php
                                    echo CHTML::label(gT("Code/text separator"),'codetextseparator');
                ...
                <div class='right'>
                    ...
                    <?php if ($thissurvey['anonymized'] == "N" && tableExists("{{tokens_$surveyid}}") && Permission::model()->hasSurveyPermission($surveyid,'tokens','read')): ?>
                        <fieldset>
                            <legend><?php eT("Token control");?></legend>
                    ...
                    <input type='submit' class="btn btn-default" value='<?php eT("Export data");?>' id='exportresultsubmitbutton' />
                </div>
                </form>
            </div>
        </div>
