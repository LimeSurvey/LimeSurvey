    ...
    <div class="row">
        <div class="col-md-6 content-right">
            ...
            <div class="panel panel-primary" id="panel-extension" style="opacity: 1; top: 0px;">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <label for="extension" class="col-md-2 form-label" data-toggle="tooltip" data-placement="right" title='<?php eT("For easy opening in MS Excel, change the extension to 'tab' or 'txt'"); ?>'>
                    ...
                    <div class="form-group">
                        <label for="vvversion" class="col-md-2 form-label" data-toggle="tooltip" data-placement="right" title='<?php eT("If you want to import survey on old installation or if your survey have problem: use old version (automatically selected if some code are duplicated)."); ?>'>
