...
<table class="table table-striped ">
    ...
    <tbody>
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/functions'); ?>">Available Functions</a></td>
        <td>Show the list of functions available within ExpressionScript Engine.</td>
    </tr>
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/strings_with_expressions'); ?>">Unit Tests of Expressions Within Strings</a></td>
    ...
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/relevance'); ?>">Unit Test Dynamic Relevance Processing</a></td>
        <td>Questions and substitutions should dynamically change based upon values entered.</td>
    </tr>
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/conditions2relevance'); ?>">Preview Conversion of Conditions to Relevance</a></td>
    ...
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/navigation_test'); ?>">Test Navigation</a></td>
        <td>Tests whether navigation properly handles relevant and irrelevant groups</td>
    </tr>
    <tr>
        <td><a class="ls-link" href="<?php echo $this->createUrl('admin/expressions/sa/survey_logic_file'); ?>">Show Survey logic overview</a></td>
