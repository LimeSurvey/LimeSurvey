<table border="1">
    ...
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/functions'); ?>">Available Functions</a></td>
        <td>Show the list of functions available within Expression Manager.</td>
    </tr>
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/stringsplit'); ?>">String Splitter</a></td>
    ...
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/tokenizer'); ?>">Tokenizer</a></td>
    ...
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/unit'); ?>">Unit Tests of Isolated Expressions</a></td>
    ...
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/strings_with_expressions'); ?>">Unit Tests of Expressions Within Strings</a></td>
    ...
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/relevance'); ?>">Unit Test Dynamic Relevance Processing</a></td>
        <td>Questions and substitutions should dynamically change based upon values entered.</td>
    </tr>
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/conditions2relevance'); ?>">Preview Conversion of Conditions to Relevance</a></td>
        <td>Shows Relevance equations for all conditions in the database, grouped by question id (and not pretty-printed)</td>
    </tr>
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/upgrade_conditions2relevance'); ?>">Bulk Convert Conditions to Relevance</a></td>
        <td>Convert conditions to relevance for entire database</td>
    </tr>
    <tr>
        <td><a href="<?php echo $this->createUrl('admin/expressions/navigation_test'); ?>">Test Navigation</a></td>
