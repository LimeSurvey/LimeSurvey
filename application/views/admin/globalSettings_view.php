...
<ul class="nav nav-tabs" id="settingTabs">
        ...
        <li role="presentation" ><a data-toggle="tab" href='#navigation'><?php eT("Home page"); ?></a></li>
</ul>
...
<div class="tab-content">
    ...
    <div id="navigation" class="tab-pane col-md-10 col-md-offset-1">
        <?php $this->renderPartial("./global_settings/_navigation", array('boxes'=>$boxes)); ?>
    </div>     
</div>
