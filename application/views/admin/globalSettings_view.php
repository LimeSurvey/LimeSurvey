...
<div id='tabs'>
    ...
    <?php echo CHtml::form(array("admin/globalsettings"), 'post', array('class'=>'form30','id'=>'frmglobalsettings','name'=>'frmglobalsettings'));?>
        ...
        <div id='general'>
            <ul>
                <li><label for='sitename'><?php eT("Site name:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
                ...
                <li><label for='defaulthtmleditormode'><?php eT("Default HTML editor mode:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
                ...
                <li><label for='defaultquestionselectormode'><?php eT("Question type selector:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
                ...
                <li><label for='defaulttemplateeditormode'><?php eT("Template editor:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
        ...
        <div id='security'><ul>
                ...
                <li><label for='filterxsshtml'><?php eT("Filter HTML for XSS:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
        ...
        <div id='language'>
            <ul>
                <li><label for='defaultlang'><?php eT("Default site language:").((Yii::app()->getConfig("demoMode")==true)?'*':''); ?></label>
