	...
	<div id='tabs'>
		...
		<div id='overview'>
            ...
            foreach (getLanguageData(true) as  $langkey2=>$langname)
            {
                ...
                if ($actuallang == $langkey2) { echo "selected='selected'";}
                echo ">".$langname['nativedescription']." - ".$langname['description'];?></option>
                <?php
            }
			?>
            </select></li><?php
            ...
            <input type='text' size='50' id='bounceaccountuser' name='bounceaccountuser' value="<?php echo htmlspecialchars(getGlobalSetting('bounceaccountuser'))?>" /></li>
