...
<br /><table class='table table-hover'>
    ...
    <tr>
        <th ><?php eT("Active survey participants lists"); ?>:</th><td><?php echo $activetokens; ?></td>
    </tr>
    <tr>
        <th ><?php eT("Deactivated survey participants lists"); ?>:</th><td><?php echo $deactivatedtokens; ?></td>
    </tr>
    <?php
