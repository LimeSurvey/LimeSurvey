...
<div class="container-fluid position-relative">
    ...
    <div class="d-flex flex-wrap flex-lg-nowrap" id="surveySettingsForThisGroup">
        ...
        <div id="pjax-content" class="tab-content col-lg-10 flex-lg-shrink-1 ps-3">
            ...
            <?php } else {
                if ($partial === '_presentation_panel') { ?>
                ...
                <?php } else {
                    ...
                    <?php } else {
                        if ($partial === '_notification_panel') { ?>
            ...
            <div class="hidden">
                <?php echo TbHtml::submitButton('Save', array('class' => 'btn btn-success col-lg-2 col-md-4', "id" => "survey-settings-form")); ?>
            </div>
