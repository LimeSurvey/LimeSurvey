...
<script type="text/javascript" src="<?php echo $baseurl;?>scripts/admin/tabpane/js/tabpane.js"></script>
...
<script type="text/javascript" src="<?php echo $baseurl;?>scripts/admin/admin_core.js"></script>
