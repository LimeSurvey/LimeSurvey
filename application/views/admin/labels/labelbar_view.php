<div class='menubar'>
    <div class='menubar-title ui-widget-header'>
        <strong><?php eT("Label Set"); ?>:</strong> <?php echo $row['label_name']; ?>
    </div>
    <div class='menubar-main'>
        <div class='menubar-left'>
            ...
            <a href='#' onclick="if (confirm('<?php eT("Do you really want to delete this label set?","js"); ?>')) { <?php echo convertGETtoPOST($this->createUrl("admin/labels/sa/process")."?action=deletelabelset&amp;lid=$lid"); ?>}" >
