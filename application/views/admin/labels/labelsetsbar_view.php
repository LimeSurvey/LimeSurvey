<div class='menubar'>
    ...
    <div class='menubar-main'>
        <div class='menubar-left'>
            <a href='<?php echo $this->createUrl("/admin/index"); ?>' title="<?php echo $clang->gTview("Return to survey administration"); ?>" >
            ...
            <a href='<?php echo $this->createUrl("admin/labels/sa/exportmulti");?>' title="<?php echo $clang->gTview("Export label set"); ?>" >
