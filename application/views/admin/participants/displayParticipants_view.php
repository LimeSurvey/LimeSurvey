        ...
        <div class="container-fluid">
            ...
            if ($searchcondition) {
                echo "<div class='container-fluid' id='ParticipantFilters'>"
                    ...
                    . gT("Active filters:")
                    . "<span class=''>&nbsp;&nbsp;</span>"
                    . "<button type='button' id='removeAllFilters' class='btn btn-warning btn-xs' data_url='" . App()->createUrl("admin/participants/sa/displayParticipants") . "'>" . gT("Remove filters") . "</button>"
                    . "</div>"
                    . "</div>";
                $i = 0;
