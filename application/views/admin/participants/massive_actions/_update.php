...
<form class="custom-modal-datas form form-horizontal">
	<div class="container-fluid">
        <fieldset class="mb-0" aria-labelledby="massedit-modify-legend">
            <legend id="massedit-modify-legend" class="visually-hidden">
                <?php eT("Modify"); ?>
            </legend>
            ...
            if (
                ...
                <div class="ex-form-group mb-3">
                    <div class="col-md-1">
                        <input type="checkbox" id="massedit_owner_uid_modify" class="action_check_to_keep_old_value"
                               aria-labelledby="massedit-modify-group-label massedit_owner_uid_fieldlabel"/>
                    </div>
                    <label id="massedit_owner_uid_fieldlabel" class="col-md-3 form-label" for="owner_uid">
                        <?php eT("Owner"); ?>
                    </label>
                    <div class="col-md-8">
                        <?php echo TbHtml::dropDownList(
                            'owner_uid',
                            'lskeep',
                            ['lskeep' => gT('Keep old value')] + $model->getOwnerOptions(),
            ...
            <div class="ex-form-group mb-3">
                <div class="col-md-1">
                    <input type="checkbox" id="massedit_language_modify" class="action_check_to_keep_old_value"
                           aria-labelledby="massedit-modify-group-label massedit_language_fieldlabel"/>
                </div>
                ...
                <div class="col-md-8">
                    <?php echo TbHtml::dropDownList(
                        'language',
                        'lskeep',
                        array_merge(['lskeep' => gT('Keep old value')], $model->getLanguageOptions()),
                        ['disabled' => 'disabled', 'class' => 'form-select custom-data selector_submitField']
                    ); ?>
                </div>
            </div>
