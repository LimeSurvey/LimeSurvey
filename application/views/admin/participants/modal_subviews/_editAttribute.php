...
?>
    ...
    <div id="ParticipantAttributeNamesDropdownEdit" class="row mb-3" style="display: none;">
        <div class="row">
            <div class="col-2">
            ...
            <?php 
                foreach($model->getAttributesValues($model->attribute_id) as $attribute_value){
                    ...
                    echo '<div class="col-1">
                            <button class="btn btn-outline-secondary mb-3 action_delDropdownField">
     ...
     <legend><?php eT("Languages") ?></legend>
        <div class="row mb-3">
            ...
            <div class="col-1">
                <button class="btn btn-outline-secondary mb-3" id="addLanguageField" data-bs-toggle="tooltip" title="<?php eT("Add a new language") ?>">
        ...
        <div id='languagesList' class="row">
            <?php 
                if($editType!=='edit'){
                    ...
                    echo 
                    '<div class="mb-3" data-lang="'.$languageKey .'">
                        ...
                        <div>
                            ...
                            <div class="col-1">
                                <button class="btn btn-outline-secondary mb-3 action_delLanguageField">
                                    <i class="fa fa-trash text-danger"></i>
                                </button>
                            </div>
                        </div>
                ...
                {
                    echo 
                    '<div class="col-12 mb-3" data-lang="'.$languageKey.'">
            ...
            ?>
            <div class="d-none">
                <div class=" mb-3" id="dummyLanguageInputGroup">
    ...
    <script>
        ...
        jQuery('.action_delLanguageField').on('click', function(e){
            ...
            var self = this,
                ...
                formGroup = $(this).closest('div.mb-3.'),
