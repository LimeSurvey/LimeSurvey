...
<script type="text/javascript">
    ...
    var translate_blocklisted = "<?php echo '<i class=\"ri-arrow-go-back-line\"></i> ' . gT('Remove from blocklist?'); ?>";
    var translate_notBlocklisted = "<?php echo '<i class=\"ri-forbid-2-line\"></i> ' . gT('Add to blocklist?'); ?>";
