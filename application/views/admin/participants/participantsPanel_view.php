  ...
  <div class='menubar-main'>
    <div class='menubar-left'>
     <?php 
        ...
        echo CHtml::link(CHtml::image($information['src'],$information['alt']),'index');
        ...
        {
            echo CHtml::link(CHtml::image($globalsettings['src'],$globalsettings['alt']),'userControl');
        }
        echo CHtml::image($seperator['src'],$seperator['alt']);
        echo CHtml::link(CHtml::image($attributecontrol['src'],$attributecontrol['alt']),'attributeControl');
        echo CHtml::image($seperator['src'],$seperator['alt']);
        echo CHtml::link( CHtml::image($sharepanel['src'],$sharepanel['alt']),'sharePanel');
     ?>
    </div>
  </div>
