...
<tr class="<?php echo !$data['valid'] ? "bg-warning text-danger":""; ?>"><!-- because lime-admin-colors.css force tr:nth-child(2n+1) td color, must add text-danger -->
    <td data-bs-toggle="tooltip"  data-container="body" title="<?php echo CHtml::encode(viewHelper::flatEllipsizeText($oQuotaMember->question->questionl10ns[$sBaseLang]->question,true,60,'...',0.6)); ?>">
