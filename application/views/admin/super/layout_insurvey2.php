...
. '>';
    echo '<div '
    . 'class="ls-flex-column align-items-flex-start align-content-flex-start col-12 ls-flex-item transition-animate-width main-content-container " style="max-width:100%!important;" '
    . '>';
