...
<?php if($oQuestion->title) {$sPattern="^([a-zA-Z][a-zA-Z0-9]*|{$oQuestion->title})$";}else{$sPattern="^[a-zA-Z][a-zA-Z0-9]*$";} ?>
...
<div class="tab-content">
    ...
    <div id="<?php echo $oSurvey->language; ?>" class="tab-pane fade in active">
        ...
        <div class="form-group">
                ...
                <div class="htmleditor input-group">
                    <?php echo CHtml::textArea("question_{$oSurvey->language}",$oQuestion->questionL10n[$oSurvey->language]->question,array('class'=>'form-control','cols'=>'60','rows'=>'8','id'=>"question_{$oSurvey->language}")); ?>
        ...
        <div class="form-group">
                ...
                <div class="">
                <div class="htmleditor input-group">
                    <?php echo CHtml::textArea("help_".$oSurvey->language,$oQuestion->questionL10n[$oSurvey->language]->help,array('class'=>'form-control','cols'=>'60','rows'=>'4','id'=>"help_{$oSurvey->language}")); ?>
    ...
    <?php if (!$adding):?>
        <?php foreach ($oQuestion->questionL10n as $sLanguage=>$oQuestionL10n): ?>
