        ...
        <div class='row'>
            ...
            <?php if (isset($questionbar['buttons']['view'])): ?>
                <div class="col-12">
                    <?php if (Permission::model()->hasSurveyPermission($surveyid, 'surveycontent', 'read')): ?>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu" style="min-width : 252px;">
                                    <?php foreach ($languagelist as $tmp_lang): ?>
                                        <li>
                                            <a target='_blank' href='<?php echo $this->createUrl("survey/index", ['sid' => $surveyid, 'newtest' => "Y", 'lang' => $tmp_lang]); ?>'>
                        ...
                        <?php else: ?>
                            ...
                            <a class="btn btn-default  btntooltip selector__topbar--previewSurvey"
                               href="<?php echo $this->createUrl("survey/index", ['sid' => $surveyid, 'newtest' => "Y", 'lang' => $oSurvey->language]); ?>" role="button" accesskey='d' target='_blank'>
                                <span class="icon-do"></span>
                                <?php if ($oSurvey->active == 'N'): ?>
                                    <?php eT('Preview survey'); ?>
                                <?php else: ?>
                            ...
                            <!-- preview question -->
                            <a class="btn btn-default" href='<?php echo $this->createUrl("survey/index/action/previewquestion/sid/" . $surveyid . "/gid/" . $gid . "/qid/" . $qid); ?>' role="button"
                               target="_blank">
                                <span class="icon-do"></span>
                    ...
                    <?php elseif (Permission::model()->hasSurveyPermission($surveyid, 'surveycontent', 'delete')): ?>
                        <button class="btn btn-default btntooltip" disabled data-bs-toggle="tooltip" data-bs-placement="bottom"
                                title="<?php eT("It is not possible to add/delete questions if the survey is active."); ?>">
                            <span class="fa fa-trash text-danger"></span>
                            <?php eT("Delete"); ?>
                        </button>
                    ...
                    <?php if (Permission::model()->hasSurveyPermission($surveyid, 'surveycontent', 'update')): ?>
                        <a class="btn btn-default pjax" href="<?php echo $this->createUrl("admin/conditions/sa/index/subaction/editconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>"
                           role="button">
                    ...
                    <?php if (Permission::model()->hasSurveyPermission($surveyid, 'surveycontent', 'update') && $qtypes[$qrrow['type']]['hasdefaultvalues'] > 0): ?>
                        <a class="btn btn-default pjax" href="<?php echo $this->createUrl('questionAdministration/editdefaultvalues/surveyid/' . $surveyid . '/gid/' . $gid . '/qid/' . $qid); ?>"
                           role="button">
            ...
            <?php if (isset($questionbar['buttons']['conditions'])): ?>
                <div class="col-12 form form-inline">
                    ...
                    <a class="btn btn-default pjax <?php if (isset($questionbar['buttons']['condition']['edit']) && $questionbar['buttons']['condition']['edit']) {
                        echo 'active';
                    } ?>" href="<?php echo $this->createUrl("admin/conditions/sa/index/subaction/editconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>" role="button">
                        <span class="icon-conditions_add"></span>
                        <?php eT("Add and edit conditions"); ?>
                    </a>

                    <a class="btn btn-default pjax <?php if (isset($questionbar['buttons']['condition']['copyconditionsform'])) {
                        echo 'active';
                    } ?>" href="<?php echo $this->createUrl("admin/conditions/sa/index/subaction/copyconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>" role="button">
                        <span class="icon-copy"></span>
