...
<div class="col-md-7">
	<a class="btn btn-default <?php if($questionbar['buttons']['condition']['conditions']){echo 'active';}?>" href="<?php echo $this->createUrl("/admin/conditions/sa/index/subaction/conditions/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>" role="button">
	...
	<a class="btn btn-default <?php if($questionbar['buttons']['condition']['copyconditionsform']){echo 'active';}?>" href="<?php echo $this->createUrl("admin/conditions/sa/index/subaction/copyconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>" role="button">
