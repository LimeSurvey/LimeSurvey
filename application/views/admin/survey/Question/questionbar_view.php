    ...
    <div class="container-fluid">
        <div class='row'>
            ...
            <?php endif; ?>
                ...
                <a class="btn btn-outline-secondary pjax" href="<?php echo $this->createUrl("admin/conditions/sa/index/subaction/editconditionsform/surveyid/$surveyid/gid/$gid/qid/$qid"); ?>">
                           role="button">
    ...
    <?php endif;?>
            ...
            <?php if (isset($questionbar['buttons']['conditions'])): ?>
                <div class="col-12 form form-inline">
                    <a class="btn btn-outline-secondary pjax <?php if (isset($questionbar['buttons']['condition']['conditions'])) {
                        echo 'active';
                    ...
                    <a class="btn btn-outline-secondary pjax <?php if (isset($questionbar['buttons']['condition']['edit']) && $questionbar['buttons']['condition']['edit']) {
                        echo 'active';
                    ...
                    <a class="btn btn-outline-secondary pjax <?php if (isset($questionbar['buttons']['condition']['copyconditionsform'])) {
                        echo 'active';
