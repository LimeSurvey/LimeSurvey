    ...
    <div class='row container-fluid'>
        ...
        <div class="col-md-4">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" style="min-width : 252px;">
                    ...
                    <li>
                        <a target='_blank'
                            href='<?php echo $this->createUrl("survey/index", array('sid'=>$surveyid,'newtest'=>"Y",'lang'=>$tmp_lang));?>'>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" style="min-width : 252px;">
                    ...
                    <li>
                        <a target="_blank"
                            href="<?php echo $this->createUrl("survey/index/action/previewgroup/sid/{$surveyid}/gid/{$gid}/lang/" . $tmp_lang); ?>">
                            <?php echo getLanguageNameFromCode($tmp_lang, false); ?>
                        </a>
                    </li>
                    <?php endforeach; ?>
        ...
        <div class="col-md-8 text-right no-padding  pull-right ">
            ...
            <a class="btn btn-default pjax"
                href="<?php echo $this->createUrl('admin/questiongroups/sa/edit/surveyid/'.$surveyid.'/gid/'.$gid); ?>"
                role="button">
            ...
            <a class="btn btn-default pjax"
                href="<?php echo $this->createUrl("admin/expressions/sa/survey_logic_file/sid/{$surveyid}/gid/{$gid}/"); ?>"
                role="button">
        ...
        <div class="col-sm-8">
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" style="min-width : 252px;">
                    ...
                    <li>
                        <a target="_blank"
                            href='<?php echo $this->createUrl("survey/index/action/previewquestion/sid/" . $surveyid . "/gid/" . $gid . "/qid/" . $qid . "/lang/" . $tmp_lang); ?>'>
                            <?php echo getLanguageNameFromCode($tmp_lang, false); ?>
                        </a>
                    </li>
                    <?php endforeach; ?>
