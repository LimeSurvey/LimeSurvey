...
<div class='messagebox ui-corner-all'>
	...
	{ ?>
        ...
        <p>
        <input type='submit'  value='<?php echo $clang->gT("Delete survey"); ?>' onclick="window.open('<?php echo Yii::app()->createUrl("admin/survey/sa/delete/surveyid/$surveyid"); ?>', '_top')" />
        <input type='submit'  value='<?php echo $clang->gT("Cancel"); ?>' onclick="window.open('<?php echo Yii::app()->createUrl("admin/survey/sa/view/$surveyid"); ?>', '_top')" />
    <?php } ?>
</div><br />&nbsp;