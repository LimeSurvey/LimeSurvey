        ...
        <div class="jumbotron message-box">
                ...
                <p>
                    <?php echo CHtml::beginForm($this->createUrl("admin/survey/sa/delete/surveyid/{$surveyid}"), 'post');?>
                        ...
                        <input type='button'  class="btn btn-lg btn-default" value='<?php eT("Cancel"); ?>' onclick="window.open('<?php echo Yii::app()->createUrl("admin/survey/sa/view/surveyid/$surveyid"); ?>', '_top')" />
