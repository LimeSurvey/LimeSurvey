        ...
        <div class="row">
            <div class="col-sm-12 col-lg-6">
                ...
                <div class="form-group">
                    ...
                    <div class="">
                    <div class="htmleditor input-group">
                        <?php echo CHtml::textArea("datasec_{$aSurveyLanguageSettings['surveyls_language']}",$aSurveyLanguageSettings['surveyls_datasecurity_notice'],array('class'=>'form-control','cols'=>'80','rows'=>'15','id'=>"datasec_{$aSurveyLanguageSettings['surveyls_language']}")); ?>
