                ...
                <?php if (isset ($aGroupAndQuestions['questions']))
                    ...
                    <ol>
                        <?php
                            ...
                            {?>
                            <li id='list_q<?php echo $aQuestion['qid'];?>'><div><b><a href='<?php echo Yii::app()->getController()->createUrl('admin/question/editquestion/'.$surveyid.'/'.$aQuestion['gid'].'/'.$aQuestion['qid']);?>'><?php echo $aQuestion['title'];?></a></b>: <?php echo FlattenText($aQuestion['question'],true);?></div></li>
...
<form id='frmOrganize' action="<?php echo Yii::app()->getController()->createUrl('admin/questiongroup/sa/organize/surveyid/'.$surveyid);?>" method="post"><p>
