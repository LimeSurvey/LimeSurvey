            ...
            foreach ($aGroupsAndQuestions as  $aGroupAndQuestions) { ?>
                <li id='list_g<?php echo $aGroupAndQuestions['gid']; ?>' class='card mjs-nestedSortable-expanded mt-2' data-level='group'>
                    ...
                    <div class="h2 card-header bg-white">
                        <a href="javascript:void(0)" role="button" aria-label="<?php echo ellipsize($aGroupAndQuestions['group_text'], 80); ?>" class='btn btn-outline-secondary btn-xs ri-arrow-down-s-fill disclose'><span title="Click to show/hide children" class="caret"></span></a>
                        &nbsp;
