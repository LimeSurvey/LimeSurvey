                                ...
                                <div class="col-md-6">
                                    <div class="card disabled card-primary" id="panel-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body-link">
                                                <p>
                                                    <a href="#" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php eT("This survey is currently active."); ?>"
                                ...
                                <?php if ($surveylocale && $surveysettings): ?>
                                    <div class="card card-clickable card-primary" id="panel-3" data-url="<?php echo $this->createUrl("surveyAdministration/editlocalsettings/surveyid/" . $oSurvey->sid); ?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body-link">
                                                <p><a href="<?php echo $this->createUrl("surveyAdministration/editlocalsettings/surveyid/" . $oSurvey->sid
