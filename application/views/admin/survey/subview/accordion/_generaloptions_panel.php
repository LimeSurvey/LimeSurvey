        ...
        <div class="col-md-6 col-sm-12">
            ...
            <?php else: ?>
                ...
                <div class="form-group">
                    <label class=" control-label" for='admin'><?php  eT("Administrator:") ; ?></label>
                    <div class="">
                        <input type='text' size='50' id='admin' name='admin'   class="form-control"  value='<?php echo $oSurvey->admin ; ?>' />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class=" control-label" for='bounce_email'><?php  eT("Bounce Email:") ; ?></label>
                    <div class="">
                        <input type='email' size='50'  class="form-control"  id='bounce_email' name='bounce_email' value='<?php echo $oSurvey->bounce_email ; ?>' />
                    </div>
                </div>
