...
<div class="row">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 content-right">
                    ...
                    <input class="form-control inherit-edit <?php echo($bShowInherited && $admin === 'inherit' ? 'hide' : 'show'); ?>" type='text' size='50' id='admin' name='admin'
                           value="<?php echo htmlspecialchars($admin); ?>" data-inherit-value="inherit" data-saved-value="<?php echo $admin; ?>"/>
                    <input class="form-control inherit-readonly <?php echo($bShowInherited && $admin === 'inherit' ? 'show' : 'hide'); ?>" type='text' size='50'
                           value="<?php echo htmlspecialchars($oSurveyOptions->admin); ?>" readonly/>
                </div>
                <div class="col-12 col-lg-4 content-right <?php echo($bShowInherited ? 'show' : 'hide'); ?>">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 content-right">
                    ...
                    <input class="form-control inherit-edit <?php echo($bShowInherited && $adminemail === 'inherit' ? 'hide' : 'show'); ?>" type='<?php echo ($bShowInherited) ? 'text' : 'email'; ?>'
                    ...
                    <input class="form-control inherit-readonly <?php echo($bShowInherited && $adminemail === 'inherit' ? 'show' : 'hide'); ?>" type='text' size='50'
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 content-right">
                    ...
                    <input class="form-control inherit-edit <?php echo($bShowInherited && $bounce_email === 'inherit' ? 'hide' : 'show'); ?>" type='<?php echo ($bShowInherited) ? 'text' : 'email'; ?>'
                           size='50' id='bounce_email' name='bounce_email' value="<?php echo htmlspecialchars($bounce_email); ?>" data-inherit-value="inherit"
                           data-saved-value="<?php echo $bounce_email; ?>"/>
                    <input class="form-control inherit-readonly <?php echo($bShowInherited && $bounce_email === 'inherit' ? 'show' : 'hide'); ?>" type='text' size='50'
    ...
    <div class="col-lg-6 col-12">
        ...
        <div class="form-group">
            ...
            <div class="">
                <select id='template' class="form-control" name='template' data-updateurl='<?php echo App()->createUrl('themeOptions/getPreviewTag') ?>'
