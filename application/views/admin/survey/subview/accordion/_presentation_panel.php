...
<div id='presentation' class="tab-pane fade in">
    ...
    <div class="form-group">
        <div class="col-sm-12">
            <h3><?php eT('template'); ?></h3>
            <div class="row template-caroussel">
                <?php
                    $templates = getTemplateList();
                    $count = 0;
                    $surveyid = $esrow['sid'];
                    $surveyinfo['template'] = $esrow['template'];
                ?>

                <div id="carousel-example-generic" class="carousel slide col-sm-12" data-ride="carousel" data-interval="false">
                    <!-- Indicators -->
