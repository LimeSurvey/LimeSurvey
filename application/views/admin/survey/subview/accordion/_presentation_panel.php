            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 content-right">
                        ...
                        <input class="form-control inherit-edit <?php echo($bShowInherited && $navigationdelay == '-1' ? 'hide' : 'show'); ?>" type='text' size='50' id='navigationdelay'
                        ...
                        <input class="form-control inherit-readonly <?php echo($bShowInherited && $navigationdelay == '-1' ? 'show' : 'hide'); ?>" type='text' size='50'
