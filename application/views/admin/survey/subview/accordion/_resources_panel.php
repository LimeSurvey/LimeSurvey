...
<div id='resources'>
    <div class="row">
        ...
        <div class="col-md-auto mb-3">
            <a href="<?php echo $this->createUrl('admin/export/sa/resources/export/survey/surveyid/'.$surveyid); ?>" aria-label="<?php eT("Export resources as ZIP archive") ?>" target="_blank" class="btn btn-outline-secondary">
                <span class="ri-upload-fill"></span>
                <?php eT("Export resources as ZIP archive") ?>
            </a>
            <a class="btn btn-outline-secondary" aria-label="<?php eT("Import resources ZIP archive"); ?>" role="button" href="" target='_blank' data-bs-toggle="modal" data-bs-target="#importRessourcesModal">
