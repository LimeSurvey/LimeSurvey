...
<div id='tokens-panel'>
    <div class="row">
        <div class="col-12 col-lg-6">
            ...
            <div class="mb-3">
                <label  class=" form-label"  for='anonymized' title='<?php eT("If you set 'Yes' then no link will exist between survey participants list and survey responses table. You won't be able to identify responses by their access code."); ?>'>
            ...
            <div class="mb-3">
                <label class=" form-label" for='tokenanswerspersistence' title='<?php  eT("With non-anonymized responses (and the survey participants list field 'Uses left' set to 1) if the participant closes the survey and opens it again (by using the survey link) their previous answers will be reloaded."); ?>'>
