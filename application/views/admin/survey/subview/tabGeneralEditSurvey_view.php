...
<ul>
    ...
    <li><label for='additional_languages'><?php $clang->eT("Additional Languages"); ?>:</label>
            ...
            <td align='left'><input type="button" value="<< <?php $clang->eT("Add"); ?>" onclick="DoAdd()" id="AddBtn" /><br /> <input type="button" value="<?php $clang->eT("Remove"); ?> >>" onclick="DoRemove(0,'')" id="RemoveBtn"  /></td>
