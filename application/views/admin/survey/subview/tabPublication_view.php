<div id='publication'><ul>
            ...
            <li><label for='public'><?php eT("List survey publicly:");?></label>
        ...
        <?php } ?>
             ...
             <li><label for='startdate'><?php eT("Start date/time:"); ?></label>
        ...
        if (trim($esrow['expires']) != '') {
             ...
             <li><label for='expires'><?php eT("Expiry date/time:"); ?></label>
        ...
        <?php if ($esrow['usecaptcha'] == "A") { ?>
              selected='selected'
        <?php } ?>
             ><?php eT("Survey Access"); ?> / <?php eT("Registration"); ?> / <?php echogT("Save & Load"); ?></option>
            <option value='B'
