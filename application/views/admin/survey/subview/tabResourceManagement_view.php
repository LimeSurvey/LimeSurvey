...
?>
<div id='resources'>
            <form enctype='multipart/form-data'  class='form30' id='importsurveyresources' name='importsurveyresources' action='<?php echo $yii->homeUrl.('/admin/survey/importsurveyresources/'); ?>' method='post' onsubmit='return validatefilename(this,"<?php $clang->eT('Please select a file to import!','js'); ?>");'>
            ...
            <li><label>&nbsp;</label>
            <input type='button' onclick='window.open("<?php echo $yii->homeUrl.("/admin/export/resources/exportsurvresources/surveyid/$surveyid/"); ?>", "_blank")' value="<?php $clang->eT("Export Resources As ZIP Archive"); ?>" <?php echo $disabledIfNoResources; ?> /></li>
