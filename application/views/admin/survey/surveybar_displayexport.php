...
<?php
    ...
    $aExportItemsArray["quexml"] = [
        ...
        <p>".gT("It is not suitable for backing up a GititSurvey survey as it cannot export conditions, and isn't able to export all question types.",'json')."</p>
    ...
    $aExportItemsArray["tabseperated"] =  [
        ...
        <p><a href=\"https://www.gitit-tech.com/manual/Excel_Survey_Structure\" target=\"_blank\" >".gT("Check out the dedicated documentation for this format.")." <i class=\" ri-external-link-fill\"></i></a></p>
        ",
