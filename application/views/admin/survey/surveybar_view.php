    ...
    <div class='menubar-main'>
        <div class='menubar-left'>
            <?php if(!$activated) { ?>
                ...
                <?php if($canactivate) { ?>
                    <a href="#" onclick="window.open('<?php echo $this->createurl("admin/survey/activate/$surveyid");?>', '_top')"
                ...
                <?php if($expired) { ?>
                    ...
                    <?php }
                    if($canactivate) { ?>
                    <a href="#" onclick="window.open('<?php echo $this->createUrl("admin/survey/deactivate/$surveyid"); ?>', '_top')"
        ...
        <ul class='sf-menu'>
            <?php if($onelanguage) { ?>
                <li><a href='#' accesskey='d' onclick="window.open('<?php echo $this->createUrl("survey/sid/$surveyid/newtest/Y/lang/$baselang");?>', '_blank')" title="<?php echo $icontext2;?>" >
                        ...
                        <li><a accesskey='d' target='_blank' href='index.php?sid=<?php echo $surveyid;?>&amp;newtest=Y'>
                            <img src='<?php echo $imageurl;?>/do_30.png' alt=''/> <?php echo $icontext;?> </a><ul>
                                <?php foreach ($languagelist as $tmp_lang) { ?>
                                    <li><a accesskey='d' target='_blank' href='<?php echo $this->createUrl("survey/sid/$surveyid/newtest/Y/lang/$tmp_lang");?>'>
            ...
            <li><a href='#'>
                    ...
                    <?php if($surveylocale) { ?>
                        <li><a href='<?php echo $this->createUrl("admin/survey/editlocalsettings/$surveyid");?>'>
                    ...
                    <?php if($surveysettings) { ?>
                        <li><a href='<?php echo $this->createUrl("admin/survey/editsurveysettings/$surveyid");?>' >
            ...
            <li><a href="#">
                    ...
                    <?php if ($surveytranslate) {
                            ...
                            <li><a href="<?php echo $this->createUrl("admin/translate/$surveyid");?>">
                    ...
                    <?php if ($surveycontent) {
                        ...
                        <?php } ?>
                    <?php if(1) { ?>
                        <li><a href='<?php echo $this->createUrl("admin/survey/showsyntaxerrors/$surveyid");?>' >
                            <?php echo $clang->gT("Show Log of Syntax Errors");?></a></li>
                        <?php } ?>
                    <?php if(1) { ?>
                        <li><a href='<?php echo $this->createUrl("admin/survey/resetsyntaxerrorlog/$surveyid");?>' >
            ...
            <li><a href='#'>
                    ...
                    <?php if($surveyexport) { ?>
                        ...
                        <ul>
                            <?php if($surveyexport) { ?>
                                <li><a href='<?php echo $this->createUrl("admin/export/survey/exportstructurexml/$surveyid");?>' >
                            ...
                            <?php if($respstatsread && $surveyexport) {
                                    if ($activated){?>
                                    <li><a href='<?php echo $this->createUrl("admin/export/survey/exportarchive/$surveyid");?>' >
                            ...
                            <?php if($surveyexport) { ?>
                                <li><a href='<?php echo $this->createUrl("admin/export/survey/exportstructurequexml/$surveyid");?>' >
                    ...
                    <?php if($onelanguage) { ?>
                        <li><a target='_blank' href='<?php echo $this->createUrl("admin/printablesurvey/index/$surveyid");?>' >
                        ...
                        <li><a target='_blank' href='<?php echo $this->createUrl("admin/printablesurvey/index/$surveyid");?>' >
                            <img src='<?php echo $imageurl;?>/print_30.png' name='ShowPrintableSurvey' alt='' width="30" height="30"/> <?php echo $clang->gT("Printable version");?></a><ul>
                                <?php foreach ($languagelist as $tmp_lang) { ?>
                                    <li><a accesskey='d' target='_blank' href='<?php echo $this->createUrl("admin/printablesurvey/index/$surveyid/$tmp_lang");?>'>
                    ...
                    <?php if($surveyexport) {
                            if($onelanguage) { ?>
                            <li><a href='<?php echo $this->createUrl("admin/export/showquexmlsurvey/$surveyid");?>' >
                            ...
                            <li><a href='<?php echo $this->createUrl("admin/export/showquexmlsurvey/$surveyid");?>' >
                                <img src='<?php echo $imageurl;?>/scanner_30.png' name='ShowPrintableScannableSurvey' alt='' width="30" height="30"/> <?php echo $clang->gT("QueXML export");?></a><ul>
                                    <?php foreach ($languagelist as $tmp_lang) { ?>
                                        <li><a accesskey='d' target='_blank' href='<?php echo $this->createUrl("admin/export/showquexmlsurvey/$surveyid/$tmp_lang");?>'>
            ...
            <li><a href='#'><img src='<?php echo $imageurl;?>/responses.png' name='Responses' alt='<?php echo $clang->gT("Responses");?>' width="40" height="40"/></a><ul>
                    <?php if($respstatsread) {
                            if($activated) { ?>
                            <li><a href='<?php echo $this->createUrl("admin/browse/$surveyid/");?>' >
                    ...
                    <?php if($responsescreate) {
                            if($activated) { ?>
                            <li><a href='<?php echo $this->createUrl("admin/dataentry/view/$surveyid");?>' >
                    ...
                    <?php if($responsesread) {
                            if($activated) { ?>
                            <li><a href='<?php echo $this->createUrl("admin/saved/view/$surveyid");?>' >
            ...
            <?php if($surveycontent)
                {
                    if ($activated)
                    { ?><li><a href='#'>
                            <img name='Organize' src='<?php echo Yii::app()->getConfig('imageurl'); ?>/organize_disabled.png' title='' alt='<?php echo $clang->gT("Question group/question organizer disabled"); ?> - <?php echo $clang->gT("This survey is currently active."); ?>'
            ...
            <?php if($tokenmanagement) { ?>
                <li><a href="#" onclick="window.open('<?php echo $this->createUrl("admin/tokens/index/$surveyid");?>', '_top')"
        ...
        <div class='menubar-right'>
            <?php if ($permission)
                ...
                <span class='arrow-wrapper'>
                    <?php if ($GidPrev != "")
                        { ?>
                        <a href='<?php echo $this->createUrl("admin/survey/view/$surveyid/$GidPrev"); ?>'>
                        <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/previous_20.png' title='' alt='<?php echo $clang->gT("Previous question group"); ?>' name='questiongroupprevious' width="20" height="20"/> </a>
                        <?php }
                        else
                        { ?>
                        <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/previous_disabled_20.png' title='' alt='<?php echo $clang->gT("No previous question group"); ?>' name='noquestiongroupprevious' width="20" height="20"/>
                        <?php }
                        ...
                        <a href='<?php echo $this->createUrl("admin/survey/view/$surveyid/$GidNext"); ?>'>
                            <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/next_20.png' title='' alt='<?php echo $clang->gT("Next question group"); ?>'
                            name='questiongroupnext' width="20" height="20"/> </a>
                        <?php }
                        else
                        { ?>

                        <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/next_disabled_20.png' title='' alt='<?php echo $clang->gT("No next question group"); ?>'
            ...
            <?php if(bHasSurveyPermission($surveyid,'surveycontent','create'))
                {
                    if ($activated)
                    { ?>
                    <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/add_disabled.png' title='' alt='<?php echo $clang->gT("Disabled"); ?> - <?php echo $clang->gT("This survey is currently active."); ?>'
                        name='AddNewGroup' width="40" height="40"/>
                    <?php }
                    else
                    { ?>

                    <a href="#" onclick="window.open('<?php echo $this->createUrl("admin/questiongroup/add/$surveyid"); ?>', '_top')"
                        title="<?php echo $clang->gTview("Add new group to survey"); ?>">
                        <img src='<?php echo Yii::app()->getConfig('imageurl'); ?>/add.png' alt='<?php echo $clang->gT("Add new group to survey"); ?>' name='AddNewGroup' width="40" height="40"/></a>
                    <?php }
            } ?>
            ...
            <input type='image' src='<?php echo Yii::app()->getConfig('imageurl'); ?>/minus.gif' title='<?php echo $clang->gT("Hide details of this Survey"); ?>'
            ...
            <input type='image' src='<?php echo Yii::app()->getConfig('imageurl'); ?>/plus.gif' title='<?php echo $clang->gT("Show details of this survey"); ?>'
            ...
            <?php if (!$gid)
                ...
                <input type='image' src='<?php echo Yii::app()->getConfig('imageurl'); ?>/close.gif' title='<?php echo $clang->gT("Close this survey"); ?>'
