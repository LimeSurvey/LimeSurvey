	...
	<div class="modal-body">
		<div class="container-fluid">
			...
			<div class="form-group">
				...
				<?php echo $form->textField($model,'name',array('title'=>gT('Kleinbuchstaben und Zahlen, beginnend mit einem Buchstaben - min 6 Zeichen, max 60 Zeichen'), 'size'=>60,'maxlength'=>255, 'pattern' => '[a-z][a-z0-9]{5,59}')); ?>
