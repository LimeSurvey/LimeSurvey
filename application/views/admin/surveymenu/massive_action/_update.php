...
<form class="custom-modal-datas form form-horizontal">
	<div class="container-fluid">
        ...
        <div class="form-group">
            ...
            <label class="col-sm-3 form-label"  for='menu_id'><?php eT("Position?"); ?></label>
            <div class="col-sm-8">
		...
		<div class="form-group">
            ...
            <label class="col-sm-3 form-label"  for='menu_class'><?php eT("Parent menu?"); ?></label>
            <div class="col-sm-8">
            ...
            <div class="form-group">
                ...
                <label class="col-sm-3 form-label"  for='permission'><?php eT("Survey?"); ?></label>
                <div class="col-sm-8">
