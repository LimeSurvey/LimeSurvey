    <div class="well">
        ...
        <p><?= gT("This surveys group are shown in list for user with rights on survey group, user with any rights on one survey inside this group and if this groups was set as available.") ?></p>
    </div>
