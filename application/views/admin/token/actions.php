...
?>
	...
	{ ?>
		...
		onclick="<?php echo get2post($this->createUrl("admin/tokens/email/surveyid/$surveyid/tids")."?tokenids=$id");?>" />
		...
		onclick="<?php echo get2post($this->createUrl("admin/tokens/remind/surveyid/$surveyid/tids")."?tokenids=$id");?>" />
<?php } ?> -->
