...
<div class='messagebox ui-corner-all'>
    ...
    { ?>
        ...
        <input type='button' value='<?php $clang->eT("Display tokens"); ?>' onclick="window.open('<?php echo $this->createUrl("admin/tokens/sa/browse/sa/index/surveyid/$surveyid"); ?>', '_top')" /><br />
