...
?>><?php echo $clang->gT("POP"); ?></option>
        ...
        <li><label for='bounceaccounthost'><?php echo $clang->gT("Server name & port:"); ?></label>
            ...
            <font size='1'><?php echo $clang->gT("Enter your hostname and port, e.g.: imap.gmail.com:995"); ?></font>
        ...
        <li><label for='bounceaccountencryption'><?php echo $clang->gT("Encryption type:"); ?></label>
