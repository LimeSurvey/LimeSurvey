...
<div id='bouncesettingsdiv'>
    <?php echo CHtml::form(array("admin/tokens/sa/bouncesettings/surveyid/{$surveyid}"), 'post', array('id'=>'bouncesettings', 'name'=>'bouncesettings', 'class'=>'form30')); ?>
        <br>
        <ul><li><label for='bounce_email'><?php eT('Survey bounce email:'); ?></label>
                <input type='email' size='50' id='bounce_email' name='bounce_email' value="<?php echo $settings['bounce_email']; ?>" ></li>
            <li><label for='bounceprocessing'><?php eT("Bounce settings to be used"); ?></label>
                <select id='bounceprocessing' name='bounceprocessing'>
                    ...
                    <option value='L'<?php
                        ...
                        ?>><?php eT("Use settings below"); ?></option>
                    <option value='G'<?php
                            if ($settings['bounceprocessing'] == 'G')
                            {
                                echo " selected='selected'";
                            }
                        ?>><?php eT("Use global settings"); ?></option>
                </select></li>
            ...
            <input type='text' size='50' id='bounceaccounthost' name='bounceaccounthost' value="<?php echo $settings['bounceaccounthost']; ?>" /> <span class='annotation'><?php eT("Enter your hostname and port, e.g.: imap.gmail.com:995"); ?></span>
            ...
            <li><label for='bounceaccountencryption'><?php eT("Encryption type:"); ?></label>
    ...
    <p><input type='button' onclick='bouncesettings.submit()' class='standardbtn' value='<?php eT("Save settings"); ?>' /><br /></p>
