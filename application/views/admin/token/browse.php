...
<script type="text/javascript">
    ...
    var remindurl = "<?php echo Yii::app()->getController()->createUrl("admin/tokens/sa/remind/surveyid/{$surveyid}/tids/|"); ?>";
    ...
    var inviteurl = "<?php echo Yii::app()->getController()->createUrl("admin/tokens/sa/email/surveyid/{$surveyid}/tids/|"); ?>";
...
<!--p><input type="button" name="sendinvitations" id="sendinvitations" value="Send Invitations" onclick='window.open("<?php echo Yii::app()->getController()->createUrl("admin/tokens/sa/email/surveyid/{$surveyid}/tids/|"); ?>"+$("#displaytokens").getGridParam("selarrrow").join("|"), "_blank")' /><input type="button" name="sendreminders" id="sendreminders" value="Send Reminders" onclick='window.open("<?php echo Yii::app()->getController()->createUrl("admin/tokens/sa/remind/surveyid/{$surveyid}/tids/|"); ?>"+$("#displaytokens").getGridParam("selarrrow").join("|"), "_blank")' />
</p-->
</table>
