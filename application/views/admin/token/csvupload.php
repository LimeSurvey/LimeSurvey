    ...
    <div class="row">
        <div class="col-lg-12 content-right">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <p><?php eT("File should be a standard CSV (comma delimited) file with optional double quotes around values (default for LibreOffice and Excel). The first line must contain the field names. The fields can be in any order."); ?></p>
