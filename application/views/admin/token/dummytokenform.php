		...
		<div class="col-lg-12 content-right">     
            <?php echo CHtml::form(array("admin/tokens/sa/adddummies/surveyid/{$surveyid}/subaction/add"), 'post', array('id'=>'edittoken', 'name'=>'edittoken', 'class'=>'form30 form-horizontal')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text' size='20' id='amount' name='amount' value="100" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='text' size='20' id='tokenlen' name='tokenlen' value="<?php echo $tokenlength; ?>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type='email' maxlength='320' size='50' id='email' name='email' value="" />
                    </div>
                </div>
