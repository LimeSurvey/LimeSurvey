            ...
            <div id="language_<?php echo $language ?>">
                <table class='listsurveys'>
                    ...
                    <tbody>
                        ...
                        $tokenvalues = array('description' => '','mandatory' => 'N','show_register' => 'N',);
                        $nrofattributes++;
                        echo "
                        <tr>
                            <td>{$tokenfield}</td>";
                            ...
                            {
                                echo "<td><input type='text' name='description_{$tokenfield}' value='" . htmlspecialchars($tokenvalues['description'], ENT_QUOTES, 'UTF-8') . "' /></td>";
                            ...
                            echo "<td><input type='text' name='caption_{$tokenfield}_$language' value='" . htmlspecialchars(!empty($tokencaptions[$language][$tokenfield]) ? $tokencaptions[$language][$tokenfield] : '', ENT_QUOTES, 'UTF-8') . "' /></td>";
                            echo "<td>";
                            if ($examplerow !== false)
                            {
                                if (!$tokenfield[10] == 'c')
