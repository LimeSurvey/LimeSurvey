...
?><div id='tokenbar' class='menubar'>
    ...
    <div class='menubar-main'>
        <div class='menubar-left'>
            <a href="<?php echo $this->createUrl("admin/survey/sa/view/surveyid/$surveyid"); ?>"><img src='<?php echo $imageurl; ?>home.png' alt='<?php eT("Return to survey administration"); ?>' /></a>
            ...
            <?php if (Permission::model()->hasSurveyPermission($surveyid, 'tokens', 'update')){ ?>
                ...
                <a href="<?php echo $this->createUrl("admin/tokens/sa/email/surveyid/$surveyid"); ?>">
                    <img src='<?php echo $imageurl; ?>invite.png' alt='<?php eT("Send email invitation"); ?>' />
                </a>
                <a href="<?php echo $this->createUrl("admin/tokens/sa/email/action/remind/surveyid/$surveyid"); ?>">
                    <img src='<?php echo $imageurl; ?>remind.png' alt='<?php eT("Send email reminder"); ?>' />
                </a>
                <img src='<?php echo $imageurl; ?>separator.gif' class='separator' alt='' />
                <a href="<?php echo $this->createUrl("admin/tokens/sa/tokenify/surveyid/$surveyid"); ?>">
                    <img src='<?php echo $imageurl; ?>tokenify.png' alt='<?php eT("Generate tokens"); ?>' />
                </a>
                <img src='<?php echo $imageurl; ?>separator.gif' class='separator' alt='' />
            <?php } ?>
            <?php if (Permission::model()->hasSurveyPermission($surveyid, 'tokens', 'update')){ ?>
        ...
        <div class='menubar-right'><a href="#" onclick="showhelp('show')">
                <img src='<?php echo $imageurl; ?>showhelp.png' alt='<?php eT("Show help"); ?>' /></a>
        </div>
    </div>
</div>
