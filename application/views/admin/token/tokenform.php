                        ...
                        <div class="form-group">
                            ...
                            <div id="completed-container" class="">
                                ...
                                <div class="selector__yesNoContainer <?php echo $sCointainerClass; ?>"
                                    ...
                                    <!-- <input class='form-control hidden YesNoDateHidden' type='text' size='20' id='completed' name='completed' value="<?php if (isset($completed)) {
                                        echo $completed;
                                    } else {
                                        echo "N";
                                    } ?>" /> -->
                    ...
                    <div class="ls-flex-column ls-space padding left-5 right-35 col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="selector__yesNoContainer <?php echo $sCointainerClass; ?>" id="sent-yes-no-date-container"
                                ...
                                <!-- <input class='form-control hidden YesNoDateHidden' type='text' size='20' id='sent' name='sent' value="<?php if (isset($sent)) {
                                    echo $sent;
                                } else {
                                    echo "N";
                                } ?>" /> -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="selector__yesNoContainer <?php echo $sCointainerClass; ?>" id="remind-yes-no-date-container"
                                ...
                                <!-- <input class='form-control hidden YesNoDateHidden' type='text' size='20' id='remindersent' name='remindersent' value="<?php if (isset($remindersent) && $remindersent != 'N') {
                                    echo $remindersent;
                                } else {
                                    echo "N";
                                } ?>" /> -->
