...
*/
?>
<div class='container-fluid <?php if( !isset($ajax) || $ajax = false ):?> side-body <?php echo getSideBodyClass(false); ?> <?php endif;?>'>
        ...
        <?php foreach ($attrfieldnames as $attr_name => $attr_description): ?>
          <div class="form-group">
            <label class=" control-label" for='<?php echo $attr_name; ?>'>
              <?php echo $attr_description['description'] . ($attr_description['mandatory'] == 'Y' ? '*' : '') ?>:</label>
            <div class="">
