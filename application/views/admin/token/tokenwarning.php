<div class="side-body">
    <h3><?php eT("Token control"); ?> <?php echo htmlspecialchars($thissurvey['surveyls_title']); ?></h3>

    <div class="row">
        <div class="col-lg-12 content-right">
                <div class='messagebox ui-corner-all'>
                <div class="alert alert-warning" role="alert"><?php eT("Warning"); ?> !</div>
                <strong class="text-warning"><?php eT("Tokens have not been initialised for this survey."); ?></strong><br /><br />
                <?php
                    ...
                    <?php echo CHtml::form(array("admin/tokens/sa/index/surveyid/{$surveyid}"), 'post'); ?>
                        <button type="submit" class="btn btn-default"  name="createtable" value="Y"><?php eT("Initialise tokens"); ?></button>
                        <a href="<?php echo $this->createUrl("admin/survey/sa/view/surveyid/$surveyid"); ?>" class="btn btn-default"><?php eT("No, thanks."); ?></a>
                    </form>
