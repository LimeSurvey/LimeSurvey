...
<div class="form-group">
    <label for="user" class=" control-label"><?php eT("Username");?></label>
    <div class="">
...
<div class="form-group">
    <label for="email" class=" control-label"><?php eT("Email");?></label>
    <div class="">
        <?php echo CHtml::emailField('email',$aUserData['email'],array('class'=>"form-control"));?>
    </div>
</div>
<div class="form-group">
    <label for="full_name" class=" control-label"><?php eT("Full name");?></label>
    <div class="">
        <?php echo CHtml::textField('full_name',$aUserData['full_name'],array('class'=>"form-control"));?>
    </div>
</div>
<div class="form-group">
    <label for="password" class=" control-label"><?php eT("Password");?></label>
    <div class="">
