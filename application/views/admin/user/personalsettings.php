                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade show active" id="your-profile">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <button type="button" class="btn btn-warning " id="selector__showChangePassword" style="outline: none;">
                                        <i class="ri-lock-fill"></i>
                                        <?= gT("Change password") ?>
                                    </button>
                                    <button type="button" class="btn btn-warning " id="selector__showChangeEmail" style="outline: none;">
                                        <i class="ri-lock-fill"></i>
