                ...
                <div id="boxes" class="tab-pane fade show active">
                    <?php $this->widget(
                        ...
                        [
                            ...
                            'template' => "{items}\n<div id='boxListPager'><div class=\"col-md-4\" id=\"massive-action-container\"></div><div class=\"col-md-4 pager-container ls-ba \">{pager}</div><div class=\"col-md-4 summary-container\">{summary}</div></div>",
