    ...
    <div class="col-md-8">
        ...
        <?php endif; ?>
            ...
            <?php
                $rows = array();
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbtype', array('class' => 'control-label ')),
                ...
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dblocation', array('class' => 'control-label ')),
                ...
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbuser', array('class' => 'control-label ')),
                ...
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbpwd', array('class' => 'control-label ')),
                ...
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbname', array('class' => 'control-label ')),
                ...
                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbengine', array('class' => 'control-label ')),
                    'control' => CHtml::activeDropDownList($model, 'dbengine', $model->dbEngines, array('required' => 'required','autocomplete'=>'off', 'class' => 'form-control')),
                    'description' => '',
                );

                $rows[] = array(
                    'label' => CHtml::activeLabelEx($model, 'dbprefix', array('class' => 'control-label ')),
