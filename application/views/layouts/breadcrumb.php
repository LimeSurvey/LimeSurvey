...
// TODO: never used $aData['title_bar']['title'] is checked for rendering of
// TODO: breadcrumb but $aData['subaction'] is what defines the actual title @link LayoutHelper::rendertitlebar
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb ls-flex-row align-items-center align-content-flex-start <?php echo $extraClass ?>">
                <li class="breadcrumb-item" aria-current="page">
                    <a id="breadcrumb__surveylist--link" class="pjax animate home-icon"
                       href="<?php echo App()->createUrl('surveyAdministration/listsurveys'); ?>">
                        <?php et('Surveys') ?>
                    </a>
                </li>
                ...
                <?php if (isset($module_subaction)): ?>
                    <li class="breadcrumb-item" aria-current="page">
                        <a id="breadcrumb__module--subaction" class="pjax animate"
                           href="<?php echo $module_subaction_url ?>">
