...
<div class="modal fade" aria-modal="true"  id="question-preview" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 role="heading" aria-level="2" class="modal-title" id="myModalLabel"><?php eT("Question preview"); ?></h5>
