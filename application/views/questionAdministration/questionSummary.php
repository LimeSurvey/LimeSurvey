            ...
            <?php if (Permission::model()->hasSurveyPermission($survey->sid, 'surveycontent', 'update')): ?>
                ...
                <div class="row welcome survey-action">
                    <div class="col-lg-12 content-right">
                        ...
                        <div class="col-lg-3">
                            <div class="card text-center <?php if ($survey->isActive) { echo 'disabled'; } else { echo 'panel-clickable'; } ?>" id="panel-1" data-url="<?php echo $this->createUrl('questionAdministration/create/surveyid/'.$survey->sid.'/gid/'.$question->gid); ?>">
