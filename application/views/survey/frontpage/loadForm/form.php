...
<div class='load-survey-form '>
    <div class='form-group load-survey-row load-survey-name'>
        <label class='form-label col-sm-3 load-survey-label' for='loadname'><?php echo gT("Saved name:") ?></label>
    ...
    <div class='form-group load-survey-row load-survey-password'>
        <label class='form-label col-sm-3 load-survey-label label-cell' for='loadpass'><?php echo gT("Password:") ?></label>
        <div class='col-sm-7 load-survey-input input-cell'>
    ...
    <?php if($captcha) : ?>
      <div class='form-group load-survey-row load-survey-captcha'>
          <label class='form-label col-sm-3 load-survey-label label-cell' for='loadsecurity'><?php echo gT("Security question:") ?></label>
          <div class='col-sm-7 load-survey-input input-cell'>
