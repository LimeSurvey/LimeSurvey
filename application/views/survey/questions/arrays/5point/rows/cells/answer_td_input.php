...
<!-- td_input -->
<td data-title='<?php echo $i;?>' class="answer-cell-2 answer_cell_<?php echo $i;?> answer-item radio-item radio text-center">
    <input
        class="radio"
        type="radio"
    ...
    -->
    <div class="hide label-text label-clickable" id="label-answer<?php echo $myfname;?>-<?php echo $i; ?>">
        <?php echo $i;?>
    </div>
</td>
<!-- end of td_input -->
