...
<!-- answer_row -->
<tr id="javatbd<?php echo $myfname;?>" class="answers-list radio-list array<?php echo $zebra; ?><?php if($error){ echo " bg-warning";} ?>" role="radiogroup"  aria-labelledby="answertext<?php echo $myfname;?>">
