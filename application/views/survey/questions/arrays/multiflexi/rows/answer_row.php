...
<!-- answer_row -->
<tr id="javatbd<?php echo $myfname;?>" class="subquestion-list questions-list array<?php echo $zebra; ?><?php if($error){ echo " has-error";} ?>" <?php echo $sDisplayStyle;?> role="group" aria-describedby="answertext<?php echo $myfname;?>">
