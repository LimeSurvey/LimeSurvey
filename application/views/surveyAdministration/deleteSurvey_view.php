        ...
        <div class="jumbotron message-box">
                ...
                <p>
                    <?php echo CHtml::beginForm($this->createUrl("surveyAdministration/delete/surveyid/{$surveyid}"), 'post');?>
                        ...
                        <input type='button'  class="btn btn-lg btn-default" value='<?php eT("Cancel"); ?>' onclick="window.open('<?php echo Yii::app()->createUrl("surveyAdministration/view/surveyid/$surveyid"); ?>', '_top')" />
