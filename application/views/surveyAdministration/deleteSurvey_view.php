    ...
    <div class="row">
        ...
        <div class="jumbotron message-box">
                ...
                <p>
                    ...
                    <?php if ($survey->hasTokensTable): ?>
                        <span class="text-warning"><?php eT("This survey has an associated participant table. If you delete this survey this participant table will be deleted. We recommend that you export or backup these participants before deleting this survey."); ?><br /><br />
                    <?php endif; ?>
                ...
                <p>
                    <?php echo CHtml::beginForm($this->createUrl("surveyAdministration/delete/surveyid/{$surveyid}"), 'post');?>
                        ...
                        <input type='button'  class="btn btn-lg btn-outline-secondary" value='<?php eT("Cancel"); ?>' onclick="window.open('<?php echo Yii::app()->request->getUrlReferrer( Yii::app()->createUrl("surveyAdministration/view/surveyid/$surveyid") ); ?>', '_top')" />
