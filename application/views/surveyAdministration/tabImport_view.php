        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-4">
                    ...
                    <div>
                        <input id='the_file' name="the_file" class="form-control" type="file" accept='.lss,.lsa,.tsv,.txt' onchange="$('#import-submit').attr('disabled', false).attr('data-toggle', false);" required />
                    </div>
                </div>
