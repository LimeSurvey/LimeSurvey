...
<div class="list-themes">
    <ul class="nav nav-tabs" id="themelist" role="tablist">
        <li class="nav-item" role="presentation">
            <a class="nav-link active" href="#surveythemes" data-bs-toggle="tab" role="tab" aria-selected="true">
                <?php eT('Survey themes'); ?>
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="#adminthemes" data-bs-toggle="tab" role="tab" aria-selected="false">
                <?php eT('Admin themes'); ?>
            </a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" href="#questionthemes" data-bs-toggle="tab" role="tab" aria-selected="false">
