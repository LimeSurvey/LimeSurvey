...
<div class="container-fluid">
    ...
    $this->widget('yiistrap.widgets.TbGridView',
        [
            ...
            'template'        => "{items}\n<div id='userListPager'><div class=\"col-md-4\" id=\"massive-action-container\">$massiveAction</div><div class=\"col-md-4 pager-container ls-ba \">{pager}</div><div class=\"col-md-4 summary-container\">{summary}</div></div>",
