            ...
            <div class="col-12 content-right">
                ...
                $this->widget(
                    ...
                    [
                        ...
                        'template' => "{items}\n<div id='rolecontrolListPager'><div class=\"col-md-4\" id=\"massive-action-container\">$massiveAction</div><div class=\"col-md-4 pager-container ls-ba \">{pager}</div><div class=\"col-md-4 summary-container\">{summary}</div></div>",
