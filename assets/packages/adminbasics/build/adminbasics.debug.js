...
/******/return __webpack_require__(__webpack_require__.s=5);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(7),__webpack_require__(8)(module));/***/},/* 1 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/**
...
if(response.outputType=='jsonoutputhtml'){$('#'+response.target).html(response.html);__WEBPACK_IMPORTED_MODULE_0__globalMethods__["c"/* globalWindowMethods */].doToolTip();}// Success popup
...
if(_typeof(window.LS.adminCore)==='object'){window.LS.adminCore.refresh();return;}var eventsBound={document:[]};var onLoadRegister=function onLoadRegister(){__WEBPACK_IMPORTED_MODULE_10__parts_globalMethods__["b"/* globalStartUpMethods */].bootstrapping();Object(__WEBPACK_IMPORTED_MODULE_8__pages_surveyGrid__["a"/* onExistBinding */])();appendToLoad(__WEBPACK_IMPORTED_MODULE_10__parts_globalMethods__["a"/* globalOnloadMethods */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_9__parts_confirmationModal__["a"/* default */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_5__pages_questionEditing__["a"/* default */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_14__components_confirmdeletemodal__["a"/* default */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_15__components_panelclickable__["a"/* default */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_16__components_panelsanimation__["a"/* default */]);appendToLoad(__WEBPACK_IMPORTED_MODULE_17__components_notifications__["a"/* default */].initNotification);appendToLoad(__WEBPACK_IMPORTED_MODULE_13__parts_save__["a"/* default */]);},appendToLoad=function appendToLoad(fn,event,root){event=event||'ready pjax:scriptcomplete';root=root||'document';__WEBPACK_IMPORTED_MODULE_18__components_lslog__["a"/* default */].log('appendToLoad',{'type':typeof fn==='undefined'?'undefined':_typeof(fn),'fn':fn});eventsBound[root]=eventsBound[root]||[];if(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.find(eventsBound[root],{fn:fn,event:event,root:root})===undefined){eventsBound[root].push({fn:fn,event:event,root:root});var events=__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(event.split(' '),function(event){return event+'.admincore';});if(root=='document'){$(document).on(events.join(' '),fn);}else{$(root).on(events.join(' '),fn);}}},refreshAdminCore=function refreshAdminCore(){__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(eventsBound,function(eventMap,root){__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(eventMap,function(evItem){var events=__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.map(evItem.event.split(' '),function(event){return event+'.admincore';});$(evItem.root).off(events.join(' '));$(evItem.root).on(events.join(' '),evItem.fn);});});Object(__WEBPACK_IMPORTED_MODULE_8__pages_surveyGrid__["a"/* onExistBinding */])();__WEBPACK_IMPORTED_MODULE_18__components_lslog__["a"/* default */].log("Refreshed Admin core methods");},setNameSpace=function setNameSpace(){var BaseNameSpace={adminCore:{refresh:refreshAdminCore,onload:onLoadRegister,appendToLoad:appendToLoad}};var LsNameSpace=__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge(BaseNameSpace,__WEBPACK_IMPORTED_MODULE_10__parts_globalMethods__["c"/* globalWindowMethods */],__WEBPACK_IMPORTED_MODULE_12__parts_ajaxHelper__,__WEBPACK_IMPORTED_MODULE_11__parts_notifyFader__,__WEBPACK_IMPORTED_MODULE_7__pages_subquestionandanswers__["a"/* subquestionAndAnswersGlobalMethods */],__WEBPACK_IMPORTED_MODULE_17__components_notifications__["a"/* default */]);/*
            ...
            */window.LS=__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge(window.LS,LsNameSpace,{ld:__WEBPACK_IMPORTED_MODULE_0_lodash___default.a});/* Set a variable to test if browser have HTML5 form ability
            * Need to be replaced by some polyfills see #8009
            */window.hasFormValidation=typeof document.createElement('input').checkValidity=='function';};setNameSpace();onLoadRegister();__WEBPACK_IMPORTED_MODULE_18__components_lslog__["a"/* default */].log("AdminCore",eventsBound);};AdminCore();/***/},/* 7 *//***/function(module,exports){var g;// This works in non-strict mode
...
module.exports=g;/***/},/* 8 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 9 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";jQuery.fn.extend({center:function center(){this.css("position","absolute");this.css("top",($(window).height()-this.height())/2+$(window).scrollTop()+"px");this.css("left",($(window).width()-this.width())/2+$(window).scrollLeft()+"px");return this;}});/***/},/* 10 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";$.fn.extend({isEmpty:function isEmpty(helperMsg){if($.trim($(this).value).length==0){alert(helperMsg);$(this).focus();// set the focus to this input
return false;}return true;}});/***/},/* 11 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";String.prototype.splitCSV=function(sep){for(var foo=this.split(sep=sep||","),x=foo.length-1,tl;x>=0;x--){if(foo[x].replace(/"\s+$/,'"').charAt(foo[x].length-1)=='"'){if((tl=foo[x].replace(/^\s+"/,'"')).length>1&&tl.charAt(0)=='"'){foo[x]=foo[x].replace(/^\s*"|"\s*$/g,'').replace(/""/g,'"');}else if(x){foo.splice(x-1,2,[foo[x-1],foo[x]].join(sep));}else foo=foo.shift().split(sep).concat(foo);}else foo[x].replace(/""/g,'"');}return foo;};/***/},/* 12 *//***/function(module,exports){/**
...
var _parseOptions=function _parseOptions(e){return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.mergeWith(optionsDefault,$(_this).data(),function(objValue,srcValue,key){return srcValue||$(e.relatedTarget).data(key)||null;});},//Generate a simple link on the ok button
...
_setTarget();};var loadMethods=function loadMethods(){$('#confirmation-modal').on('show.bs.modal',function(e){ConfirmationModal.call(this,e);});};/* harmony default export */__webpack_exports__["a"]=loadMethods;/***/},/* 18 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash__=__webpack_require__(0);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_lslog__=__webpack_require__(1);var SaveController=function SaveController(){var formSubmitting=false;// Attach this <input> tag to form to check for closing after save
 ...
 */function panelsAnimation(){/**
     ...
     */function rotateLast(){var $rotateShown=$('.rotateShown');var $rotateHidden=$('.rotateHidden');$rotateShown.hide('slide',{direction:'left',easing:'easeInOutQuint'},500,function(){$rotateHidden.show('slide',{direction:'right',easing:'easeInOutQuint'},1000);});$rotateShown.removeClass('rotateShown').addClass('rotateHidden');$rotateHidden.removeClass('rotateHidden').addClass('rotateShown');window.setTimeout(rotateLast,5000);}if($("#last_question").length){$('.rotateHidden').hide();window.setTimeout(rotateLast,2000);}};/***/},/* 22 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony import */var _arguments=arguments;var __WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__=__webpack_require__(4);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__lslog__=__webpack_require__(1);/**
 * Notifcation system for admin
 *
 * @since 2017-08-02
 * @author Olle Haerstedt, Markus Flür
 */var NotifcationSystem=function(){function NotifcationSystem(){_classCallCheck(this,NotifcationSystem);}_createClass(NotifcationSystem,[{key:'__updateNotificationWidget',/**
     * Load widget HTML and inject it
     * @param {string} URL to call
     * @return
     */value:function __updateNotificationWidget(updateUrl){var _this4=this;__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('updateNotificationWidget');// Update notification widget
return Object(__WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"])({url:updateUrl,method:'GET',success:function success(response){$('#notification-li').replaceWith(response);// Re-bind onclick
_this4.initNotification();// Adapt style to window size
_this4.styleNotificationMenu();}});}},{key:'__notificationIsRead',/**
     * Tell system that notification is read
     * @param {object} that The notification link
     * @return
     */value:function __notificationIsRead(that){var _this5=this;__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('notificationIsRead');Object(__WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"])({url:$(that).data('read-url'),method:'GET'}).done(function(response){// Fetch new HTML for menu widget
_this5.__updateNotificationWidget($(that).data('update-url'));});}},{key:'__showNotificationModal',/**
     * Fetch notification as JSON and show modal
     * @param {object} that The notification link
     * @param {url} URL to fetch notification as JSON
     * @return
     */value:function __showNotificationModal(that,url){var _this6=this;__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('showNotificationModal');Object(__WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"])({url:url,method:'GET'}).done(function(response){var not=response.result;$('#admin-notification-modal .modal-title').html(not.title);$('#admin-notification-modal .modal-body-text').html(not.message);$('#admin-notification-modal .modal-content').addClass('panel-'+not.display_class);$('#admin-notification-modal .notification-date').html(not.created.substr(0,16));$('#admin-notification-modal').modal();// TODO: Will this work in message includes a link that is clicked?
$('#admin-notification-modal').off('hidden.bs.modal');$('#admin-notification-modal').on('hidden.bs.modal',function(e){_this6.__notificationIsRead(that);$('#admin-notification-modal .modal-content').removeClass('panel-'+not.display_class);});});}},{key:'initNotification',/*##########PUBLIC##########*//**
     * Bind onclick and stuff
     * @return
     */value:function initNotification(){var _this7=this;// const self = this;
...
if(importance==3&&status=='new'){_this7.__showNotificationModal(that,url);__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('stoploop');return false;// Stop loop
}// Bind click to notification in drop-down
$(that).off('click');$(that).on('click',function(){_this7.__showNotificationModal(that,url);});});__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].groupEnd('initNotification');}},{key:'updateNotificationWidget',/**
