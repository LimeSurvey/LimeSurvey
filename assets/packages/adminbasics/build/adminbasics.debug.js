 ...
 */function panelClickable(){$(".panel-clickable").on('click',function(e){$that=$(this);if($that.data('url')!=''){if($that.data('target')==='_blank'){window.open($that.data('url'));}else{window.location.href=$that.data('url');}}});};/***/},/* 21 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony export (immutable) */__webpack_exports__["a"]=panelsAnimation;/**
 ...
 */function panelsAnimation(){/**
     ...
     */function rotateLast(){var $rotateShown=$('.rotateShown');var $rotateHidden=$('.rotateHidden');$rotateShown.hide('slide',{direction:'left',easing:'easeInOutQuint'},500,function(){$rotateHidden.show('slide',{direction:'right',easing:'easeInOutQuint'},1000);});$rotateShown.removeClass('rotateShown').addClass('rotateHidden');$rotateHidden.removeClass('rotateHidden').addClass('rotateShown');window.setTimeout(rotateLast,5000);}if($("#last_question").length){$('.rotateHidden').hide();window.setTimeout(rotateLast,2000);}};/***/},/* 22 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__=__webpack_require__(4);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__lslog__=__webpack_require__(1);/**
 * Notifcation system for admin
 *
 * @since 2017-08-02
 * @author Olle Haerstedt, Markus Flür
 */var NotifcationSystem=function NotifcationSystem(){var _this4=this;//constructor(){}
/**
     * Load widget HTML and inject it
     * @param {string} URL to call
     * @return
     */var __updateNotificationWidget=function __updateNotificationWidget(updateUrl){__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('updateNotificationWidget');// Update notification widget
return __WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"].ajax({url:updateUrl,method:'GET',success:function success(response){$('#notification-li').replaceWith(response);// Re-bind onclick
...
styleNotificationMenu();}});},/**
     ...
     * @return
     */__notificationIsRead=function __notificationIsRead(that){__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('notificationIsRead');__WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"].ajax({url:$(that).data('read-url'),method:'GET'}).done(function(response){// Fetch new HTML for menu widget
...
$(that).off('click');$(that).on('click',function(){__showNotificationModal(that,url);});});__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].groupEnd('initNotification');},/**
...
_this4.__updateNotificationWidget(url).then(function(){if(openAfter!==false){$('#notification-li').addClass('open');}});// Only update once
$('#notification-li').off('click');},/**
     * Apply styling
     * @return
     */styleNotificationMenu=function styleNotificationMenu(){__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('styleNotificationMenu');var height=window.innerHeight-70;$('#notification-outer-ul').css('height',height+'px');$('#notification-inner-ul').css('height',height-60+'px');$('#notification-inner-li').css('height',height-60+'px');},deleteAllNotifications=function deleteAllNotifications(url,updateUrl){return __WEBPACK_IMPORTED_MODULE_0__parts_ajaxHelper__["default"].ajax({url:url,method:'GET',success:function success(response){__WEBPACK_IMPORTED_MODULE_1__lslog__["a"/* default */].log('response',response);}}).then(function(){updateNotificationWidget(updateUrl);});};return{initNotification:initNotification,updateNotificationWidget:updateNotificationWidget,styleNotificationMenu:styleNotificationMenu,deleteAllNotifications:deleteAllNotifications};};//########################################################################
var notificationHelper=NotifcationSystem();/* harmony default export */__webpack_exports__["a"]={initNotification:notificationHelper.initNotification,updateNotificationWidget:notificationHelper.updateNotificationWidget,styleNotificationMenu:notificationHelper.styleNotificationMenu,deleteAllNotifications:notificationHelper.deleteAllNotifications};/***/}]/******/);//# sourceMappingURL=adminbasics.js.map