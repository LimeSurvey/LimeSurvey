...
/******/return __webpack_require__(__webpack_require__.s=3);/******/})(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
root._=_;}}).call(this);/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(5),__webpack_require__(6)(module));/***/},/* 1 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"a",function(){return globalStartUpMethods;});/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"b",function(){return globalWindowMethods;});/**
...
$('#'+newID)[options.inAnimation](options.animationTime,function(){var remove=function remove(){$('#'+newID)[options.outAnimation](options.animationTime,function(){$('#'+newID).remove();_this2.decrement();});};$(_this2).on('click',remove);if(options.timeout){setTimeout(remove,options.timeout);}});}}]);return NotifyFader;}();;window.LS.LsGlobalNotifier=window.LS.LsGlobalNotifier||new NotifyFader();/* harmony default export */__webpack_exports__["default"]={notifyFader:function notifyFader(text,classes,styles,customOptions){window.LS.LsGlobalNotifier.create(text,classes,styles,customOptions);}};/***/},/* 3 *//***/function(module,exports,__webpack_require__){module.exports=__webpack_require__(4);/***/},/* 4 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash__=__webpack_require__(0);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__jqueryAdditions_center_js__=__webpack_require__(7);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__jqueryAdditions_isEmpty_js__=__webpack_require__(8);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__jqueryAdditions_isEmpty_js___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__jqueryAdditions_isEmpty_js__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__parts_prototypeDefinition__=__webpack_require__(9);/* harmony import */var __WEBPACK_IMPORTED_MODULE_4__pages_questionEditing__=__webpack_require__(10);/* harmony import */var __WEBPACK_IMPORTED_MODULE_5__pages_quickaction__=__webpack_require__(11);/* harmony import */var __WEBPACK_IMPORTED_MODULE_6__pages_subquestionandanswers__=__webpack_require__(12);/* harmony import */var __WEBPACK_IMPORTED_MODULE_7__pages_surveyGrid__=__webpack_require__(13);/* harmony import */var __WEBPACK_IMPORTED_MODULE_8__parts_confirmationModal__=__webpack_require__(14);/* harmony import */var __WEBPACK_IMPORTED_MODULE_9__parts_globalMethods__=__webpack_require__(1);/* harmony import */var __WEBPACK_IMPORTED_MODULE_10__parts_notifyFader__=__webpack_require__(2);/* harmony import */var __WEBPACK_IMPORTED_MODULE_11__parts_ajaxHelper__=__webpack_require__(15);/*
...
if(_typeof(window.LS.adminCore)==='object'){window.LS.adminCore.refresh();return;}var eventsBound={document:[]};var onLoadRegister=function onLoadRegister(){__WEBPACK_IMPORTED_MODULE_9__parts_globalMethods__["a"/* globalStartUpMethods */].bootstrapping();Object(__WEBPACK_IMPORTED_MODULE_7__pages_surveyGrid__["a"/* onExistBinding */])();appendToLoad(__WEBPACK_IMPORTED_MODULE_8__parts_confirmationModal__);appendToLoad(__WEBPACK_IMPORTED_MODULE_4__pages_questionEditing__);},appendToLoad=function appendToLoad(fn,event,root){event=event||'ready pjax:scriptcomplete';root=root||'document';eventsBound[root]=eventsBound[root]||[];if(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.find(eventsBound[root],{fn:fn,event:event,root:root})===undefined){eventsBound[root].push({fn:fn,event:event,root:root});$(root).on(event+'.admincore',fn);}},refreshAdminCore=function refreshAdminCore(){__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(eventsBound,function(eventMap,root){__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.each(eventMap,function(evItem){$(evItem.root).off(evItem.event+'.admincore');$(evItem.root).on(evItem.event+'.admincore',evItem.fn);});});Object(__WEBPACK_IMPORTED_MODULE_7__pages_surveyGrid__["a"/* onExistBinding */])();console.ls.log("Refreshed Admin core methods");},setNameSpace=function setNameSpace(){var BaseNameSpace={adminCore:{refresh:refreshAdminCore,onload:onLoadRegister,appendToLoad:appendToLoad}};var LsNameSpace=__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.merge(BaseNameSpace,__WEBPACK_IMPORTED_MODULE_9__parts_globalMethods__["b"/* globalWindowMethods */],__WEBPACK_IMPORTED_MODULE_11__parts_ajaxHelper__,__WEBPACK_IMPORTED_MODULE_10__parts_notifyFader__,__WEBPACK_IMPORTED_MODULE_6__pages_subquestionandanswers__["a"/* subquestionAndAnswersGlobalMethods */]);/*
            ...
            */window.hasFormValidation=typeof document.createElement('input').checkValidity=='function';};setNameSpace();onLoadRegister();};AdminCore();/***/},/* 5 *//***/function(module,exports){var g;// This works in non-strict mode
...
module.exports=g;/***/},/* 6 *//***/function(module,exports){module.exports=function(module){if(!module.webpackPolyfill){module.deprecate=function(){};module.paths=[];// module.parent = undefined by default
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 7 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";jQuery.fn.extend({center:function center(){this.css("position","absolute");this.css("top",($(window).height()-this.height())/2+$(window).scrollTop()+"px");this.css("left",($(window).width()-this.width())/2+$(window).scrollLeft()+"px");return this;}});/***/},/* 8 *//***/function(module,exports){$.fn.extend({isEmpty:function isEmpty(helperMsg){if($.trim($(this).value).length==0){alert(helperMsg);$(this).focus();// set the focus to this input
return false;}return true;}});/***/},/* 9 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";String.prototype.splitCSV=function(sep){for(var foo=this.split(sep=sep||","),x=foo.length-1,tl;x>=0;x--){if(foo[x].replace(/"\s+$/,'"').charAt(foo[x].length-1)=='"'){if((tl=foo[x].replace(/^\s+"/,'"')).length>1&&tl.charAt(0)=='"'){foo[x]=foo[x].replace(/^\s*"|"\s*$/g,'').replace(/""/g,'"');}else if(x){foo.splice(x-1,2,[foo[x-1],foo[x]].join(sep));}else foo=foo.shift().split(sep).concat(foo);}else foo[x].replace(/""/g,'"');}return foo;};/***/},/* 10 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"bindAdvancedAttribute",function(){return bindAdvancedAttribute;});/**
 * Methods and bindings for the question edit page
 */var bindAdvancedAttribute=function bindAdvancedAttribute(){$('#showadvancedattributes').click(function(){$('#showadvancedattributes').hide();$('#hideadvancedattributes').show();$('#advancedquestionsettingswrapper').animate({"height":"toggle","opacity":"toggle"});});};/***/},/* 11 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* unused harmony export bindings *//* unused harmony export methods *//**
...
success:function success(data,statut){var newState=parseInt(data.newState);console.ls.log('quickaction resolve',data);console.ls.log('quickaction new state',newState);$self.data('active',newState);if(newState===1){$('#survey-action-container').slideDown(500);}else{$('#survey-action-container').slideUp(500);}$('#survey-action-chevron').find('i').toggleClass('fa-caret-up').toggleClass('fa-caret-down');},error:function error(html,statut){console.ls.error('ERROR!',html,statut);}});}};var bindings=function bindings(){$('#switchchangeformat button').on('click',function(event,state){$('#switchchangeformat button.active').removeClass('active');$(this).addClass('active');var value=$(this).data('value');var url=$('#switch-url').attr('data-url')+'/format/'+value;$.ajax({url:url,type:'GET',dataType:'html',// html contains the buttons
success:function success(html,statut){},error:function error(html,statut){alert('error');}});});};/***/},/* 12 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"a",function(){return subquestionAndAnswersGlobalMethods;});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash__=__webpack_require__(0);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);/**
 * Methods loaded on subquestions and answers page
 */var subquestionAndAnswersGlobalMethods={removechars:function removechars(strtoconvert){return strtoconvert.replace(/[-a-zA-Z_]/g,"");},getUnique:function getUnique(array){return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.uniq(array);}};/***/},/* 13 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"a",function(){return onExistBinding;});/**
 * Methods to load when a the surveygrid is available
 *     if($('#survey-grid').length>0)
 */var onExistBinding=function onExistBinding(){$(document).on('click','.has-link',function(){var linkUrl=$(this).find('a').attr('href');window.location.href=linkUrl;});};/***/},/* 14 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony export (binding) */__webpack_require__.d(__webpack_exports__,"loadMethods",function(){return loadMethods;});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash__=__webpack_require__(0);/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_lodash___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_lodash__);/**
...
if(!!options['ajax-url']){_ajaxHandler();return;}console.ls.error("Confirmation modal: Found neither data-href or data-onclick, nor ajax data.");};//////RUN BINDINGS
...
_setTarget();};var loadMethods=function loadMethods(){$('#confirmation-modal').on('show.bs.modal',function(e){ConfirmationModal.call(this,e);});};/***/},/* 15 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0__globalMethods__=__webpack_require__(1);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__notifyFader__=__webpack_require__(2);/**
 * Collection of ajax helper
 */var onSuccess=function onSuccess(response){// Check type of response and take action accordingly
if(response==''){console.ls.error('No response from server');__WEBPACK_IMPORTED_MODULE_1__notifyFader__["default"].create('No response from server','alert-danger');return false;}if(!response.loggedIn){// Hide any modals that might be open
...
var runOldSuccess=ajaxHelperOnSuccess(response);if(oldSuccess&&runOldSuccess){oldSuccess(response,textStatus,jqXHR);}};options.error=function(jqXHR,textStatus,errorThrown){$('#ls-loading').hide();console.ls.error('AJAX CALL FAILED -> ',{errorThrown:errorThrown,textStatus:textStatus,jqXHR:jqXHR});if(oldError){oldError(jqXHR,textStatus,errorThrown);}};$('#ls-loading').show();return $.ajax(options);};/* harmony default export */__webpack_exports__["default"]=ajax;/***/}]/******/);//# sourceMappingURL=adminbasics.js.map