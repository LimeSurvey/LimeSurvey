...
css+='\n/*# sourceMappingURL=data:application/json;base64,'+btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))))+' */';}if(styleElement.styleSheet){styleElement.styleSheet.cssText=css;}else{while(styleElement.firstChild){styleElement.removeChild(styleElement.firstChild);}styleElement.appendChild(document.createTextNode(css));}}/***/},/* 3 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,module){var __WEBPACK_AMD_DEFINE_RESULT__;/**
 * @license
...
module.exports=g;/***/},/* 6 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";/* WEBPACK VAR INJECTION */(function(global,setImmediate){/*!
 * Vue.js v2.5.2
...
if(!module.children)module.children=[];Object.defineProperty(module,"loaded",{enumerable:true,get:function get(){return module.l;}});Object.defineProperty(module,"id",{enumerable:true,get:function get(){return module.i;}});module.webpackPolyfill=1;}return module;};/***/},/* 9 *//***/function(module,exports,__webpack_require__){var Component=__webpack_require__(0)(/* script */__webpack_require__(28),/* template */__webpack_require__(29),/* styles */null,/* scopeId */null,/* moduleIdentifier (server only) */null);module.exports=Component.exports;/***/},/* 10 *//***/function(module,exports,__webpack_require__){module.exports=__webpack_require__(11);/***/},/* 11 *//***/function(module,__webpack_exports__,__webpack_require__){"use strict";Object.defineProperty(__webpack_exports__,"__esModule",{value:true});/* harmony import */var __WEBPACK_IMPORTED_MODULE_0_vue__=__webpack_require__(6);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_sidebar_vue__=__webpack_require__(14);/* harmony import */var __WEBPACK_IMPORTED_MODULE_1__components_sidebar_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_sidebar_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_topbar_vue__=__webpack_require__(42);/* harmony import */var __WEBPACK_IMPORTED_MODULE_2__components_topbar_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_topbar_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__components_parameter_table_vue__=__webpack_require__(52);/* harmony import */var __WEBPACK_IMPORTED_MODULE_3__components_parameter_table_vue___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_parameter_table_vue__);/* harmony import */var __WEBPACK_IMPORTED_MODULE_4__store_vuex_store_js__=__webpack_require__(58);/* harmony import */var __WEBPACK_IMPORTED_MODULE_5__mixins_logSystem_js__=__webpack_require__(63);/* harmony import */var __WEBPACK_IMPORTED_MODULE_5__mixins_logSystem_js___default=__webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__mixins_logSystem_js__);//globals formId
__WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */].config.devtools=false;//Ignore phpunits testing tags
__WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */].config.ignoredElements=["x-test"];__WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */].use(__WEBPACK_IMPORTED_MODULE_5__mixins_logSystem_js___default.a);__WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */].mixin({methods:{updatePjaxLinks:function updatePjaxLinks(){this.$store.commit("updatePjax");},redoTooltips:function redoTooltips(){window.LS.doToolTip();}}});var LsAdminPanel=function LsAdminPanel(){var AppState=Object(__WEBPACK_IMPORTED_MODULE_4__store_vuex_store_js__["a"/* default */])(window.LS.globalUserId);var panelNameSpace={};var applySurveyId=function applySurveyId(store){var surveyid=$('#vue-apps-main-container').data("surveyid");if(surveyid!=0){store.commit("updateSurveyId",surveyid);}};var controlWindowSize=function controlWindowSize(){var adminmenuHeight=$("body").find("nav").first().height();var footerHeight=$("body").find("footer").last().height();var menuHeight=$(".menubar").outerHeight();var inSurveyOffset=adminmenuHeight+footerHeight+menuHeight+25;var windowHeight=window.innerHeight;var inSurveyViewHeight=windowHeight-inSurveyOffset;var bodyWidth=(1-parseInt($('#sidebar').width())/$('#vue-apps-main-container').width())*100;var collapsedBodyWidth=(1-parseInt('98px')/$('#vue-apps-main-container').width())*100;var inSurveyViewWidth=Math.floor($('#sidebar').data('collapsed')?bodyWidth:collapsedBodyWidth)+'%';console.ls.log({adminmenuHeight:adminmenuHeight,footerHeight:footerHeight,menuHeight:menuHeight,inSurveyOffset:inSurveyOffset,windowHeight:windowHeight,inSurveyViewHeight:inSurveyViewHeight,bodyWidth:bodyWidth,collapsedBodyWidth:collapsedBodyWidth,inSurveyViewWidth:inSurveyViewWidth});panelNameSpace["surveyViewHeight"]=inSurveyViewHeight;panelNameSpace["surveyViewWidth"]=inSurveyViewWidth;$('#pjax-content').css({//'height': inSurveyViewHeight,
'max-width':inSurveyViewWidth});};var createSideMenu=function createSideMenu(){return new __WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */]({el:"#vue-sidebar-container",store:AppState,components:{sidebar:__WEBPACK_IMPORTED_MODULE_1__components_sidebar_vue___default.a},created:function created(){var _this2=this;$(document).on("vue-sidebar-collapse",function(){_this2.$store.commit("changeIsCollapsed",true);});},mounted:function mounted(){var _this3=this;applySurveyId(this.$store);var maxHeight=$("#in_survey_common").height()-35||400;this.$store.commit("changeMaxHeight",maxHeight);this.updatePjaxLinks();$(document).on("vue-redraw",function(){_this3.$forceUpdate();_this3.updatePjaxLinks();});$(document).trigger("vue-reload-remote");window.setInterval(function(){$(document).trigger("vue-reload-remote");},60*5*1000);}});};var createParameterTable=function createParameterTable(){return new __WEBPACK_IMPORTED_MODULE_0_vue__["a"/* default */]({el:"#vue-parameter-table-container",store:AppState,components:{lspanelparametertable:__WEBPACK_IMPORTED_MODULE_3__components_parameter_table_vue___default.a},mounted:function mounted(){applySurveyId(this.$store);}});};var applyPjaxMethods=function applyPjaxMethods(){panelNameSpace.reloadcounter=5;$(document).off("pjax:send.aploading").on("pjax:send.aploading",function(){$('<div id="pjaxClickInhibitor"></div>').appendTo("body");$(".ui-dialog.ui-corner-all.ui-widget.ui-widget-content.ui-front.ui-draggable.ui-resizable").remove();$("#pjax-file-load-container").find("div").css({width:"20%",display:"block"});LS.adminpanel.reloadcounter--;});$(document).off("pjax:error.aploading").on("pjax:error.aploading",function(event){// eslint-disable-next-line no-console
console.ls.log(event);});$(document).off("pjax:complete.aploading").on("pjax:complete.aploading",function(){if(LS.adminpanel.reloadcounter===0){location.reload();}});$(document).off("pjax:scriptcomplete.aploading").on("pjax:scriptcomplete.aploading",function(){$("#pjax-file-load-container").find("div").css("width","100%");$("#pjaxClickInhibitor").fadeOut(400,function(){$(this).remove();});$(document).trigger("vue-resize-height");$(document).trigger("vue-reload-remote");// $(document).trigger('vue-sidemenu-update-link');
setTimeout(function(){$("#pjax-file-load-container").find("div").css({width:"0%",display:"none"});},2200);});};var createPanelAppliance=function createPanelAppliance(){window.singletonPjax();if(document.getElementById("vue-sidebar-container")){panelNameSpace['sidemenu']=createSideMenu();}if(document.getElementById("vue-parameter-table-container")){panelNameSpace['parameterTable']=createParameterTable();}$(document).on("click","ul.pagination>li>a",function(){$(document).trigger('pjax:refresh');});controlWindowSize();window.addEventListener("resize",_.debounce(controlWindowSize,300));$(document).on("vue-resize-height",_.debounce(controlWindowSize,300));applyPjaxMethods();};LS.adminCore.addToNamespace(panelNameSpace,'adminpanel');return createPanelAppliance;};window.AdminPanel=window.AdminPanel||LsAdminPanel();window.LS.adminCore.appendToLoad(window.AdminPanel);/***/},/* 12 *//***/function(module,exports,__webpack_require__){var apply=Function.prototype.apply;// DOM APIs, for completeness
...
__webpack_require__(13);exports.setImmediate=setImmediate;exports.clearImmediate=clearImmediate;/***/},/* 13 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(global,process){(function(global,undefined){"use strict";if(global.setImmediate){return;}var nextHandle=1;// Spec says greater than zero
...
var update=__webpack_require__(2)("14b1e440",content,true);/***/},/* 16 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(1)(undefined);// imports
// module
...
var update=__webpack_require__(2)("3c0fbac0",content,true);/***/},/* 21 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(1)(undefined);// imports
// module
exports.push([module.i,".list-group-item.question-question-list-item .editIcon{margin:10px 10px 10px 5px}.display-as-container{display:block}#questionexplorer{overflow:auto}",""]);// exports
...
var update=__webpack_require__(2)("046f81d6",content,true);/***/},/* 32 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(1)(undefined);// imports
// module
exports.push([module.i,"",""]);// exports
...
var update=__webpack_require__(2)("3516652c",content,true);/***/},/* 38 *//***/function(module,exports,__webpack_require__){exports=module.exports=__webpack_require__(1)(undefined);// imports
// module
exports.push([module.i,"",""]);// exports
 ...
 * _.times(2, _.stubFalse);
 * // => [false, false]
 */function stubFalse(){return false;}module.exports=merge;/* WEBPACK VAR INJECTION */}).call(exports,__webpack_require__(5),__webpack_require__(8)(module));/***/},/* 62 *//***/function(module,exports,__webpack_require__){/* WEBPACK VAR INJECTION */(function(process){/**
