                    ...
                    <transition name="slide-fade-down">
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <span v-if="question.hidden == 0" class="question_text_ellipsize" :style="{ width: itemWidth }">
                                        [{{question.title}}] &rsaquo; {{ question.question_flat }}
                                    </span>

                                    <span v-if="question.hidden == 1" class="question_text_ellipsize question-hidden" :style="{ width: itemWidth }">
                                        [{{question.title}}] &rsaquo; {{ question.question_flat }}
                                    </span>
