...
const Actions = function () {
  ...
  function unlockLockOrganizer() {
    return new Promise(function (resolve, reject) {
      const newAllowOrganizer = _StateManager_js__WEBPACK_IMPORTED_MODULE_2__["default"].get('allowOrganizer') ? 0 : 1;
      ...
      _AjaxHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"].post(window.SideMenuData.unlockLockOrganizerUrl, {
        ...
        _StateManager_js__WEBPACK_IMPORTED_MODULE_2__["default"].commit('setAllowOrganizer', newAllowOrganizer);
        resolve(result);
      }).catch(function (error) {
        reject(error);
      });
...
class QuickMenu {
  ...
  renderIcon(menuItem) {
    ...
    switch (iconType) {
      case 'fontawesome':
        return '<i class="quickmenuIcon fa fa-' + _UIHelpers_js__WEBPACK_IMPORTED_MODULE_2__["default"].escapeHtml(icon) + '"></i>';
      case 'image':
        return '<img width="32px" src="' + _UIHelpers_js__WEBPACK_IMPORTED_MODULE_2__["default"].escapeHtml(icon) + '" />';
      case 'iconclass':
      case 'remix':
        return '<i class="quickmenuIcon ' + _UIHelpers_js__WEBPACK_IMPORTED_MODULE_2__["default"].escapeHtml(icon) + '"></i>';
      default:
        return '';
    }
  }
...
class Sidebar {
  constructor() {
    ...
    // Component instances
    this.sideMenu = new _SideMenu_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this.quickMenu = new _QuickMenu_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this.questionExplorer = new _QuestionExplorer_js__WEBPACK_IMPORTED_MODULE_9__["default"]();
  ...
  init(containerEl) {
    ...
    _StateManager_js__WEBPACK_IMPORTED_MODULE_4__["default"].subscribe(this.handleStateChange);
   ...
   */
  getSideBarWidth() {
    const width = _StateManager_js__WEBPACK_IMPORTED_MODULE_4__["default"].getComputed('isCollapsed') ? 98 : this.sideBarWidth;
  ...
  handleMouseDown(e) {
    ...
    this.isMouseDown = !_StateManager_js__WEBPACK_IMPORTED_MODULE_4__["default"].getComputed('isCollapsed');
  ...
  handleQuestionGroupOrderChange() {
    ...
    _Actions_js__WEBPACK_IMPORTED_MODULE_5__["default"].updateQuestionGroupOrder(questiongroups, surveyid).then(() => {
      ...
      _Actions_js__WEBPACK_IMPORTED_MODULE_5__["default"].getQuestions().catch(retryError => {
  ...
  handleVueReloadRemote() {
    Promise.all([_Actions_js__WEBPACK_IMPORTED_MODULE_5__["default"].getQuestions(), _Actions_js__WEBPACK_IMPORTED_MODULE_5__["default"].collectMenus()]).then(() => {
   ...
   */
  handlePjaxSend() {
    if (_UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView() && this.smallScreenHidden) {
      this.smallScreenHidden = false;
      this.render();
    }
  }
  ...
  render() {
    ...
    const showMainContent = _UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView() && this.smallScreenHidden || !_UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView();
    const showPlaceholder = _UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView() && this.smallScreenHidden;
    ...
    if (showMainContent) {
      ...
      // Resize handle
      if (_UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView() && !this.smallScreenHidden || !_UIHelpers_js__WEBPACK_IMPORTED_MODULE_6__["default"].useMobileView()) {
