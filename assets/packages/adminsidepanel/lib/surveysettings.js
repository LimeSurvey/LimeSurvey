...
function templatechange($element) {
    $('#preview-image-container').html(
        '<div style="height:200px;" class="ls-flex ls-flex-column align-content-center align-items-center"><span class="sr-only">Loading</span><i class="ri-loader-2-fill remix-spin remix-3x"></i></div>'
    );
