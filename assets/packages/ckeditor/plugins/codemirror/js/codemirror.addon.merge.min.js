...
b){for(var d=Math.max(f,c),l=Math.min(g,b),k=d;k<l;++k)e.push(N(a,k,h,!0,k==c,k==b-1));c==b&&d==b&&l==b&&(d?e.push(N(a,d-1,h,!1,!1,!0)):e.push(N(a,d,h,!1,!0,!1)))}for(var k=x(0,0),p=x(f,0),m=a.clipPos(x(g-1)),n=c==DIFF_DELETE?h.del:h.insert,l,r=0,q=!1,v=0;v<b.length;++v){var t,u,w,z=b[v],y=z[0],z=z[1];y==DIFF_EQUAL?(u=k.line+(W(b,v)?0:1),F(k,z),u<(t=k.line+(X(b,v)?1:0))&&(q&&(d(r,u),q=!1),r=t)):(q=!0,y==c&&(u=F(k,z,!0),t=k,z=0<((y=p).line-t.line||y.ch-t.ch)?y:t,y=u,w=0>((w=m).line-y.line||w.ch-y.ch)?
...
h=0;h<a.chunks.length;h++){var d=a.chunks[h];if(d.editFrom<=c.to&&d.editTo>=c.from&&d.origFrom<=e.to&&d.origTo>=e.from){var k=n=m=p=n=p=k=m=void 0,p,m,n,l=a,r=f,q=g,v=b,t="left"==l.type,u=l.orig.heightAtLine(d.origFrom,"local",!0)-r;l.svg&&(m=u,k=l.edit.heightAtLine(d.editFrom,"local",!0)-q,t&&(p=m,m=k,k=p),r=l.orig.heightAtLine(d.origTo,"local",!0)-r,n=l.edit.heightAtLine(d.editTo,"local",!0)-q,t&&(p=r,r=n,n=p),t=" C "+v/2+" "+k+" "+v/2+" "+m+" "+(v+2)+" "+m,p=" C "+v/2+" "+r+" "+v/2+" "+n+" -1 "+
