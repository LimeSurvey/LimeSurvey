...
g.bbcode,c="startTag","tag"):(b.next(),null)},inAttribute:function(b){return function(d,c){for(var e,a=null;!d.eol();){if(e=d.peek(),d.next()==b&&"\\"!==a){c.tokenize=g.bbcode;break}a=e}return"string"}},bbcode:function(b,d){if(b.match("]",!0))return d.tokenize=g.tokenizer,c=null,"tag";if(b.match("[",!0))return c="startTag","tag";var a=b.next();if(l.test(a))return d.tokenize=g.inAttribute(a),c="string","string";if(/\d/.test(a))return b.eatWhile(/\d/),c="number","number";if("whitespace"==d.last)return b.eatWhile(h),
c="modifier","attribute";if("property"==d.last)return b.eatWhile(h),c=null,"property";if(/\s/.test(a))return c="whitespace",null;var e="";"/"!=a&&(e+=a);for(var f;f=b.eat(h);)e+=f;return n.test(e)?(c="atom","atom"):m.test(e)?(c="keyword","keyword"):/\s/.test(a)?null:(c="tag","tag")}};return{startState:function(){return{tokenize:g.tokenizer,mode:"bbcode",last:null}},token:function(b,a){b=a.tokenize(b,a);return a.last=c,b},electricChars:""}});CodeMirror.defineMIME("text/x-bbcode","bbcode");