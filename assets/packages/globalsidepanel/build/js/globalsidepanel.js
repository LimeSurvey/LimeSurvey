  ...
  return _createClass(Sidemenu, [{
    ...
    value: function renderMenuIcon(menuItem) {
      ...
      if (iconType === 'fontawesome') {
        iconClass = "fa fa-".concat(esc(menuItem.menu_icon));
      } else if (iconType === 'remix') {
        iconClass = "ri-".concat(esc(menuItem.menu_icon));
