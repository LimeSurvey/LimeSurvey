...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    processKeyPress: function processKeyPress($event) {
      ...
      this.$log.log('PROCESS KEYPRESS', $event.key.toLowerCase);
      this.$log.log('PROCESS KEYPRESS', this.filteredList.length);
      this.$log.log('PROCESS KEYPRESS', this.selectedIndex);
...
//# sourceMappingURL=main.4356422006bddae62c9c.hot-update.js.map