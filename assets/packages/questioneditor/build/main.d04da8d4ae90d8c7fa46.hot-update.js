...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    replaceFromLabelSets: function replaceFromLabelSets(contents) {
      ...
      lodash_forEach__WEBPACK_IMPORTED_MODULE_9___default()(contents.data, function (lngSet, key) {
        var newDataSetBlock = _this5.getTemplate(contents.scaleId);

        newDataSetBlock[_this5.typeDefininitionKey] = key;
        lodash_forEach__WEBPACK_IMPORTED_MODULE_9___default()(lngSet, function (dataSetValue, lngKey) {
          newDataSetBlock[lngKey][_this5.typeDefininition] = dataSetValue;
        });
        tempObject[scale].push(newDataSetBlock);
      });
      this.currentDataSet = tempObject;
    ...
    addToFromLabelSets: function addToFromLabelSets(contents) {
      ...
      lodash_forEach__WEBPACK_IMPORTED_MODULE_9___default()(contents, function (scaleObject, scale) {
        lodash_forEach__WEBPACK_IMPORTED_MODULE_9___default()(scaleObject, function (lngSet, key) {
          var newDataSetBlock = _this6.getTemplate(scale);

          newDataSetBlock[_this6.typeDefininitionKey] = key;
          lodash_forEach__WEBPACK_IMPORTED_MODULE_9___default()(lngSet, function (dataSetValue, lngKey) {
            newDataSetBlock[lngKey][_this6.typeDefininition] = dataSetValue;
          });
          tempObject[scale].push(newDataSetBlock);
        });
      });
...
//# sourceMappingURL=main.d04da8d4ae90d8c7fa46.hot-update.js.map