                ...
                <div class="panel panel-default col-12 question-option-general-container" key="mainPanel">
                    ...
                    <div class="panel-body">
                        <div class="col-12 ls-space margin all-5 scope-contains-ckeditor ">
                            ...
                            <lsckeditor v-if="!questionEditSource" v-model="currentQuestionQuestion" v-on:input="runDebouncedChange" :config="editorQuestionConfig"></lsckeditor>
                        ...
                        <div class="col-12 ls-space margin all-5 scope-contains-ckeditor ">
                            ...
                            <lsckeditor v-if="!helpEditSource" v-model="currentQuestionHelp" v-on:input="runDebouncedChange" :config="editorHelpConfig"></lsckeditor>
