...
var TemplateCoreClass = function () {
    return {
        ...
        confirmSurveyDialog: function (text, title, submits) {
            $("#bootstrap-alert-box-modal .modal-header .modal-title").text(title);
            $("#bootstrap-alert-box-modal .modal-body").html("<p>" + text + "</p>" + "<div class='btn-group btn-group-justified' role='group'><a class='btn btn-warning btn-confirm' data-dismiss='modal'>" + LSvar.lang.yes + "</a><a class='btn btn-cancel' data-dismiss='modal'>" + LSvar.lang.no + "</a></div>");
            $("#bootstrap-alert-box-modal").modal('show');
