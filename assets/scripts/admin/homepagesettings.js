...
$(document).on('ready  pjax:scriptcomplete', function(){
    ...
    $('a[data-confirm]').click(function(ev) {
        ...
        if (!$('#dataConfirmModal').length) {
            $('body').append('<div  id="dataConfirmModal" class="modal  fade" role="dialog" aria-labelledby="dataConfirmLabel">  <div class="modal-dialog">    <div class="modal-content">      <div class="modal-header">        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>        <h4 class="modal-title">'+strConfirm+'</h4>      </div>      <div class="modal-body">      </div>      <div class="modal-footer"><button role="button" class="btn btn-primary" id="dataConfirmOK">'+strOK+'</button><button  type="button" class="btn btn-cancel" data-bs-dismiss="modal" >'+strCancel+'</button>      </div>    </div><!-- /.modal-content -->  </div><!-- /.modal-dialog --></div><!-- /.modal -->');
        }
