...
$databasename       =   'ls192dev';  // The name of the database that we will create
$databaseuser       =   'ls192dev';        // The name of a user with rights to create db (or if db already exists, then rights within that db)
$databasepass       =   'ls192dev';            // Password of db user
