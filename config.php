...
$databasetabletype  =   "ISAM";		   // Storage engine mysql should use when creating survey results tables (if mysql is used). If available, InnoDB is recommended. Default is ISAM.
