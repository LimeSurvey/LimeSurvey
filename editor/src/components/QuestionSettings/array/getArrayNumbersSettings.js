...
const displaySettings = () => {
  ...
  return [
    ...
    displayAttributes.MINIMUM_VALUE,
    displayAttributes.MAXIMUM_VALUE,
    displayAttributes.REVERSE_ANSWER_ORDER,
    displayAttributes.RANDOM_ORDER,
    displayAttributes.KEEP_CODE_ORDER,
    displayAttributes.SUBQUESTION_WIDTH,
    displayAttributes.REPEAT_HEADERS,
    displayAttributes.GET_ORDER_FROM_PREVIEW_QUESTION,
    ...
    displayAttributes.TEXT_INPUTS,
    displayAttributes.STEP_VALUE,
    displayAttributes.CHECKBOX_LAYOUT,
  ]
}
...
export const getArrayNumbersSettings = () => {
  return [
    {
