...
const displaySettings = () => {
  ...
  return [
    ...
    displayAttributes.CATEGORY_SERARATOR,
    displayAttributes.PREFIX_FOR_LIST_ITEMS,
    displayAttributes.HEIGHT_OF_DROPDOWN,
...
const logicSettings = () => {
  ...
  return [
    ...
    logicAttributes.COMMENT_MANDATORY,
...
const themeOptionsSettings = () => {
  ...
  return [
    themeAttributes.ALLOW_SEARCHING_DROPDOWN,
    themeAttributes.DISPLAY_TICK_SELECTED_ITEM,
    themeAttributes.WIDTH_DROPDOWN_SELECTED_ENTRY,
  ]
}
...
export const getDropdownSettings = () => {
  return [
    {
