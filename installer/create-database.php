    ...
    */
    ...
    try{
        ...
        $oDB->createCommand()->createTable('{{surveys}}', array(
            ...
            'showdatasecuritynotice' => 'int DEFAULT 0',
        ...
        $oDB->createCommand()->createTable('{{surveys_languagesettings}}', array(
            ...
            'surveyls_datasecurity_notice' => "TEXT NULL",
            'surveyls_datasecurity_error' => "TEXT NULL",
            'surveyls_datasecurity_notice_label' => 'string(192) NULL',
