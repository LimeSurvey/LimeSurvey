...
define("_MANDATORY_POPUP_TEXT", "Mantatory text fields require answers, if you do not have an opinion then please say 'none'"); //Traslation for Duane's Text Field Popup Patch
