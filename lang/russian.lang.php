...
define("_PRIVACY_MESSAGE", "<b><i>Замечания о приватности</i></b><br />"
...
define("_SM_COMPLETED", "<b>Благодарим Вас<br /><br />"
					   ."Вы полностью ответили на вопросы опроса.</b><br /><br />"
...
define("_PS_CHOOSEONE", "Пожалуйста выберите <b>только одно</b> из перечисленного"); //New for 0.98finalRC1
define("_PS_WRITE", "Пожалуйста напишите Ваш ответ здесь"); //New for 0.98finalRC1
define("_PS_CHOOSEANY", "Пожалуйста отметьте <b>все</b> необходимое"); //New for 0.98finalRC1
