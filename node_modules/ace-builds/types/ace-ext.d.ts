...
declare module "ace-builds/src-noconflict/ext-language_tools" {
    export function setCompleters(val?: import("ace-builds").Ace.Completer[]): void;
    export function addCompleter(completer: import("ace-builds").Ace.Completer): void;
    ...
    import { MarkerGroup } from "ace-builds-internal/marker_group";
...
declare module "ace-builds/src-noconflict/ext-diff/scroll_diff_decorator" {
    export class ScrollDiffDecorator extends Decorator {
        constructor(scrollbarV: import("ace-builds").Ace.VScrollbar, renderer: import("ace-builds-internal/virtual_renderer").VirtualRenderer, forInlineDiff?: boolean);
        addZone(startRow: number, endRow: number, type: "delete" | "insert"): void;
        setSessions(sessionA: import("ace-builds-internal/edit_session").EditSession, sessionB: import("ace-builds-internal/edit_session").EditSession): void;
        sessionA: import("ace-builds-internal/edit_session").EditSession;
        sessionB: import("ace-builds-internal/edit_session").EditSession;
    }
    import { Decorator } from "ace-builds-internal/layer/decorators";
}
...
declare module "ace-builds/src-noconflict/ext-diff" {
    ...
    export type DiffViewOptions = {
         ...
         */
        theme?: string | import("ace-builds").Ace.Theme;
    };
    export type IDiffProvider = {
        /**
         * - Computes differences between original and modified lines
         */
        compute: (originalLines: string[], modifiedLines: string[], opts?: any) => import("ace-builds/src-noconflict/ext-diff/base_diff_view").DiffChunk[];
    };
    import { InlineDiffView } from "ace-builds/src-noconflict/ext-diff/inline_diff_view";
    import { SplitDiffView } from "ace-builds/src-noconflict/ext-diff/split_diff_view";
    import { DiffProvider } from "ace-builds/src-noconflict/ext-diff/providers/default";
    /**
     * Interface representing a model for handling differences between two views or states.
...
declare module "ace-builds/src-noconflict/ext-diff/base_diff_view" {
    ...
    namespace Ace {
        type OptionsProvider<T> = import("ace-builds").Ace.OptionsProvider<T>;
    }
    export interface BaseDiffView extends Ace.OptionsProvider<import("ace-builds/src-noconflict/ext-diff").DiffViewOptions> {
    }
}
...
declare module "ace-builds/src-noconflict/ext-whitespaces_in_selection" {
}
