...
declare module "ace-builds-internal/lib/useragent" {
    export namespace OS {
        let LINUX: string;
        let MAC: string;
        let WINDOWS: string;
...
declare module "ace-builds-internal/lib/oop" {
...
declare module "ace-builds-internal/lib/deep_copy" {
    export function deepCopy(obj: any): any;
}
declare module "ace-builds-internal/lib/lang" {
...
declare module "ace-builds-internal/lib/net" {
...
declare module "ace-builds-internal/lib/report_error" {
    export function reportError(msg: any, data: any): void;
}
declare module "ace-builds-internal/lib/default_english_messages" {
...
declare module "ace-builds-internal/lib/scroll" {
    export function preventParentScroll(event: any): void;
}
declare module "ace-builds-internal/lib/bidiutil" {
    export const ON_R: 3;
    export const AN: 4;
    export const R_H: 5;
    export const B: 6;
...
declare module "ace-builds-internal/lib/fixoldbrowsers" {
}
