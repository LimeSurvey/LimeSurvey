...
class pdf extends TCPDF {
  ...
  function addGidAnswer($sGroupName, $sGroupDescription, $bAllowBreakPage=false)
  {
    ...
    $sGroupName = \ls\helpers\Replacements::templatereplace($sGroupName, array(), $sData, null, true);
    $sGroupDescription = \ls\helpers\Replacements::templatereplace($sGroupDescription, array(), $sData, null);
  ...
  function addAnswer($sQuestion, $sResponse, $bReplaceExpressions=true, $bAllowBreakPage=false)
  {
    ...
    {
        $sData['thissurvey']=$this->_aSurveyInfo;
        $sQuestionHTML = \ls\helpers\Replacements::templatereplace($sQuestionHTML, array(), $sData, null);
    }
