...
class SurveyLanguageSetting extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            ['surveyls_email_invite_subj', 'safe'],
            ['surveyls_email_invite', 'safe'],
            ['surveyls_email_remind_subj', 'safe'],
            ['surveyls_email_remind', 'safe'],
            ['surveyls_email_confirm_subj', 'safe'],
            ['surveyls_email_confirm', 'safe'],
            ['surveyls_email_register_subj', 'safe'],
            ['surveyls_email_register', 'safe'],
            ['email_admin_notification_subj', 'safe'],
            ['email_admin_notification', 'safe'],
            ['email_admin_responses_subj', 'safe'],
            ['email_admin_responses', 'safe'],
            ['surveyls_title', 'safe'],
            ['surveyls_description', 'safe'],
            ['surveyls_welcometext', 'safe'],
            ['surveyls_endtext', 'safe'],
            ['surveyls_url', \CUrlValidator::class],
            ['surveyls_urldescription', 'safe'],
            [
                'surveyls_dateformat',
                'numerical',
                'integerOnly' => true,
