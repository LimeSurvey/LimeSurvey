...
class UserGroup extends ActiveRecord
{
    ...
    public function relations()
    {
        ...
        return array(
            'Users' => array(self::HAS_MANY, 'ls\models\User', 'uid')
        );
    }
    ...
    function addGroup($group_name, $group_description)
    {
        ...
        if ($result) { //Checked
            ...
            if ($id > 0) {
                ...
                $command = Yii::app()->db->createCommand($user_in_groups_query)->bindParam(":ugid", $id,
                    PDO::PARAM_INT)->bindParam(":uid", $iLoginID, PDO::PARAM_INT)->query();
            }
