<div class="tabpage_<?php echo $lang; ?>">
    <ul>
        <li><label for='quotals_message_<?php echo $lang;?>'><?php eT("ls\models\Quota message");?>:</label><textarea  id="quotals_message_<?php echo $lang;?>" name="quotals_message_<?php echo $lang;?>" cols="60" rows="6"><?php echo htmlspecialchars($langquotainfo['quotals_message']);?></textarea></li>
