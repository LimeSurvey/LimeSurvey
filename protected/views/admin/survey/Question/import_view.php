<div class='header ui-widget-header'><?php eT("Import ls\models\Question") ?></div>
<div class='messagebox ui-corner-all'>
    <div class='successheader'><?php eT("Success") ?></div><br />
    <?php eT("File upload succeeded.") ?><br /><br />
    <?php eT("Reading file..") ?><br /><br />
    <div class='successheader'><?php eT("Success") ?></div><br />
    <strong><u><?php eT("ls\models\Question import summary") ?></u></strong><br />
...
?>
    ...
    <strong><?php eT("ls\models\Question import is complete.") ?></strong><br />
