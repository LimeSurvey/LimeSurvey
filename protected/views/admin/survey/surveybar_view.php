    ...
    <div class='menubar-main'>
        <div class='menubar-left'>
            <?php if(!$activated) { ?>
                ...
                <?php } else { ?>
                <?php if($expired) { ?>
                    <img src='<?php echo $sImageURL; ?>expired.png' alt='<?php eT("This survey is active but expired."); ?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/>
                    <?php } elseif($notstarted) { ?>
                    <img src='<?php echo $sImageURL; ?>notyetstarted.png' alt='<?php eT("This survey is active but has a start date."); ?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/>
                    <?php } else { ?>
                    <img src='<?php echo $sImageURL; ?>active.png' title='' alt='<?php eT("This survey is currently active."); ?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/>
                    <?php }
                    if($canactivate) { ?>
                    <a href="<?php echo $this->createUrl("admin/survey/sa/deactivate/surveyid/$surveyid"); ?>">
                        <img src='<?php echo $sImageURL;?>deactivate.png' alt='<?php eT("Stop this survey"); ?>' /></a>
                    <?php } else { ?>
            ...
            <li><a href='#'>
                    ...
                    <?php if($surveysettings) { ?>
                        <li><a href='<?php echo $this->createUrl("admin/survey/sa/editsurveysettings/surveyid/$surveyid");?>' >
                            <img src='<?php echo $sImageURL;?>survey_settings_30.png' alt=''/> <?php eT("General settings");?></a></li>
                        <?php } ?>
            ...
            <li><a href='#'>
                    ...
                    <?php if(App()->user->checkAccess('surveycontent', ['entity' => 'survey', 'entity_id' => $surveyid])) { ?>
                        <?php if($onelanguage) { ?>
                            ...
                            <?php } else { ?>
                            <li><a target='_blank' href='<?php echo $this->createUrl("admin/printablesurvey/sa/index/surveyid/$surveyid");?>' >
                                <img src='<?php echo $sImageURL;?>print_30.png' alt='' /> <?php eT("Printable version");?></a><ul>
                                    <?php foreach ($languagelist as $tmp_lang) { ?>
            	...
            	<li><a href='#'><img src='<?php echo $sImageURL;?>responses.png' alt='<?php eT("Responses");?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/></a>
                    ...
                    <?php if($respstatsread) {
                            ...
                            <li><a href='<?php echo $this->createUrl("admin/responses/sa/index/surveyid/$surveyid/");?>' >
                                <img src='<?php echo $sImageURL;?>browse_30.png' alt='' /> <?php eT("Responses & statistics");?></a></li>
                            <?php } else { ?>
                            <li><a href="#" onclick="alert('<?php eT("This survey is not active - no responses are available.","js");?>');" >
                                <img src='<?php echo $sImageURL;?>browse_disabled_30.png' alt='' /> <?php eT("Responses & statistics");?></a></li>
                            <?php }
                    } ?>
            ...
            <?php if($surveycontent)
                {
                    ...
                    { ?><li>
                        ...
                        <a href="<?php echo $this->createUrl("admin/survey/sa/organize/surveyid/$surveyid"); ?>">
                            <img src='<?php echo $sImageURL; ?>organize.png' alt='<?php eT("Reorder question groups / questions"); ?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/></a></li>
                    <?php }
            } ?>
        ...
        <div class='menubar-right'>
            <?php if ($permission)
                ...
                <span class='arrow-wrapper' style='font-size:0;'>
                    <?php if ($GidPrev != "")
                        ...
                        <img src='<?php echo $sImageURL; ?>previous_20.png' title='' alt='<?php eT("Previous question group"); ?>'/> </a>
                        <?php }
                        else
                        { ?>
                        <img src='<?php echo $sImageURL; ?>previous_disabled_20.png' title='' alt='<?php eT("No previous question group"); ?>' />
                        <?php }
                        ...
                        <img src='<?php echo $sImageURL; ?>next_20.png' title='' alt='<?php eT("Next question group"); ?>'/> </a>
                        <?php }
                        else
                        { ?>

                        <img src='<?php echo $sImageURL; ?>next_disabled_20.png' title='' alt='<?php eT("No next question group"); ?>'/>
                        <?php } ?>
                </span>
                <?php } ?>
            ...
            <?php if(App()->user->checkAccess('surveycontent', ['crud' => 'create', 'entity' => 'survey', 'entity_id' => $surveyid]))
                {
                    if ($activated)
                    { ?>
                    <img src='<?php echo $sImageURL; ?>add_disabled.png' title='' alt='<?php eT("Disabled"); ?> - <?php eT("This survey is currently active."); ?>'
                    ...
                    <a href="<?php echo $this->createUrl("admin/questiongroups/sa/add/surveyid/$surveyid"); ?>">
                        <img src='<?php echo $sImageURL; ?>add.png' alt='<?php eT("Add new group to survey"); ?>' width="<?php echo $iIconSize;?>" height="<?php echo $iIconSize;?>"/></a>
                    <?php }
            } ?>
            ...
            <input type='image' src='<?php echo $sImageURL; ?>close.png' title='<?php eT("Close this survey"); ?>'
                alt='<?php eT("Close this survey"); ?>' onclick="window.open('<?php echo $this->createUrl("/admin/index"); ?>','_top');"
