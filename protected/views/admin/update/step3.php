...
<h3><?php eT('Creating DB & file backup')?></h3>
...
<?php
    ...
    <?php }else{ ?>
        <div class='errorheader'><?php eT("Failed"); ?></div>
    <?php } ?>
    <div class="<?php echo $aFileBackup['class']; ?>title"> <?php eT('Creating file backup... '); ?></div>
    <p><?php echo $aFileBackup['text']; ?></p>

    <div class="<?php echo $aFileBackup['class']; ?>title"> <?php eT('Creating database backup...'); ?></div>
    <p class="<?php echo $aSQLBackup['class']; ?>"><?php echo $aSQLBackup['text']; ?></p>
    <p class="information"><?php eT('Please check any problems above and then proceed to the final step.'); ?>
