...
function savedcontrol()
{
	...
	else
	{
		...
		{
            $today = date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust);     
...
function createinsertquery()
{
	...
	if (isset($_SESSION['insertarray']) && is_array($_SESSION['insertarray']))
	{
		...
		{
			$_SESSION['datestamp']=date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust);      
		...
		{
			$mysubmitdate = date_shift(date("Y-m-d H:i"), "Y-m-d H:i:s", $timeadjust);      
		}
