    ...
    $.widget("ui.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseDrag: function(event) {
            ...
            // If the item is below another one and is moved to the right, make it a children of it
                ...
                // CSC: Record destination level
                this.placeholder.destinationLevel=level+1;
                // CSC: end change
                ...
                // CSC: Record destination level and add the changevent
                this.placeholder.destinationLevel=level;
                this._trigger("change", event, this._uiHash());
                // CSC: end change
            }
        ...
        // CSC: Get Source level

        _mouseStart: function(event, overrideHandle, noActivation) {
            this.sourceNode=this._uiHash();
            this.sourceNode.item[0].sourceLevel=this._getLevel($(this.sourceNode.item[0]));
