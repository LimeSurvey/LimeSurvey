...
define("_NUMERICAL_PS", "Μόνο αριθμιτικές τιμές επιτρέπονται σε αυτό το πεδίο");
...
define("_MANDATORY_POPUP", "Μια ή περισσότερες υποχρεωτικές ερωτήσεις δεν έχουν απαντηθεί. Δεν μπορείτε να προχωρήσετε μέχρις ότου απαντηθούν!"); //NEW in 0.98rc4
...
//From INDEX.PHP
define("_NOSID", "Δέν έχει προσδιορίσθεί το ID της έρευνας");
...
define("_CONFIRMCLEAR", "Είστε σήγουροι ότι επιθυμείτε την διαγραφή όλων των απαντήσεών σας?");
define("_CONFIRMSAVE", "Είστε σήγουροι ότι επιθυμείτε την αποθήκευση των απαντήσεών σας?");
define("_EXITCLEAR", "Έξοδος και αρχικοποίηση Έρευνας");
//From QUESTION.PHP
define("_BADSUBMIT1", "Η υποβολή δέν είναι εφικτή - δέν υπάρχει τίποτα να υποβληθεί.");
...
define("_DNSAVEEMAIL2", "ΔΕΔΩΜΕΝΑ ΠΡΟΣ ΕΙΣΑΓΩΓΗ");
define("_DNSAVEEMAIL3", "ΚΩΔΙΚΑΣ SQL ΠΟΥ ΑΠΕΤΥΧΕ");
define("_DNSAVEEMAIL4", "ΜΗΝΗΜΑ ΣΦΑΛΜΑΤΟΣ");
define("_DNSAVEEMAIL5", "Σφάλμα κατα την καταχώρηση των αποτελεσμτων της έρευνας στην Βάση Δεδομένων");
...
define ("_RG_INVALIDEMAIL", "Το e-mail που δώσατε δέν είναι έγκυρο. Παρακαλώ προσπαθήστε ξανά.");//NEW for 0.98rc9
define ("_RG_USEDEMAIL", "Το e-mail που δώσατε χρησημοποιείτε ήδη.");//NEW for 0.98rc9
...
define ("_RG_REGISTRATIONCOMPLETE", "Σας ευχαριστούμε για την εγγραφή και συμμετοχή σε αυτήν την έρευνα.<br /><br />\n"
								   ."Ένα e-mail σας έχει σταλεί στην διεύθηνση που δώσατε με περεταίρω πληροφορίες για την πρόσβαση "
...
define("_PS_EACHITEM", "Παρακαλώ επιλέξε την κατάληλη απαντηση για κάθε στοιχείο"); //New for 0.98finalRC1
...
define("_PS_RANKING", "Παρακαλώ αριθμήστε κάθε κελί με σειρά προτήμισης από το 1 μέχρι"); //New for 0.98finalRC1
define("_PS_SUBMIT", "Υποβάλετε την έρενά σας."); //New for 0.98finalRC1
define("_PS_THANKYOU", "Ευχαριστούμε που συμπληρώσατε αυτήν την έρευνα."); //New for 0.98finalRC1
define("_PS_FAXTO", "Παρακαλώ να αποστείλετε με φάξ την συμπληρωμένη έρευνα στο:"); //New for 0.98finaclRC1

define("_PS_CON_ONLYANSWER", "Απαντήστε μόνο αυτήν την ερώτηση"); //New for 0.98finalRC1
define("_PS_CON_IFYOU", "Άν απαντήσατε"); //New for 0.98finalRC1
...
define("_SAVEHEADING", "Αποθύκευση της μή-ολοκληρωμένης έρευνας");
...
define("_SAVEEXPLANATION", " Δώστε ένα Όνομα και ένα Συνθηματικό για την παρούσα Έρευνα και πατήστε το κουμπί Αποθήκευση που βρίσκεται από κάτω.<br />\n"
				  ...
				  ."<br>Εάν συμπληρώσετε την ηλεκτρονική σας διεύθυνση, θα σας αποσταλεί ένα email με όλες τις σχετικές λεπτομέρειες.");
...
define("_SAVE_EMAILSENT", "Σας απεστάλει email με τις πληροφορίες για την αποθηκευμένη Έρευνά σας.");
...
define("_LOADNAME", "Αποθυκευμένο όνομα");
