...
class SurveySearchTest extends TestBaseClass
{
    ...
    public function testTwoSurveysFoundOnGroupThree($testData)
    {
        ...
        $this->assertContains($data[0]->sid, $sids, 'One of the expected surveys was not found.');
        $this->assertContains($data[1]->sid, $sids, 'One of the expected surveys was not found.');
    ...
    public function testThreeSurveysFoundOnGroupOne($testData)
    {
        ...
        $this->assertContains($data[0]->sid, $sids, 'One of the expected surveys was not found.');
        $this->assertContains($data[1]->sid, $sids, 'One of the expected surveys was not found.');
        $this->assertContains($data[2]->sid, $sids, 'One of the expected surveys was not found.');
